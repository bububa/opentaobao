...
func (r AlibabaAliqinFcVoiceNumDoublecallAPIRequest) GetApiParams(params url.Values) {
...
func (r AlibabaAliqinFcVoiceNumDoublecallAPIRequest) GetRawParams() model.Params {
	return r.Params
}
