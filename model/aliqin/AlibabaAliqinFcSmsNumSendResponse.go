...
type AlibabaAliqinFcSmsNumSendAPIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"alibaba_aliqin_fc_sms_num_send_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识

    // 返回值
    
    Result   *AlibabaAliqinFcSmsNumSendBizResult `json:"result,omitempty" xml:"