...
type TribeMsg struct {
    ...
    AtFlag   int64 `json:"at_flag,omitempty"`
    ...
    MediaAttrs   string `json:"media_attrs,omitempty"`
...
type TribeMsg struct {
    ...
    // 当at_flag=1时，必须指定at的用户
    Atmembers   []User `json:"atmembers,omitempty"`
