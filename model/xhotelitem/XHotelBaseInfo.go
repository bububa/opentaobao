...
type XHotelBaseInfo struct {
    ...
    RoomTypeList   []RoomType `json:"room_type_list,omitempty" xml:"room_type_list,omitempty"`
    

    // 房价基础信息(需要新增rp时绑定酒店)
    
    RatePlanList   []RatePlan `json:"rate_plan_list,omitempty" xml:"rate_plan_list,omitempty"`
    ...
    SRoomTypeList   []Sroomtypelist `json:"s_room_type_list,omitempty" xml:"s_room_type_list,omitempty"`
    ...
    HotelDynamicInfoList   []Hoteldynamicinfo `json:"hotel_dynamic_info_list,omitempty" xml:"hotel_dynamic_info_list,omitempty"`
