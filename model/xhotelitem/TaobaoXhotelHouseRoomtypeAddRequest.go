...
// OuterId Setter
// 卖家房型ID，不能重复建议格式是:酒店code_房型code
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetOuterId(_outerId string) error {
    r._outerId = _outerId
...
// Hid Setter
// （已废弃）请使用outHid
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetHid(_hid int64) error {
    r._hid = _hid
    r.Set("hid", _hid)
    return nil
}
...
// Name Setter
// 房型名称。不能超过30字
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetName(_name string) error {
    r._name = _name
    r.Set("name", _name)
    return nil
}
...
// MaxOccupancy Setter
// 最大入住人数，默认2（1-99）
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetMaxOccupancy(_maxOccupancy int64) error {
...
// Area Setter
// 具体面积大小，请按照正确格式填写。两种格式，例如：40或者 10-20
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetArea(_area string) error {
    r._area = _area
    r.Set("area", _area)
    return nil
}
...
// Floor Setter
// 客房在建筑的第几层，隔层为1-2层，4-5层，7-8层
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetFloor(_floor string) error {
    r._floor = _floor
    r.Set("floor", _floor)
    return nil
}
...
// Internet Setter
// 宽带服务。A,B,C,D。分别代表： A：无宽带，B：免费宽带，C：收费宽带，D：部分收费宽带
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetInternet(_internet string) error {
...
// Service Setter
// 设施服务。JSON格式。 value值true有此服务，false没有。 bar：吧台，catv：有线电视，ddd：国内长途电话，idd：国际长途电话，toilet：独立卫生间，pubtoliet：公共卫生间。 如： {"bar":false,"catv":false,"ddd":false,"idd":false,"pubtoilet":false,"toilet":false}
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetService(_service string) error {
    r._service = _service
...
// Extend Setter
// 不要使用
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetExtend(_extend string) error {
    r._extend = _extend
...
// WindowType Setter
// 0:无窗/1:有窗/2:部分有窗/3:暗窗/4:部分暗窗
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetWindowType(_windowType int64) error {
...
// Srid Setter
// 该字段只有确定的时候，才允许填入。用于标示和淘宝房型的匹配关系。目前尚未启动该字段。
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetSrid(_srid int64) error {
    r._srid = _srid
    r.Set("srid", _srid)
    return nil
}
...
// OutHid Setter
// （必传）商家酒店ID，指明该房型属于哪家酒店
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetOutHid(_outHid string) error {
    r._outHid = _outHid
...
// Vendor Setter
// 系统商，无申请不可使用
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetVendor(_vendor string) error {
    r._vendor = _vendor
...
// Pics Setter
// 房型图片只支持远程图片，格式如下：[{"url":"http://taobao.com/123.jpg","ismain":"true"},{"url":"http://taobao.com/456.jpg","ismain":"false"},{"url":"http://taobao.com/789.jpg","ismain":"false"}]其中url是远程图片的访问地址（URL地址必须是合法的，否则会报错），main是是否为主图。只能设置一张图片为主图。
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetPics(_pics string) error {
    r._pics = _pics
    r.Set("pics", _pics)
    return nil
}
...
// NameE Setter
// 卖家房型英文名称
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetNameE(_nameE string) error {
    r._nameE = _nameE
    r.Set("name_e", _nameE)
    return nil
}
...
// Operator Setter
// 操作人信息
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetOperator(_operator string) error {
...
// 属性值为1: 含义是非直连房型
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetConnectionType(_connectionType int64) error {
...
// HouseModel Setter
// 房屋户型， bedroom: 室, bathroom: 卫, livingroom: 厅, study: 书房, balcony: 阳台,kitchen: 厨房
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetHouseModel(_houseModel string) error {
...
// HouseSize Setter
// 房屋面积
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetHouseSize(_houseSize int64) error {
...
// RentType Setter
// 出租类型:1.整租;2.单间;3.床位
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetRentType(_rentType int64) error {
...
// RentSize Setter
// 出租面积,单位平方米
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetRentSize(_rentSize int64) error {
...
// HasLandlord Setter
// 是否和房东合住:0.不和房东合住;1.和房东合住;
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetHasLandlord(_hasLandlord int64) error {
...
// BedInfo Setter
// 床信息: bedType:床型, desc: 床型名, width:床宽, length：床长, bedNum: 床数。床型取值见链接https://open.alitrip.com/docs/doc.htm?spm=0.0.0.0.4zBOVn&docType=1&articleId=108347
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetBedInfo(_bedInfo string) error {
    r._bedInfo = _bedInfo
...
// Status Setter
// 数据状态 0:正常，-1:删除，-2:停售
func (r *TaobaoXhotelHouseRoomtypeAddRequest) SetStatus(_status int64) error {
    r._status = _status
