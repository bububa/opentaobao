...
// OuterId Setter
// 外部酒店ID, 这是卖家自己系统中的ID
func (r *TaobaoXhotelAddRequest) SetOuterId(_outerId string) error {
    r._outerId = _outerId
...
// Name Setter
// 酒店名称,国内酒店请传中文名称
func (r *TaobaoXhotelAddRequest) SetName(_name string) error {
    r._name = _name
    r.Set("name", _name)
    return nil
}
...
// UsedName Setter
// 酒店曾用名
func (r *TaobaoXhotelAddRequest) SetUsedName(_usedName string) error {
...
// Domestic Setter
// 是否国内酒店。0:国内;1:国外。默认是国内
func (r *TaobaoXhotelAddRequest) SetDomestic(_domestic int64) error {
...
// Country Setter
// domestic为0时，固定China； domestic为1时，必须传定义的海外国家编码值。参见：http://hotel.alitrip.com/area.htm
func (r *TaobaoXhotelAddRequest) SetCountry(_country string) error {
    r._country = _country
...
// Province Setter
// 省份编码。选填，不填入的时候已city字段为准.参见：http://hotel.alitrip.com/area.htm，domestic为false时默认为0
func (r *TaobaoXhotelAddRequest) SetProvince(_province int64) error {
...
// City Setter
// 城市编码。参见：http://hotel.alitrip.com/area.htm，domestic为false时，输入对应国家的海外城市编码，可调用海外城市查询接口获取；（更新酒店时为可选）
func (r *TaobaoXhotelAddRequest) SetCity(_city int64) error {
    r._city = _city
    r.Set("city", _city)
    return nil
}
...
// District Setter
// 区域（县级市）编码。参见：http://hotel.alitrip.com/area.htm
func (r *TaobaoXhotelAddRequest) SetDistrict(_district int64) error {
...
// Business Setter
// 商业区（圈）长度不超过20字
func (r *TaobaoXhotelAddRequest) SetBusiness(_business string) error {
...
// Address Setter
// 酒店地址。长度不能超过255。不填入会导致不能自动匹配。
func (r *TaobaoXhotelAddRequest) SetAddress(_address string) error {
    r._address = _address
...
// Longitude Setter
// 经度
func (r *TaobaoXhotelAddRequest) SetLongitude(_longitude string) error {
...
// Latitude Setter
// 纬度
func (r *TaobaoXhotelAddRequest) SetLatitude(_latitude string) error {
...
// PositionType Setter
// 坐标类型，现在支持：G – GoogleB – 百度A – 高德M – MapbarL – 灵图
func (r *TaobaoXhotelAddRequest) SetPositionType(_positionType string) error {
...
// Tel Setter
// 酒店电话。格式：国家代码（最长6位）#区号（最长4位）#电话（最长20位）。国家代码提示：中国大陆0086、香港00852、澳门00853、台湾00886
func (r *TaobaoXhotelAddRequest) SetTel(_tel string) error {
    r._tel = _tel
    r.Set("tel", _tel)
    return nil
}
...
// Extend Setter
// 扩展信息的JSON。注：此字段的值需要ISV在接入前与淘宝沟通，且确认能解析
func (r *TaobaoXhotelAddRequest) SetExtend(_extend string) error {
    r._extend = _extend
...
// Shid Setter
// 该字段只有确定的时候，才允许填入。用于标示和淘宝酒店的匹配关系。目前尚未启动该字段。
func (r *TaobaoXhotelAddRequest) SetShid(_shid int64) error {
    r._shid = _shid
    r.Set("shid", _shid)
    return nil
}
...
// Vendor Setter
// 对接系统商名称：可为空不要乱填，需要申请后使用
func (r *TaobaoXhotelAddRequest) SetVendor(_vendor string) error {
    r._vendor = _vendor
...
// Star Setter
// 酒店档次，星级。取值范围为1,1.5,2,2.5,3,3.5,4,4.5,5
func (r *TaobaoXhotelAddRequest) SetStar(_star string) error {
    r._star = _star
    r.Set("star", _star)
    return nil
}
...
// OpeningTime Setter
// 开业时间，格式为2015-01-01
func (r *TaobaoXhotelAddRequest) SetOpeningTime(_openingTime string) error {
...
// DecorateTime Setter
// 装修时间，格式为2015-01-01装修时间
func (r *TaobaoXhotelAddRequest) SetDecorateTime(_decorateTime string) error {
...
// Floors Setter
// 楼层信息。
func (r *TaobaoXhotelAddRequest) SetFloors(_floors string) error {
    r._floors = _floors
...
// Rooms Setter
// 房间数 0~9999之内的数字
func (r *TaobaoXhotelAddRequest) SetRooms(_rooms int64) error {
    r._rooms = _rooms
    r.Set("rooms", _rooms)
    return nil
}
...
// Description Setter
// 酒店描述
func (r *TaobaoXhotelAddRequest) SetDescription(_description string) error {
...
// Pics Setter
// 酒店图片只支持远程图片，格式如下：[{"url":"http://123.jpg","ismain":"false","type":"大堂","attribute":"普通图"},{"url":"http://456.jpg","ismain":"true","type":"公共区域","attribute":"全景图"},{"url":"http://789.jpg","ismain":"false","type":"大堂","attribute":"普通图"}] 其中url是远程图片的访问地址（URL地址必须是合法的，否则会报错），main是是否为主图（主图只能有一个，如果有多个或者没有，则会报错）,attribute表示图片属性，取值范围只能是：[普通图, 平面图, 全景图] ,type表示图片类型，取值范围只能是：[周边, 外观, 商务中心, 健身房, 其他, 会议室, 餐厅, 浴室, 客房, 公共区域, 娱乐设施, 大堂, 泳池]，图片数量最多是能是10张。
func (r *TaobaoXhotelAddRequest) SetPics(_pics string) error {
    r._pics = _pics
    r.Set("pics", _pics)
    return nil
}
...
// Brand Setter
// 酒店品牌。取值为数字。枚举如下（只给出top30，如果不满足，请联系去啊接口人）：    ruJia("1", "rujiakuaijie", "如家快捷", 1),    qiTian("2", "7 days", "7天连锁", 1),    hanTing("3", "Hanting Inns & Hotels", "汉庭酒店", 1),    geLinHaoTai("4", "Green Tree Inn", "格林豪泰", 1),    jinJiang("5", "Jinjiang Inn", "锦江之星", 1),    su8("6", "Super 8", "速8", 1),    moTai("7", "Motel", "莫泰", 1),    zhouji("8", "InterContinental", "洲际", 4),    budint("9", "Pod Inn", "布丁", 1),    jiuJiu("10", "jiujiuliansuo", "99连锁", 1),    piaoHome("11", "Piao Home Inn", "飘HOME", 1),    juzi("12", "Orange Hotels", "桔子酒店", 1),    yibai("13", "yibai", "易佰", 1),    weiyena("14","weiyena","维也纳",2),    huangguanjiari("15", "huangguanjiari", "皇冠假日", 4),    xidawu("16", "xidawu", "喜达屋", 3),    chengshiBJ("17", "chengshibianjie", "城市便捷", 1),    shagnKeYou("18", "shagnkeyou", "尚客优", 1),    jinjiang("19", "jinjiang", "锦江酒店", 3),    wendemu("20", "Hawthorn Suites", "温德姆", 4),    yibisi("21", "Ibis Hotels", "宜必思", 1),    wanhao("22", "JM Hoteles", "万豪", 4),    yijia365("23", "yijia365", "驿家365", 1),    shoulv("24", "shoulvjituan", "首旅建国", 3),    kaiyuan("25", "New Century Hotel", "开元大酒店", 4),    yagao("26", "yagao", "雅高", 3),    daisi("27", "daisi", "戴斯", 3),    jinling("28", "jinlingliansuo", "金陵", 4),    xianggelila("29", "Shangri-La City Hotels", "香格里拉", 4),    xierdun("30", "Hilton", "希尔顿", 4),
func (r *TaobaoXhotelAddRequest) SetBrand(_brand string) error {
    r._brand = _brand
    r.Set("brand", _brand)
    return nil
}
...
// PostalCode Setter
// 邮政编码。
func (r *TaobaoXhotelAddRequest) SetPostalCode(_postalCode string) error {
...
// 预订须知。json字段描述：hotelInMountaintop 酒店位于山顶 1在山顶、0不在；needBoat 酒店需要坐船前往 1需要、0不需要；酒店位于景区内 1在景区、0不在；extraBed 加床收费；extraCharge 额外收费；arrivalTime 到店时间；extend 其他补充项
func (r *TaobaoXhotelAddRequest) SetBookingNotice(_bookingNotice string) error {
...
// 逗号分隔的字符串 1visa；2万事达卡；3美国运通卡；4发现卡；5大来卡；6JCB卡；7银联卡
func (r *TaobaoXhotelAddRequest) SetCreditCardTypes(_creditCardTypes string) error {
...
// OrbitTrack Setter
// 扩展信息的JSON。 orbitTrack 业务字段是指从飞猪到酒店说经过平台名以及方式的一个数组，按顺序，从飞猪，再经过若干平台，最后到酒店， platform是指定当前平台名，ways 是指通过哪种方式到该平台 其中，飞猪到下一个平台里, ways 字段只能是【直连】、【人工】两个方式之一； 从最后一个平台到酒店的ways字段只能是【电话】、【传真】、【人工】、【系统】之一； 第一个 飞猪平台 和 最后具体酒店是至少得填的
func (r *TaobaoXhotelAddRequest) SetOrbitTrack(_orbitTrack string) error {
...
// NameE Setter
// 卖家酒店英文名称
func (r *TaobaoXhotelAddRequest) SetNameE(_nameE string) error {
    r._nameE = _nameE
    r.Set("name_e", _nameE)
    return nil
}
...
// Supplier Setter
// 供应商标识，需要提前开通权限，如果需要对接请联系技术支持，请谨慎使用。注：如商家申请的应用类型为“飞猪-新业务”，此项则必填。
func (r *TaobaoXhotelAddRequest) SetSupplier(_supplier string) error {
...
// 结算过程中的结算币种符合，如需对接请联系飞猪技术支持，请谨慎使用
func (r *TaobaoXhotelAddRequest) SetSettlementCurrency(_settlementCurrency string) error {
...
// 标准娱乐设施,参考文档https://open.alitrip.com/docs/doc.htm?docType=1&articleId=108891
func (r *TaobaoXhotelAddRequest) SetStandardAmuseFacilities(_standardAmuseFacilities string) error {
...
// 标准房型设施,参考文档https://open.alitrip.com/docs/doc.htm?docType=1&articleId=108891
func (r *TaobaoXhotelAddRequest) SetStandardRoomFacilities(_standardRoomFacilities string) error {
...
// 标准酒店服务,参考文档https://open.alitrip.com/docs/doc.htm?docType=1&articleId=108891
func (r *TaobaoXhotelAddRequest) SetStandardHotelService(_standardHotelService string) error {
...
// 标准酒店设施,参考文档https://open.alitrip.com/docs/doc.htm?docType=1&articleId=108891
func (r *TaobaoXhotelAddRequest) SetStandardHotelFacilities(_standardHotelFacilities string) error {
...
// 标准预订须知,参考文档https://open.alitrip.com/docs/doc.htm?docType=1&articleId=108891
func (r *TaobaoXhotelAddRequest) SetStandardBookingNotice(_standardBookingNotice string) error {
...
// ServiceType Setter
// 0:可以接待外宾；1:仅内宾
func (r *TaobaoXhotelAddRequest) SetServiceType(_serviceType int64) error {
...
// HotelType Setter
// 0:酒店；1:客栈
func (r *TaobaoXhotelAddRequest) SetHotelType(_hotelType int64) error {
...
// 标识坐标系类型。WGS84，表示地球坐标系 ；GCJ02，表示火星坐标系
func (r *TaobaoXhotelAddRequest) SetCoordinateSystem(_coordinateSystem string) error {
...
// 废弃
func (r *TaobaoXhotelAddRequest) SetRoomFacilities(_roomFacilities string) error {
...
// Service Setter
// 废弃
func (r *TaobaoXhotelAddRequest) SetService(_service string) error {
    r._service = _service
...
// 废弃
func (r *TaobaoXhotelAddRequest) SetHotelFacilities(_hotelFacilities string) error {
...
// 废弃
func (r *TaobaoXhotelAddRequest) SetHotelPolicies(_hotelPolicies string) error {
