...
type ItemProp struct {
    ...
    TaosirDo  *struct {
        ItemTaosirDO  *ItemTaosirDO `json:"item_taosir_do,omitempty"`
    } `json:"taosir_do,omitempty"`
    ...
    MaterialDo  *struct {
        ItemMaterialProp  *ItemMaterialProp `json:"item_material_prop,omitempty"`
    } `json:"material_do,omitempty"`
...
type ItemProp struct {
    ...
    // 度量衡相关信息
    TaosirDo   *ItemTaosirDO `json:"taosir_do,omitempty"`

    // 是否是材质 属性项
    IsMaterial   bool `json:"is_material,omitempty"`

    // 材质属性信息
    MaterialDo   *ItemMaterialProp `json:"material_do,omitempty"`
