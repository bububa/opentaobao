...
type ResultData struct {
    ...
    // 数据
    OnePagedDataList   []OnePagedDataList `json:"one_paged_data_list,omitempty"`
    ...
    // 服务场所编码
    ServiceSiteCode   string `json:"service_site_code,omitempty"`
    ...
    // 商户中心门店id
    PlaceStoreId   string `json:"place_store_id,omitempty"`
