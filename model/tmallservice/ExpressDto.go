...
type ExpressDto struct {
    ...
    ReserveEndTime   string `json:"reserve_end_time,omitempty"`
    

    // 预约结束时间
    
    ReserveStartTime   string `json:"reserve_start_time,omitempty"`
...
type ExpressDto struct {
    ...
    // 寄件人信息
    Sender   *CustomerInfo `json:"sender,omitempty"`

    // 收件人信息
    Receiver   *CustomerInfo `json:"receiver,omitempty"`
