...
type AlibabaSscSupplyplatformServiceInventoryQueryAPIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"alibaba_ssc_supplyplatform_service_inventory_query_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识

    // 接口返回model
    
    Result   *AlibabaSscSupplyplatformServiceInventoryQueryResult `json:"result,omitempty" xml:"