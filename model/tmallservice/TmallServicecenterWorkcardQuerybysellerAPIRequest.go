...
func (r TmallservicecenterworkcardquerybysellerAPIRequest) GetApiParams(params url.Values) {
...
func (r TmallservicecenterworkcardquerybysellerAPIRequest) GetRawParams() model.Params {
	return r.Params
}
