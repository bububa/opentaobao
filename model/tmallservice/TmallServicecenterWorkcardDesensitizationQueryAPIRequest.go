...
func (r TmallServicecenterWorkcardDesensitizationQueryAPIRequest) GetApiParams(params url.Values) {
...
func (r TmallServicecenterWorkcardDesensitizationQueryAPIRequest) GetRawParams() model.Params {
	return r.Params
}
