...
type GroupTourPackageInfo struct {
    ...
    TripElementList   []GroupTourTripElement `json:"trip_element_list,omitempty" xml:"trip_element_list,omitempty"`
    

    // 返程交通，交通工具的类型必须与商品上的去程交通一致
    
    BackTrafficInfoList   []GroupTourTrafficInfo `json:"back_traffic_info_list,omitempty" xml:"back_traffic_info_list,omitempty"`
    

    // 去程交通，交通工具的类型必须与商品上的去程交通一致
    
    GoTrafficInfoList   []GroupTourTrafficInfo `json:"go_traffic_info_list,omitempty" xml:"go_traffic_info_list,omitempty"`
