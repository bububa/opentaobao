...
type PontusTravelItemRefundInfo struct {
    ...
    RefundRegulations  struct {
        String  []string `json:"string,omitempty"`
    } `json:"refund_regulations,omitempty"`
    ...
    RefundRegulationsJson   string `json:"refund_regulations_json,omitempty"`
