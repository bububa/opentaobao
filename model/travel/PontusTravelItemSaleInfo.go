...
type PontusTravelItemSaleInfo struct {
    ...
    BcStartDate   string `json:"bc_start_date,omitempty"`
    ...
    TouristServiceProvider   string `json:"tourist_service_provider,omitempty"`
