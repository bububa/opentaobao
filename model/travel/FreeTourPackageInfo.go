...
type FreeTourPackageInfo struct {
    ...
    FreeTourScenicInfoList   []FreeTourScenicInfo `json:"free_tour_scenic_info_list,omitempty" xml:"free_tour_scenic_info_list,omitempty"`
    ...
    BackTrafficInfoList   []FreeTourTrafficInfo `json:"back_traffic_info_list,omitempty" xml:"back_traffic_info_list,omitempty"`
    ...
    GoTrafficInfoList   []FreeTourTrafficInfo `json:"go_traffic_info_list,omitempty" xml:"go_traffic_info_list,omitempty"`
    ...
    ItemResourceInfoList   []ItemResourceInfo `json:"item_resource_info_list,omitempty" xml:"item_resource_info_list,omitempty"`
    ...
    FreeTourHotelInfoList   []FreeTourHotelInfo `json:"free_tour_hotel_info_list,omitempty" xml:"free_tour_hotel_info_list,omitempty"`
