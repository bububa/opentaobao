...
type DateSkuInfo struct {
    ...
    Alias   []PropertyAliasInfo `json:"alias,omitempty" xml:"alias,omitempty"`
    

    // SKU的销售价格库存，日历商品使用
    
    DateList   []DateInventoryAndPrice `json:"date_list,omitempty" xml:"date_list,omitempty"`
    ...
    Properties   []CatPropInfo `json:"properties,omitempty" xml:"properties,omitempty"`
