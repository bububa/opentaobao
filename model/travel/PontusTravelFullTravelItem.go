...
type PontusTravelFullTravelItem struct {
    ...
    Itineraries   []PontusTravelItemItineraryInfo `json:"itineraries,omitempty" xml:"itineraries,omitempty"`
    ...
    SkuInfos   []PontusTravelItemSkuInfo `json:"sku_infos,omitempty" xml:"sku_infos,omitempty"`
    ...
    BookingRules   []PontusTravelBookingRuleInfo `json:"booking_rules,omitempty" xml:"booking_rules,omitempty"`
    ...
    HighLights   []HighLights `json:"high_lights,omitempty" xml:"high_lights,omitempty"`
