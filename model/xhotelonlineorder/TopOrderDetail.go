...
type TopOrderDetail struct {
    ...
    TopRelationOrders   []Toprelationorders `json:"top_relation_orders,omitempty" xml:"top_relation_orders,omitempty"`
    ...
    TopDailyInfos   []TopDailyInfo `json:"top_daily_infos,omitempty" xml:"top_daily_infos,omitempty"`
    ...
    TopOrderGuests   []TopOrderGuest `json:"top_order_guests,omitempty" xml:"top_order_guests,omitempty"`
