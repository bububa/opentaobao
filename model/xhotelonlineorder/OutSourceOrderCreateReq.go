...
type OutSourceOrderCreateReq struct {
    ...
    GuestInfoList   []GuestInfo `json:"guest_info_list,omitempty" xml:"guest_info_list,omitempty"`
    ...
    DailyPriceInfoList   []DailyPriceInfo `json:"daily_price_info_list,omitempty" xml:"daily_price_info_list,omitempty"`
