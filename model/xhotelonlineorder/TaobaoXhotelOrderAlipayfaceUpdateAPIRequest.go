...
func (r TaobaoXhotelOrderAlipayfaceUpdateAPIRequest) GetApiParams(params url.Values) {
...
func (r TaobaoXhotelOrderAlipayfaceUpdateAPIRequest) GetRawParams() model.Params {
	return r.Params
}
