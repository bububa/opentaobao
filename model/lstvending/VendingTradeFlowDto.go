...
type VendingTradeFlowDto struct {
    ...
    GoodsDetailDTOList   []VendingTradeGoodsDetailDto `json:"goods_detail_d_t_o_list,omitempty" xml:"goods_detail_d_t_o_list,omitempty"`
    ...
    PaymentDTOList   []VendingTradePaymentDto `json:"payment_d_t_o_list,omitempty" xml:"payment_d_t_o_list,omitempty"`
