...
/* 
24-销售月预测数量（产管）回传-月度 APIResponse
...
type AlibabaTmallgenieScpPlanSaleforcastPmMonthUploadAPIResponse struct {
    ...
    AlibabaTmallgenieScpPlanSaleforcastPmMonthUploadResponse
}

type AlibabaTmallgenieScpPlanSaleforcastPmMonthUploadResponse struct {
