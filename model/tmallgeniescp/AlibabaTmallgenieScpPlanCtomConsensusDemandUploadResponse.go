...
type AlibabaTmallgenieScpPlanCtomConsensusDemandUploadAPIResponse struct {
    ...
    AlibabaTmallgenieScpPlanCtomConsensusDemandUploadResponse
}

type AlibabaTmallgenieScpPlanCtomConsensusDemandUploadResponse struct {
