...
type AlibabaTmallgenieScpPlanForecastOemUploadAPIResponse struct {
    ...
    AlibabaTmallgenieScpPlanForecastOemUploadResponse
}

// 16-供应商预测（OEM-成品）回传接口 成功返回结果
type AlibabaTmallgenieScpPlanForecastOemUploadResponse struct {
