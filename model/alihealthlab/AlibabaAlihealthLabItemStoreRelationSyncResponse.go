...
type AlibabaAlihealthLabItemStoreRelationSyncAPIResponse struct {
    ...
    AlibabaAlihealthLabItemStoreRelationSyncResponse
}

// 检验检测业务，isv项目门店关系同步 成功返回结果
type AlibabaAlihealthLabItemStoreRelationSyncResponse struct {
