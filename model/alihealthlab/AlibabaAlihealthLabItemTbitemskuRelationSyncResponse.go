...
/* 
阿里健康检验检测业务，检验检测项目淘宝商品SKU关系同步 APIResponse
...
type AlibabaAlihealthLabItemTbitemskuRelationSyncAPIResponse struct {
    ...
    AlibabaAlihealthLabItemTbitemskuRelationSyncResponse
}

type AlibabaAlihealthLabItemTbitemskuRelationSyncResponse struct {
