...
type Food struct {
    ...
    Specfoods   []Specfood `json:"specfoods,omitempty" xml:"specfoods,omitempty"`
    ...
    Specifications   []Specification `json:"specifications,omitempty" xml:"specifications,omitempty"`
    ...
    Attrs   []Attr `json:"attrs,omitempty" xml:"attrs,omitempty"`
