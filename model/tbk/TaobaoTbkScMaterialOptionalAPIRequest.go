...
func NewTaobaoTbkScMaterialOptionalRequest() *TaobaoTbkScMaterialOptionalAPIRequest {
	return &TaobaoTbkScMaterialOptionalAPIRequest{
		Params: model.NewParams(44),
	}
}

// Reset IRequest interface 方法, 清空结构体
func (r *TaobaoTbkScMaterialOptionalAPIRequest) Reset() {
...
var poolTaobaoTbkScMaterialOptionalAPIRequest = sync.Pool{
	New: func() any {
		return NewTaobaoTbkScMaterialOptionalRequest()
	},
}

// GetTaobaoTbkScMaterialOptionalRequest 从 sync.Pool 获取 TaobaoTbkScMaterialOptionalAPIRequest
func GetTaobaoTbkScMaterialOptionalAPIRequest() *TaobaoTbkScMaterialOptionalAPIRequest {
	return poolTaobaoTbkScMaterialOptionalAPIRequest.Get().(*TaobaoTbkScMaterialOptionalAPIRequest)
}

// ReleaseTaobaoTbkScMaterialOptionalAPIRequest 将 TaobaoTbkScMaterialOptionalAPIRequest 放入 sync.Pool
func ReleaseTaobaoTbkScMaterialOptionalAPIRequest(v *TaobaoTbkScMaterialOptionalAPIRequest) {
	v.Reset()
	poolTaobaoTbkScMaterialOptionalAPIRequest.Put(v)
}
