...
var poolTaobaoTbkScOptimusMaterialMapData = sync.Pool{
	New: func() any {
		return new(TaobaoTbkScOptimusMaterialMapData)
	},
}

// GetTaobaoTbkScOptimusMaterialMapData() 从对象池中获取TaobaoTbkScOptimusMaterialMapData
func GetTaobaoTbkScOptimusMaterialMapData() *TaobaoTbkScOptimusMaterialMapData {
	return poolTaobaoTbkScOptimusMaterialMapData.Get().(*TaobaoTbkScOptimusMaterialMapData)
}

// ReleaseTaobaoTbkScOptimusMaterialMapData 释放TaobaoTbkScOptimusMaterialMapData
func ReleaseTaobaoTbkScOptimusMaterialMapData(v *TaobaoTbkScOptimusMaterialMapData) {
	...
	v.JuOnlineEndTime = ""
	v.JuOnlineStartTime = ""
	v.MaochaoPlayFreePostFee = ""
	v.MaochaoPlayEndTime = ""
	v.MaochaoPlayStartTime = ""
	v.MaochaoPlayConditions = ""
	v.MaochaoPlayDiscounts = ""
	v.MaochaoPlayDiscountType = ""
	v.MultiCouponZkRate = ""
	v.PriceAfterMultiCoupon = ""
	v.MultiCouponItemCount = ""
	v.LockRate = ""
	...
	poolTaobaoTbkScOptimusMaterialMapData.Put(v)
}
