...
// CampaignType Setter
// CPS佣金计划类型
func (r *TaobaoTbkDgVegasTljCreateRequest) SetCampaignType(_campaignType string) error {
...
// AdzoneId Setter
// 妈妈广告位Id
func (r *TaobaoTbkDgVegasTljCreateRequest) SetAdzoneId(_adzoneId int64) error {
...
// ItemId Setter
// 宝贝id
func (r *TaobaoTbkDgVegasTljCreateRequest) SetItemId(_itemId int64) error {
    r._itemId = _itemId
...
// TotalNum Setter
// 淘礼金总个数
func (r *TaobaoTbkDgVegasTljCreateRequest) SetTotalNum(_totalNum int64) error {
...
// Name Setter
// 淘礼金名称，最大10个字符
func (r *TaobaoTbkDgVegasTljCreateRequest) SetName(_name string) error {
    r._name = _name
    r.Set("name", _name)
    return nil
}
...
// 单用户累计中奖次数上限
func (r *TaobaoTbkDgVegasTljCreateRequest) SetUserTotalWinNumLimit(_userTotalWinNumLimit int64) error {
...
// 安全开关，若不进行安全校验，可能放大您的资损风险，请谨慎选择
func (r *TaobaoTbkDgVegasTljCreateRequest) SetSecuritySwitch(_securitySwitch bool) error {
...
// PerFace Setter
// 单个淘礼金面额，支持两位小数，单位元
func (r *TaobaoTbkDgVegasTljCreateRequest) SetPerFace(_perFace string) error {
    r._perFace = _perFace
...
// 发放开始时间
func (r *TaobaoTbkDgVegasTljCreateRequest) SetSendStartTime(_sendStartTime string) error {
...
// SendEndTime Setter
// 发放截止时间
func (r *TaobaoTbkDgVegasTljCreateRequest) SetSendEndTime(_sendEndTime string) error {
...
// UseEndTime Setter
// 使用结束日期。如果是结束时间模式为相对时间，时间格式为1-7直接的整数, 例如，1（相对领取时间1天）； 如果是绝对时间，格式为yyyy-MM-dd，例如，2019-01-29，表示到2019-01-29 23:59:59结束
func (r *TaobaoTbkDgVegasTljCreateRequest) SetUseEndTime(_useEndTime string) error {
...
// 结束日期的模式,1:相对时间，2:绝对时间
func (r *TaobaoTbkDgVegasTljCreateRequest) SetUseEndTimeMode(_useEndTimeMode int64) error {
...
// UseStartTime Setter
// 使用开始日期。相对时间，无需填写，以用户领取时间作为使用开始时间。绝对时间，格式 yyyy-MM-dd，例如，2019-01-29，表示从2019-01-29 00:00:00 开始
func (r *TaobaoTbkDgVegasTljCreateRequest) SetUseStartTime(_useStartTime string) error {
...
// 安全等级，0：适用于常规淘礼金投放场景；1：更高安全级别，适用于淘礼金面额偏大等安全性较高的淘礼金投放场景，可能导致更多用户拦截。security_switch为true，此字段不填写时，使用0作为默认安全级别。如果security_switch为false，不进行安全判断。
func (r *TaobaoTbkDgVegasTljCreateRequest) SetSecurityLevel(_securityLevel int64) error {
