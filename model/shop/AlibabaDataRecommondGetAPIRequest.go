...
// AlibabaDataRecommondGetAPIRequest 获取推荐信息 API请求
...
func (r AlibabaDataRecommondGetAPIRequest) GetApiParams(params url.Values) {
...
func (r AlibabaDataRecommondGetAPIRequest) GetRawParams() model.Params {
	return r.Params
}
