...
// AccountAliyuncsComCreateAliyunAccountForBid2013_07_01APIRequest 为bid用户创建账号 API请求
...
func (r AccountAliyuncsComCreateAliyunAccountForBid2013_07_01APIRequest) GetApiParams(params url.Values) {
...
func (r AccountAliyuncsComCreateAliyunAccountForBid2013_07_01APIRequest) GetRawParams() model.Params {
	return r.Params
}
