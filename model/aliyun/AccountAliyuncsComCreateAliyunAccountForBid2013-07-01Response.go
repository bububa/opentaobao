...
type AccountAliyuncsComCreateAliyunAccountForBid2013-07-01APIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"account_aliyuncs_com_CreateAliyunAccountForBid_2013-07-01_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识
