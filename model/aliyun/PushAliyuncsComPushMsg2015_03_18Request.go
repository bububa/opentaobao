...
// Account Setter
// 用户账号列表,以换行区分,仅sendType为3时有效
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetAccount(_account string) error {
    r._account = _account
...
// 防打扰时长,取值范围为1~23
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetAntiHarassDuration(_antiHarassDuration int64) error {
...
// 防打扰开始时间点,取值范围为0~23
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetAntiHarassStartTime(_antiHarassStartTime int64) error {
...
// AppId Setter
// 应用标识
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetAppId(_appId int64) error {
    r._appId = _appId
    r.Set("AppId", _appId)
    return nil
}
...
// BatchNumber Setter
// 批次编号,用于统计活动推送效果
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetBatchNumber(_batchNumber string) error {
...
// Body Setter
// 消息体,UTF-8编码
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetBody(_body string) error {
    r._body = _body
    r.Set("Body", _body)
    return nil
}
...
// DeviceId Setter
// 设备编号列表,以换行区分,仅sendType为4时有效
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetDeviceId(_deviceId string) error {
...
// DeviceType Setter
// 设备类型,取值范围为:0~3云推送支持多种设备, 各种设备类型编号如下:IOS设备:deviceType&amp;1=1; Andriod设备:deviceType&amp;2=2;如果存在此字段,则 向指定的设备类型推送消息。默认为全部(3);
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetDeviceType(_deviceType int64) error {
...
// PushTime Setter
// 推送时间,若空表示立即推送,推送时间不能早于当前 时间
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetPushTime(_pushTime string) error {
...
// SendType Setter
// 推送类型,取值范围:1~4; 1:所有人,无需指定tag、 deviceType等2:一群人,必须指定tag3:指定用户,根 据用户账号列表文件发送消息4:指定设备,根据设备编 码列表文件发送消息默认值为1
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetSendType(_sendType int64) error {
...
// Tag Setter
// 标签名称,仅支持1个标签,仅sendType为2时有效
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetTag(_tag string) error {
    r._tag = _tag
    r.Set("Tag", _tag)
    return nil
}
...
// Timeout Setter
// 离线消息保存时长,取值范围为1~72,若不填,则表 示不保存离线消息
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetTimeout(_timeout int64) error {
    r._timeout = _timeout
...
// Title Setter
// 标题
func (r *PushAliyuncsComPushMsg2015_03_18Request) SetTitle(_title string) error {
    r._title = _title
    r.Set("Title", _title)
    return nil
}
