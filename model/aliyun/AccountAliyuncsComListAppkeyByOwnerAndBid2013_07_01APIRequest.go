...
// AccountAliyuncsComListAppkeyByOwnerAndBid2013_07_01APIRequest 根据渠道id和状态列出appkey API请求
...
func (r AccountAliyuncsComListAppkeyByOwnerAndBid2013_07_01APIRequest) GetApiParams(params url.Values) {
...
func (r AccountAliyuncsComListAppkeyByOwnerAndBid2013_07_01APIRequest) GetRawParams() model.Params {
	return r.Params
}
