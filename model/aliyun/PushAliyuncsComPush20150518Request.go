...
// 初始化PushAliyuncsComPush20150518Request对象
...
// Account Setter
// 用户账号列表,以换行区分,仅sendType为3时有效
func (r *PushAliyuncsComPush20150518Request) SetAccount(_account string) error {
    r._account = _account
...
// Android对应的activity,仅仅当androidOpenType=2有效
func (r *PushAliyuncsComPush20150518Request) SetAndroidActivity(_androidActivity string) error {
...
// 自定义的kv结构,开发者扩展用 针对android
func (r *PushAliyuncsComPush20150518Request) SetAndroidExtParameters(_androidExtParameters string) error {
...
// AndroidMusic Setter
// android通知声音
func (r *PushAliyuncsComPush20150518Request) SetAndroidMusic(_androidMusic string) error {
...
// 点击通知后动作,1:打开应用 2: 打开应用Activity 3:打开 url
func (r *PushAliyuncsComPush20150518Request) SetAndroidOpenType(_androidOpenType string) error {
...
// Android收到推送后打开对应的url,仅仅当androidOpenType=3有效
func (r *PushAliyuncsComPush20150518Request) SetAndroidOpenUrl(_androidOpenUrl string) error {
...
// 防打扰时长,取值范围为1~23
func (r *PushAliyuncsComPush20150518Request) SetAntiHarassDuration(_antiHarassDuration int64) error {
...
// 防打扰开始时间点,取值范围为0~23
func (r *PushAliyuncsComPush20150518Request) SetAntiHarassStartTime(_antiHarassStartTime int64) error {
...
// AppId Setter
// 应用标识
func (r *PushAliyuncsComPush20150518Request) SetAppId(_appId int64) error {
    r._appId = _appId
    r.Set("AppId", _appId)
    return nil
}
...
// BatchNumber Setter
// 批次编号,用于活动效果统计
func (r *PushAliyuncsComPush20150518Request) SetBatchNumber(_batchNumber string) error {
...
// Body Setter
// 推送内容
func (r *PushAliyuncsComPush20150518Request) SetBody(_body string) error {
    r._body = _body
    r.Set("Body", _body)
    return nil
}
...
// DeviceId Setter
// 推送接收设备，多个以逗号分隔
func (r *PushAliyuncsComPush20150518Request) SetDeviceId(_deviceId string) error {
...
// DeviceType Setter
// 设备类型,取值范围为:0~3云推送支持多种设备,各 种设备类型编号如下: 0:IOS设备; 1:Andriod设备 3:全部. 默认为3.
func (r *PushAliyuncsComPush20150518Request) SetDeviceType(_deviceType int64) error {
...
// IOSBadge Setter
// iOS应用图标右上角角标
func (r *PushAliyuncsComPush20150518Request) SetIOSBadge(_iOSBadge string) error {
...
// 自定义的kv结构,开发者扩展用 针对iOS设备
func (r *PushAliyuncsComPush20150518Request) SetIOSExtParameters(_iOSExtParameters string) error {
...
// IOSMusic Setter
// iOS通知声音
func (r *PushAliyuncsComPush20150518Request) SetIOSMusic(_iOSMusic string) error {
...
// PushTime Setter
// 推送时间,若空表示立即推送,推送时间不能早于当前时间
func (r *PushAliyuncsComPush20150518Request) SetPushTime(_pushTime string) error {
...
// Remind Setter
// 当APP不在线时候，是否通过通知提醒
func (r *PushAliyuncsComPush20150518Request) SetRemind(_remind bool) error {
    r._remind = _remind
...
// SendType Setter
// 推送类型,取值范围:1~4; 1:所有人,无需指定tag、 deviceType等2:一群人,必须指定tag3:指定用户,根据 用户账号列表文件发送消息4:指定设备,根据设备编码列 表文件发送消息默认值为1
func (r *PushAliyuncsComPush20150518Request) SetSendType(_sendType int64) error {
...
// StoreOffline Setter
// 离线消息是否保存,若保存, 在推送时候，用户即使不在线，下一次上线则会收到
func (r *PushAliyuncsComPush20150518Request) SetStoreOffline(_storeOffline bool) error {
...
// Summery Setter
// 通知的摘要
func (r *PushAliyuncsComPush20150518Request) SetSummery(_summery string) error {
    r._summery = _summery
...
// Timeout Setter
// 离线消息保存时长,取值范围为1~72,若不填,则表示不保存离线消息
func (r *PushAliyuncsComPush20150518Request) SetTimeout(_timeout int64) error {
    r._timeout = _timeout
...
// Title Setter
// 推送的标题内容.
func (r *PushAliyuncsComPush20150518Request) SetTitle(_title string) error {
    r._title = _title
    r.Set("Title", _title)
    return nil
}
