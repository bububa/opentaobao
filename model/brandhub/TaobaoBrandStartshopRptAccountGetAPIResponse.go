...
type TaobaobrandstartshoprptaccountgetAPIResponseModel struct {
	...
	// result
	AdvertiserRptList []TaobaobrandstartshoprptaccountgetResult `json:"advertiser_rpt_list,omitempty" xml:"advertiser_rpt_list>taobaobrandstartshoprptaccountget_result,omitempty"`
	// 错误信息
