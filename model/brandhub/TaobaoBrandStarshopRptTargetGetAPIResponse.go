...
type TaobaobrandstarshoprpttargetgetAPIResponseModel struct {
	...
	// 返回结果
	CampaignRptList []TaobaobrandstarshoprpttargetgetResult `json:"campaign_rpt_list,omitempty" xml:"campaign_rpt_list>taobaobrandstarshoprpttargetget_result,omitempty"`
	// 错误信息
