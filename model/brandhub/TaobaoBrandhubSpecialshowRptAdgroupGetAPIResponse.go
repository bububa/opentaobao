...
type TaobaobrandhubspecialshowrptadgroupgetAPIResponseModel struct {
	...
	// 返回结果
	AdgroupRptList []TaobaobrandhubspecialshowrptadgroupgetResult `json:"adgroup_rpt_list,omitempty" xml:"adgroup_rpt_list>taobaobrandhubspecialshowrptadgroupget_result,omitempty"`
	// 错误信息
