...
type TaobaobrandstartshoprptwordpackagegetAPIResponseModel struct {
	...
	// 返回结果
	CampaignRptList []TaobaobrandstartshoprptwordpackagegetResult `json:"campaign_rpt_list,omitempty" xml:"campaign_rpt_list>taobaobrandstartshoprptwordpackageget_result,omitempty"`
	// 错误信息
