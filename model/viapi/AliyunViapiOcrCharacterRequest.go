...
// ImageUrl Setter
// 待检测图片链接
func (r *AliyunViapiOcrCharacterRequest) SetImageUrl(_imageUrl string) error {
...
// ImageType Setter
// 图片类型, ,取范围[0:ImageURL, 1:ImageContent]
func (r *AliyunViapiOcrCharacterRequest) SetImageType(_imageType int64) error {
...
// MinHeight Setter
// 图片中文字的最小高度，单位像素
func (r *AliyunViapiOcrCharacterRequest) SetMinHeight(_minHeight int64) error {
...
// 是否输出文字框的概率,取值范围[true:是, false:否]
func (r *AliyunViapiOcrCharacterRequest) SetOutputProbability(_outputProbability bool) error {
