...
type PosLogDto struct {
    ...
    // 当前操作步骤
    OperStep   string `json:"oper_step,omitempty"`
    ...
    // 联网:ON/OFF
    NetStat   string `json:"net_stat,omitempty"`
    ...
    // pos日志发生时间(本地时间)
    HappenTime   string `json:"happen_time,omitempty"`
    ...
    // 告警级别
    BizAlarmLevel   string `json:"biz_alarm_level,omitempty"`
