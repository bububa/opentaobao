...
type TravelHeadDto struct {
    ...
    PeerStaffList   []PeerStaff `json:"peer_staff_list,omitempty" xml:"peer_staff_list,omitempty"`
    ...
    LineList   []TravelLineDto `json:"line_list,omitempty" xml:"line_list,omitempty"`
