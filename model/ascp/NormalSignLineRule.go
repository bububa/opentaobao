...
var poolNormalSignLineRule = sync.Pool{
	New: func() any {
		return new(NormalSignLineRule)
	},
}

// GetNormalSignLineRule() 从对象池中获取NormalSignLineRule
func GetNormalSignLineRule() *NormalSignLineRule {
	return poolNormalSignLineRule.Get().(*NormalSignLineRule)
}

// ReleaseNormalSignLineRule 释放NormalSignLineRule
func ReleaseNormalSignLineRule(v *NormalSignLineRule) {
