...
func (r YunosTvpubadminContentSingleVideoGetlistAPIRequest) GetApiParams(params url.Values) {
...
func (r YunosTvpubadminContentSingleVideoGetlistAPIRequest) GetRawParams() model.Params {
	return r.Params
}
