...
var poolAfterChangeSegments = sync.Pool{
	New: func() any {
		return new(AfterChangeSegments)
	},
}

// GetAfterChangeSegments() 从对象池中获取AfterChangeSegments
func GetAfterChangeSegments() *AfterChangeSegments {
	return poolAfterChangeSegments.Get().(*AfterChangeSegments)
}

// ReleaseAfterChangeSegments 释放AfterChangeSegments
func ReleaseAfterChangeSegments(v *AfterChangeSegments) {
	v.CabinClass = ""
	v.FlightNo = ""
	v.DepTime = ""
	v.ArrCity = ""
