...
type AuxRefundApiBean struct {
    ...
    CanRefundIndependent   bool `json:"can_refund_independent,omitempty"`

    // 改规则。 最多允许200个字符。 禁止空格等特殊符号。
    ModifyRule   string `json:"modify_rule,omitempty"`

    // 是否可改 true可以，false不可以 当refundRule=true时此节点必传
    CanModify   bool `json:"can_modify,omitempty"`

    // 是否可单独改 true可以，false不可以
    CanModifyIndependent   bool `json:"can_modify_independent,omitempty"`
