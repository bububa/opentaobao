...
type PolicyCreateResponseDto struct {
	...
	// 创建结果
	CreateResult *AlitripPolicyNormalUploadResultDto `json:"create_result,omitempty" xml:"create_result,omitempty"`
	// 删除结果
	DeleteResult *AlitripPolicyNormalUploadResultDto `json:"delete_result,omitempty" xml:"delete_result,omitempty"`
	// 政策进度类型
