...
type AuxProductItemApiBean struct {
    ...
    Baggage  *struct {
        BaggageApiBean  *BaggageApiBean `json:"baggage_api_bean,omitempty"`
    } `json:"baggage,omitempty"`
    ...
    Service  *struct {
        ServiceApiBean  *ServiceApiBean `json:"service_api_bean,omitempty"`
    ...
    SalesRule  *struct {
        SalesRuleApiBean  *SalesRuleApiBean `json:"sales_rule_api_bean,omitempty"`
    } `json:"sales_rule,omitempty"`
    

    // 辅营产品退改规则
    
    RefundRule  *struct {
        AuxRefundApiBean  *AuxRefundApiBean `json:"aux_refund_api_bean,omitempty"`
    } `json:"refund_rule,omitempty"`
    ...
    Seat  *struct {
        SeatApiBean  *SeatApiBean `json:"seat_api_bean,omitempty"`
    } `json:"seat,omitempty"`
...
type AuxProductItemApiBean struct {
    ...
    // 行李说明，当productType=4为必传
    Baggage   *BaggageApiBean `json:"baggage,omitempty"`
    ...
    // 辅营产品服务说明,仅当productType=1或productType=2为必传
    Service   *ServiceApiBean `json:"service,omitempty"`

    // 在线价，是对旅客展示的销售价格。 仅允许100的倍数。 币种：人民币。单位：分。
    OnlinePrice   int64 `json:"online_price,omitempty"`

    // 辅营产品销售规则
    SalesRule   *SalesRuleApiBean `json:"sales_rule,omitempty"`

    // 辅营产品退改规则
    RefundRule   *AuxRefundApiBean `json:"refund_rule,omitempty"`
    ...
    // 选座说明，当productType=3或8 为必传
    Seat   *SeatApiBean `json:"seat,omitempty"`
