...
var poolPassengerBaseInfo = sync.Pool{
	New: func() any {
		return new(PassengerBaseInfo)
	},
}

// GetPassengerBaseInfo() 从对象池中获取PassengerBaseInfo
func GetPassengerBaseInfo() *PassengerBaseInfo {
	return poolPassengerBaseInfo.Get().(*PassengerBaseInfo)
}

// ReleasePassengerBaseInfo 释放PassengerBaseInfo
func ReleasePassengerBaseInfo(v *PassengerBaseInfo) {
	v.IdCard = ""
	v.Age = 0
	v.CardType = 0
	poolPassengerBaseInfo.Put(v)
}
