...
// Schema Setter
// 账户体系隔离
func (r *AlibabaAilabsAligenieAlbumsSearchRequest) SetSchema(_schema string) error {
    r._schema = _schema
...
// UserId Setter
// 用户ID，此处传入第三方账户体系的用户id
func (r *AlibabaAilabsAligenieAlbumsSearchRequest) SetUserId(_userId string) error {
    r._userId = _userId
...
// UtdId Setter
// 用户设备唯一识别码，长度限制32以内，建议使用系统接口获取deviceid,然后做一定的混淆处理来作为此输入参数
func (r *AlibabaAilabsAligenieAlbumsSearchRequest) SetUtdId(_utdId string) error {
    r._utdId = _utdId
    r.Set("utd_id", _utdId)
    return nil
}
...
// Ext Setter
// 扩展信息，用于存放APP类型等
func (r *AlibabaAilabsAligenieAlbumsSearchRequest) SetExt(_ext string) error {
    r._ext = _ext
    r.Set("ext", _ext)
    return nil
}
...
// Param1 Setter
// 一级类目，如：儿童、新闻、商业财经有声书等
func (r *AlibabaAilabsAligenieAlbumsSearchRequest) SetParam1(_param1 string) error {
    r._param1 = _param1
...
// Param2 Setter
// 二级类目，如儿童下有：儿歌、童谣、国学等
func (r *AlibabaAilabsAligenieAlbumsSearchRequest) SetParam2(_param2 string) error {
    r._param2 = _param2
...
// Param3 Setter
// 搜索的单个专辑名称
func (r *AlibabaAilabsAligenieAlbumsSearchRequest) SetParam3(_param3 string) error {
    r._param3 = _param3
...
// Param4 Setter
// 当前页（从1开始, 目前由于底层引擎限制，实际最多能查5000个，超过5000返回为空，请确保页码*分页大小不超过5000）
func (r *AlibabaAilabsAligenieAlbumsSearchRequest) SetParam4(_param4 int64) error {
    r._param4 = _param4
...
// Param5 Setter
// 每页数量（不超过50）
func (r *AlibabaAilabsAligenieAlbumsSearchRequest) SetParam5(_param5 int64) error {
    r._param5 = _param5
