...
// Schema Setter
// 账户体系隔离
func (r *TaobaoAilabAicloudTopMessageListRequest) SetSchema(_schema string) error {
    r._schema = _schema
...
// UserId Setter
// 用户ID，此处传入第三方账户体系的用户id
func (r *TaobaoAilabAicloudTopMessageListRequest) SetUserId(_userId string) error {
    r._userId = _userId
...
// UtdId Setter
// 用户设备唯一识别码，长度限制32以内，建议使用系统接口获取deviceid,然后做一定的混淆处理来作为此输入参数
func (r *TaobaoAilabAicloudTopMessageListRequest) SetUtdId(_utdId string) error {
    r._utdId = _utdId
    r.Set("utd_id", _utdId)
    return nil
}
...
// Ext Setter
// 扩展信息，用于存放APP类型等
func (r *TaobaoAilabAicloudTopMessageListRequest) SetExt(_ext string) error {
    r._ext = _ext
    r.Set("ext", _ext)
    return nil
}
...
// BeforeTime Setter
// 截止时间，yyyy-MM-dd HH:mm:ss.SSS
func (r *TaobaoAilabAicloudTopMessageListRequest) SetBeforeTime(_beforeTime string) error {
...
// Limit Setter
// 一次性展示多少条信息
func (r *TaobaoAilabAicloudTopMessageListRequest) SetLimit(_limit int64) error {
    r._limit = _limit
    r.Set("limit", _limit)
    return nil
}
