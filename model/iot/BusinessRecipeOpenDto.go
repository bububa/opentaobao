...
type BusinessRecipeOpenDto struct {
    ...
    RecipeIngredientList   []RecipeIngredientDto `json:"recipe_ingredient_list,omitempty" xml:"recipe_ingredient_list,omitempty"`
    ...
    RecipeStepList   []BusinessRecipeStepOpenDto `json:"recipe_step_list,omitempty" xml:"recipe_step_list,omitempty"`
    ...
    TagList   []ContentTagDto `json:"tag_list,omitempty" xml:"tag_list,omitempty"`
