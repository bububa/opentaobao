...
type BusinessRecipeOpenDto struct {
    ...
    RecipeIngredientList  struct {
        RecipeIngredientDto  []RecipeIngredientDto `json:"recipe_ingredient_dto,omitempty"`
    ...
    RecipeStepList  struct {
        BusinessRecipeStepOpenDto  []BusinessRecipeStepOpenDto `json:"business_recipe_step_open_dto,omitempty"`
    } `json:"recipe_step_list,omitempty"`
    ...
    TagList  struct {
        ContentTagDto  []ContentTagDto `json:"content_tag_dto,omitempty"`
