...
type StandardOrderTrackingInfoDto struct {
    ...
    FoodsInfos   []FoodsInfo `json:"foods_infos,omitempty" xml:"foods_infos,omitempty"`
    

    // 订单杂项费用
    
    OrderExtras   []OrderExtra `json:"order_extras,omitempty" xml:"order_extras,omitempty"`
