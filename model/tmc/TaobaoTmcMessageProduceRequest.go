...
// Content Setter
// 消息内容的JSON表述，必须按照topic的定义来填充
func (r *TaobaoTmcMessageProduceRequest) SetContent(_content string) error {
    r._content = _content
...
// Topic Setter
// 消息类型
func (r *TaobaoTmcMessageProduceRequest) SetTopic(_topic string) error {
    r._topic = _topic
    r.Set("topic", _topic)
    return nil
}
...
// TargetGroup Setter
// 目标分组，一般为default
func (r *TaobaoTmcMessageProduceRequest) SetTargetGroup(_targetGroup string) error {
