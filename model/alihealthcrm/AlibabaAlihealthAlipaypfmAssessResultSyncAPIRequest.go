...
func (r AlibabaAlihealthAlipaypfmAssessResultSyncAPIRequest) GetApiParams(params url.Values) {
...
func (r AlibabaAlihealthAlipaypfmAssessResultSyncAPIRequest) GetRawParams() model.Params {
	return r.Params
}
