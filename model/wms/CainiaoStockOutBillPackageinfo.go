...
type CainiaoStockOutBillPackageinfo struct {
    ...
    PackageItemList  struct {
        CainiaoStockOutBillPackageitemlist  []CainiaoStockOutBillPackageitemlist `json:"cainiao_stock_out_bill_packageitemlist,omitempty"`
    } `json:"package_item_list,omitempty"`
