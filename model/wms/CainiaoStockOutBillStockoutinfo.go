...
type CainiaoStockOutBillStockoutinfo struct {
    ...
    PackageInfoList   []CainiaoStockOutBillPackageinfolist `json:"package_info_list,omitempty" xml:"package_info_list,omitempty"`
    

    // 订单商品列表
    
    OrderItemList   []CainiaoStockOutBillOrderitemlist `json:"order_item_list,omitempty" xml:"order_item_list,omitempty"`
