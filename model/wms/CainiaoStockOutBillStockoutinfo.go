...
type CainiaoStockOutBillStockoutinfo struct {
    ...
    PackageInfoList  struct {
        CainiaoStockOutBillPackageinfolist  []CainiaoStockOutBillPackageinfolist `json:"cainiao_stock_out_bill_packageinfolist,omitempty"`
    } `json:"package_info_list,omitempty"`
    

    // 订单商品列表
    
    OrderItemList  struct {
        CainiaoStockOutBillOrderitemlist  []CainiaoStockOutBillOrderitemlist `json:"cainiao_stock_out_bill_orderitemlist,omitempty"`
