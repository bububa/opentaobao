...
type TopTripOrderResult struct {
    ...
    SubOrders   []SubOrderInfo `json:"sub_orders,omitempty" xml:"sub_orders,omitempty"`
    ...
    ScoreDetails   []ScoreDetail `json:"score_details,omitempty" xml:"score_details,omitempty"`
