...
type OrderInfo struct {
    ...
    OutBuyer  *struct {
        OrderUser  *OrderUser `json:"order_user,omitempty"`
    } `json:"out_buyer,omitempty"`
    ...
    PerformanceWay   string `json:"performance_way,omitempty"`
    ...
    BusinessTypeDesc   string `json:"business_type_desc,omitempty"`
    ...
    DinnerNumber   string `json:"dinner_number,omitempty"`
    

    // 就餐人数
    
    DinnerPersons   int64 `json:"dinner_persons,omitempty"`
    

    // 就餐形式:FOR_HERE堂食  TAKE_OUT外带  SEND外送  TO_GO自提  OTHER其他
    
    DinnerType   string `json:"dinner_type,omitempty"`
    ...
    OutCashierId   string `json:"out_cashier_id,omitempty"`
    

    // 收银员名称
    
    OutCashierName   string `json:"out_cashier_name,omitempty"`
    

    // 配送员id
    
    OutDeliveryId   string `json:"out_delivery_id,omitempty"`
    

    // 配送员名称
    
    OutDeliveryName   string `json:"out_delivery_name,omitempty"`
    ...
    OutSalesmanId   string `json:"out_salesman_id,omitempty"`
    

    // 销售员名称
    
    OutSalesmanName   string `json:"out_salesman_name,omitempty"`
    

    // 卖家id
    
    OutSellerId   string `json:"out_seller_id,omitempty"`
    ...
    OutVipUserId   string `json:"out_vip_user_id,omitempty"`
    

    // 服务员id
    
    OutWaiterId   string `json:"out_waiter_id,omitempty"`
    

    // 服务员名称
    
    OutWaiterName   string `json:"out_waiter_name,omitempty"`
    ...
    RelatedOutOrderNo   string `json:"related_out_order_no,omitempty"`
    ...
    ScrapFee   int64 `json:"scrap_fee,omitempty"`
    ...
    VipUserId   string `json:"vip_user_id,omitempty"`
    ...
    AttachTotalFee   int64 `json:"attach_total_fee,omitempty"`
    ...
    TaxTotalFee   int64 `json:"tax_total_fee,omitempty"`
    

    // 外部组织id，辰森和客如云直接填out_store_id
    
    OutOrgId   string `json:"out_org_id,omitempty"`
...
type OrderInfo struct {
    ...
    // 外部买家基础信息
    OutBuyer   *OrderUser `json:"out_buyer,omitempty"`

    // 外部卖家基础信息
    OutSeller   *OrderUser `json:"out_seller,omitempty"`
