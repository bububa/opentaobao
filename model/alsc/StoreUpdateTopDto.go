...
type StoreUpdateTopDto struct {
    ...
    StoreAdress  *struct {
        StoreAdressDto  *StoreAdressDto `json:"store_adress_dto,omitempty"`
    } `json:"store_adress,omitempty"`
    

    // 门店信息
    
    StoreKeeper  *struct {
        StoreKeeperDto  *StoreKeeperDto `json:"store_keeper_dto,omitempty"`
    } `json:"store_keeper,omitempty"`
    ...
    Attributes  struct {
        AttributeValueTopDto  []AttributeValueTopDto `json:"attribute_value_top_dto,omitempty"`
    } `json:"attributes,omitempty"`
    

    // 类目属性
    
    CategoryPropertyValues  struct {
        PropertyValueTopDto  []PropertyValueTopDto `json:"property_value_top_dto,omitempty"`
    } `json:"category_property_values,omitempty"`
    ...
    BizAttributes  struct {
        AttributeValueTopDto  []AttributeValueTopDto `json:"attribute_value_top_dto,omitempty"`
    } `json:"biz_attributes,omitempty"`
