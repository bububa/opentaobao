...
type RefundInfo struct {
    ...
    RefundItemList  struct {
        Item  []Item `json:"item,omitempty"`
    } `json:"refund_item_list,omitempty"`
    

    // 退款流水号（支付宝单号、微信单号、三方单号）
    
    RefundPayNo   string `json:"refund_pay_no,omitempty"`
...
type RefundInfo struct {
    ...
    // 退款商品
    RefundItemList   []Item `json:"refund_item_list,omitempty"`
