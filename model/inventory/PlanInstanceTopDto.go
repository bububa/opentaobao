...
type PlanInstanceTopDto struct {
    ...
    PromiseList   []PromiseList `json:"promise_list,omitempty" xml:"promise_list,omitempty"`
    ...
    RelationList   []RelationList `json:"relation_list,omitempty" xml:"relation_list,omitempty"`
