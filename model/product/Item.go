...
type Item struct {
    ...
    Skus   []Sku `json:"skus,omitempty" xml:"skus,omitempty"`
    ...
    ItemImgs   []ItemImg `json:"item_imgs,omitempty" xml:"item_imgs,omitempty"`
    ...
    PropImgs   []PropImg `json:"prop_imgs,omitempty" xml:"prop_imgs,omitempty"`
    ...
    Videos   []Video `json:"videos,omitempty" xml:"videos,omitempty"`
    ...
    ItemRectangleImgs   []ItemImg `json:"item_rectangle_imgs,omitempty" xml:"item_rectangle_imgs,omitempty"`
