...
type Item struct {
    ...
    EmsFee   float64 `json:"ems_fee,omitempty"`
    ...
    ItemRectangleImgs  struct {
        ItemImg  []ItemImg `json:"item_img,omitempty"`
    } `json:"item_rectangle_imgs,omitempty"`
    ...
    DescModuleInfo   string `json:"desc_module_info,omitempty"`
    ...
    FoodSecurity   string `json:"food_security,omitempty"`
    ...
    CuntaoItemSpecific   string `json:"cuntao_item_specific,omitempty"`
    ...
    PaimaiInfo   string `json:"paimai_info,omitempty"`
    ...
    GlobalStockDeliveryPlace   string `json:"global_stock_delivery_place,omitempty"`
    

    // 全球购商品卖家包税承诺，当值为true时，代表卖家承诺包税。
    
    GlobalStockTaxFreePromise   bool `json:"global_stock_tax_free_promise,omitempty"`
    

    // 商品3:4比例主图
    
    MainPic34   string `json:"main_pic34,omitempty"`
    

    // 商品竖图
    
    UprightImageUrl   string `json:"upright_image_url,omitempty"`
...
type Item struct {
    ...
    // 商品图片列表(包括主图)。fields中只设置item_img可以返回ItemImg结构体中所有字段，如果设置为item_img.id、item_img.url、item_img.position等形式就只会返回相应的字段
    ItemImgs   []ItemImg `json:"item_imgs,omitempty"`

    // 商品属性图片列表。fields中只设置prop_img可以返回PropImg结构体中所有字段，如果设置为prop_img.id、prop_img.url、prop_img.properties、prop_img.position等形式就只会返回相应的字段
    PropImgs   []PropImg `json:"prop_imgs,omitempty"`
    ...
    // itemRectangleImgs
    ItemRectangleImgs   []ItemImg `json:"item_rectangle_imgs,omitempty"`
