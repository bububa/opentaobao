...
// CategoryId Setter
// 商品发布的目标类目，必须是叶子类目
func (r *TmallItemSchemaAddRequest) SetCategoryId(_categoryId int64) error {
...
// ProductId Setter
// 发布商品的productId，如果tmall.product.match.schema.get获取到得字段为空，这个参数传入0，否则需要通过tmall.product.schema.match查询到得可用productId
func (r *TmallItemSchemaAddRequest) SetProductId(_productId int64) error {
...
// XmlData Setter
// 根据tmall.item.add.schema.get生成的商品发布规则入参数据
func (r *TmallItemSchemaAddRequest) SetXmlData(_xmlData string) error {
    r._xmlData = _xmlData
