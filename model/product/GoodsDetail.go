...
type GoodsDetail struct {
    ...
    ThumbUrls  struct {
        String  []string `json:"string,omitempty"`
    } `json:"thumb_urls,omitempty"`
    

    // property_list 产品属性
    
    PropertyList  struct {
        WholesaleGoodsAttribute  []WholesaleGoodsAttribute `json:"wholesale_goods_attribute,omitempty"`
    } `json:"property_list,omitempty"`
    ...
    SupplierInfo  *struct {
        WholesaleUser  *WholesaleUser `json:"wholesale_user,omitempty"`
    } `json:"supplier_info,omitempty"`
    

    // 产品物流信息
    
    FreightInfoList  struct {
        FreightInfo  []FreightInfo `json:"freight_info,omitempty"`
    } `json:"freight_info_list,omitempty"`
