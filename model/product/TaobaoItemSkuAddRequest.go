...
// NumIid Setter
// Sku所属商品数字id。必选
func (r *TaobaoItemSkuAddRequest) SetNumIid(_numIid int64) error {
    r._numIid = _numIid
...
// Properties Setter
// Sku属性串。格式:pid:vid;pid:vid,如:1627207:3232483;1630696:3284570,表示:机身颜色:军绿色;手机套餐:一电一充。
func (r *TaobaoItemSkuAddRequest) SetProperties(_properties string) error {
...
// Quantity Setter
// Sku的库存数量。sku的总数量应该小于等于商品总数量(Item的NUM)。取值范围:大于零的整数
func (r *TaobaoItemSkuAddRequest) SetQuantity(_quantity int64) error {
...
// Price Setter
// Sku的销售价格。商品的价格要在商品所有的sku的价格之间。精确到2位小数;单位:元。如:200.07，表示:200元7分
func (r *TaobaoItemSkuAddRequest) SetPrice(_price float64) error {
    r._price = _price
    r.Set("price", _price)
    return nil
}
...
// OuterId Setter
// Sku的商家外部id
func (r *TaobaoItemSkuAddRequest) SetOuterId(_outerId string) error {
    r._outerId = _outerId
...
// ItemPrice Setter
// sku所属商品的价格。当用户新增sku，使商品价格不属于sku价格之间的时候，用于修改商品的价格，使sku能够添加成功
func (r *TaobaoItemSkuAddRequest) SetItemPrice(_itemPrice float64) error {
...
// Lang Setter
// Sku文字的版本。可选值:zh_HK(繁体),zh_CN(简体);默认值:zh_CN
func (r *TaobaoItemSkuAddRequest) SetLang(_lang string) error {
    r._lang = _lang
    r.Set("lang", _lang)
    return nil
}
...
// 忽略警告提示.
func (r *TaobaoItemSkuAddRequest) SetIgnorewarning(_ignorewarning string) error {
