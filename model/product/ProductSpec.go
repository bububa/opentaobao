...
type ProductSpec struct {
    ...
    CertifiedPics  struct {
        CertPicInfo  []CertPicInfo `json:"cert_pic_info,omitempty"`
    } `json:"certified_pics,omitempty"`
...
type ProductSpec struct {
    ...
    // 认证图片列表
    CertifiedPics   []CertPicInfo `json:"certified_pics,omitempty"`
