...
type TopHotelSearchListParam struct {
    ...
    } `json:"search_poi,omitempty"`
    

    // 品牌code
    
    BrandCodeList  struct {
        String  []string `json:"string,omitempty"`
    } `json:"brand_code_list,omitempty"`
...
type TopHotelSearchListParam struct {
    ...
    // 儿童年龄
    ChildrenAges   []int64 `json:"children_ages,omitempty"`
