...
type TaobaoXhotelCityGetAPIResponse struct {
    ...
    // Response *TaobaoXhotelCityGetResponse `json:"xhotel_city_get_response,omitempty"` 
...
type TaobaoXhotelCityGetResponse struct {
    ...
    Divisions  struct {
        HotelDivision  []HotelDivision `json:"hotel_division,omitempty"`
...
type TaobaoXhotelCityGetResponse struct {
    ...
    // 酒店区域的数据列表
    Divisions   []HotelDivision `json:"divisions,omitempty"`
