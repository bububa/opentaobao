...
type ItemInfo struct {
    ...
    OthersDiscounts  struct {
        String  []string `json:"string,omitempty"`
    } `json:"others_discounts,omitempty"`
    ...
    RefundPolicys  struct {
        String  []string `json:"string,omitempty"`
    } `json:"refund_policys,omitempty"`
...
type ItemInfo struct {
    ...
    // 日历外币价（酒店本地价)
    DailyPrices   []string `json:"daily_prices,omitempty"`
