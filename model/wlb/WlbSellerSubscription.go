...
type WlbSellerSubscription struct {
	...
	// 联系人地址信息
	WlbPartnerAddress *WlbPartnerAddress `json:"wlb_partner_address,omitempty" xml:"wlb_partner_address,omitempty"`
	// 联系人联系详情
	WlbPartnerContact *WlbPartnerContact `json:"wlb_partner_contact,omitempty" xml:"wlb_partner_contact,omitempty"`
