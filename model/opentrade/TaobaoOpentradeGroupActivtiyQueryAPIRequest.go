...
// TaobaoOpentradeGroupActivtiyQueryAPIRequest 组团活动信息查询 API请求
...
func (r TaobaoOpentradeGroupActivtiyQueryAPIRequest) GetApiParams(params url.Values) {
...
func (r TaobaoOpentradeGroupActivtiyQueryAPIRequest) GetRawParams() model.Params {
	return r.Params
}
