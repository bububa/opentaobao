...
// GroupId Setter
// 团id
func (r *TaobaoOpentradeGroupMemberInfoRequest) SetGroupId(_groupId int64) error {
    r._groupId = _groupId
...
// OpenUserId Setter
// 用户openId
func (r *TaobaoOpentradeGroupMemberInfoRequest) SetOpenUserId(_openUserId string) error {
