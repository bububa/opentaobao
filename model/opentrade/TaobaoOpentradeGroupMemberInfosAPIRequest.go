...
func (r TaobaoOpentradeGroupMemberInfosAPIRequest) GetApiParams(params url.Values) {
...
func (r TaobaoOpentradeGroupMemberInfosAPIRequest) GetRawParams() model.Params {
	return r.Params
}
