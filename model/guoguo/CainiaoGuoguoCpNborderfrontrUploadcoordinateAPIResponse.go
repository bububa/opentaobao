...
// CainiaoGuoguoCpNborderfrontrUploadcoordinateAPIResponseModel is 上传小件员GPS位置信息 成功返回结果
type CainiaoGuoguoCpNborderfrontrUploadcoordinateAPIResponseModel struct {
