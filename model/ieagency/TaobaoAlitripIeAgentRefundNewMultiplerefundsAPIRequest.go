...
// TaobaoAlitripIeAgentRefundNewMultiplerefundsAPIRequest 补退接口 API请求
...
// NewTaobaoAlitripIeAgentRefundNewMultiplerefundsRequest 初始化TaobaoAlitripIeAgentRefundNewMultiplerefundsAPIRequest对象
