...
type IeChangeOrderVo struct {
    ...
    ChangePassengerVOS   []IeChangePassengerVo `json:"change_passenger_v_o_s,omitempty" xml:"change_passenger_v_o_s,omitempty"`
    ...
    ChangeTicketVOS   []IeChangeTicketVo `json:"change_ticket_v_o_s,omitempty" xml:"change_ticket_v_o_s,omitempty"`
