...
type RefundOrderVo struct {
    ...
    RefundPassengerFeeVos   []RefundPassengerFeeVo `json:"refund_passenger_fee_vos,omitempty" xml:"refund_passenger_fee_vos,omitempty"`
    

    // 退票乘机人列表
    
    RefundPassengerVos   []RefundPassengerVo `json:"refund_passenger_vos,omitempty" xml:"refund_passenger_vos,omitempty"`
