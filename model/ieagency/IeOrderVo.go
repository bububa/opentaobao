...
type IeOrderVo struct {
    ...
    PassgenerVos   []IePassgenerVo `json:"passgener_vos,omitempty" xml:"passgener_vos,omitempty"`
    ...
    BookOrderVos   []IeBookOrderVo `json:"book_order_vos,omitempty" xml:"book_order_vos,omitempty"`
    

    // activityVOs
    
    ActivityVos   []IeOrderActivityVo `json:"activity_vos,omitempty" xml:"activity_vos,omitempty"`
    

    // 辅营订单
    
    VirProOrderVos   []IeVirProOrderVo `json:"vir_pro_order_vos,omitempty" xml:"vir_pro_order_vos,omitempty"`
