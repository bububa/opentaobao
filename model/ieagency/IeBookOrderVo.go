...
type IeBookOrderVo struct {
    ...
    BookFlightVos   []IeBookFlightVo `json:"book_flight_vos,omitempty" xml:"book_flight_vos,omitempty"`
    ...
    BookTicketVos   []IeBookTicketVo `json:"book_ticket_vos,omitempty" xml:"book_ticket_vos,omitempty"`
