...
// BillCode Setter
// 单据编号【同一个企业不能上传相同单据号】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetBillCode(_billCode string) error {
...
// BillTime Setter
// 单据时间（扫码时间）
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetBillTime(_billTime string) error {
...
// BillType Setter
// 单据类型【102代表采购入库,201代表销售出库，其它单据类型详见文档】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetBillType(_billType int64) error {
...
// PhysicType Setter
// 药品类型【3普药2特药】89开头的码定义为特药，其它码定义成普药
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetPhysicType(_physicType int64) error {
...
// RefUserId Setter
// 货主企业（单据的所有者，上传人）【注意：该入参是ref_ent_id，不是ent_id】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetRefUserId(_refUserId string) error {
...
// 第三方物流代理企业【注意：该入参是ref_ent_id，不是ent_id】，该字段兼容之前接口逻辑，后期将不允许使用，不要填值。
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetAgentRefUserId(_agentRefUserId string) error {
...
// FromUserId Setter
// 发货企业【注意：该入参是ent_id,并不是ref_ent_id】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetFromUserId(_fromUserId string) error {
...
// ToUserId Setter
// 收货企业【注意：该入参是ent_id,并不是ref_ent_id】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetToUserId(_toUserId string) error {
...
// DestUserId Setter
// 直调企业【注意：该入参是ent_id,并不是ref_ent_id】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetDestUserId(_destUserId string) error {
...
// OperIcCode Setter
// 操作人标识（appkey编号）
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetOperIcCode(_operIcCode string) error {
...
// OperIcName Setter
// 单据提交者姓名
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetOperIcName(_operIcName string) error {
...
// FileContent Setter
// 单据文件体【bas64字符串】，看对接文档中的代码示例，示例中有相应说明。
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetFileContent(_fileContent string) error {
...
// 单据名称
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetUploadFileName(_uploadFileName string) error {
...
// ClientType Setter
// 客户端类型【暂定都写2】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetClientType(_clientType string) error {
...
// QuReceivable Setter
// （协同平台数据合规）应收货总数量
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetQuReceivable(_quReceivable int64) error {
...
// XtIsCheck Setter
// （协同平台数据合规）是否验证，0：未通过验证，1：已验证
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetXtIsCheck(_xtIsCheck string) error {
...
// XtCheckCode Setter
// （协同平台数据合规）未验证通过原因【验证未通过时填写】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetXtCheckCode(_xtCheckCode string) error {
...
// （协同平台数据合规）未验证通过原因描述【验证未通过时填写】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetXtCheckCodeDesc(_xtCheckCodeDesc string) error {
...
// DrugListJson Setter
// （协同平台数据合规）药品列表Json："codeCount":         药品数量 "commDrugId":     国家药品唯一标识 "exprieDate":         生产日期 "physicInfo":          药品信息 "pkgSpec":           包状规格 "prepnCount":       制剂数量 "produceBatchNo":生产批次 "produceDate":      生产日期
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetDrugListJson(_drugListJson string) error {
...
// AssRefEntId Setter
// （协同平台数据合规）单据委托企业refEntId
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetAssRefEntId(_assRefEntId string) error {
...
// DisEntId Setter
// （协同平台数据合规）药品配送企业entId【出库单，收货方为医疗机构时填写】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetDisEntId(_disEntId string) error {
...
// DisRefEntId Setter
// （协同平台数据合规）药品配送企业【出库单，收货方为医疗机构时填写】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetDisRefEntId(_disRefEntId string) error {
...
// ToPerson Setter
// （协同平台数据合规）收货人【必选】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetToPerson(_toPerson string) error {
...
// FromPerson Setter
// （协同平台数据合规）发货人【必选】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetFromPerson(_fromPerson string) error {
...
// OrderCode Setter
// （协同平台数据合规）订货单编号【可选】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetOrderCode(_orderCode string) error {
...
// FromBillCode Setter
// （协同平台数据合规）发货单编号【必选】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetFromBillCode(_fromBillCode string) error {
...
// ToAddress Setter
// （协同平台数据合规）收货地址【必选】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetToAddress(_toAddress string) error {
...
// FromAddress Setter
// （协同平台数据合规）发货地址【必选】
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetFromAddress(_fromAddress string) error {
...
// AssEntId Setter
// （协同平台数据合规）单据委托企业entId
func (r *AlibabaAlihealthDrugKytUploadcircubillRequest) SetAssEntId(_assEntId string) error {
