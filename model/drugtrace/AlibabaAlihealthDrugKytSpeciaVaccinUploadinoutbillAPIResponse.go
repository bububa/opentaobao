...
// AlibabaAlihealthDrugKytSpeciaVaccinUploadinoutbillAPIResponse 疫苗企业出入库上传 API返回值
...
type AlibabaAlihealthDrugKytSpeciaVaccinUploadinoutbillAPIResponseModel struct {
	XMLName xml.Name `xml:"alibaba_alihealth_drug_kyt_specia_vaccin_uploadinoutbill_response"`
	// 平台颁发的每次请求访问的唯一标识
