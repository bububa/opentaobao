...
// BillCode Setter
// 单据编号（唯一）
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetBillCode(_billCode string) error {
...
// BillTime Setter
// 单据生成时间（一般写当前时间）
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetBillTime(_billTime string) error {
...
// BillType Setter
// 单据类型[321,零售出库][322,疫苗接种]
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetBillType(_billType int64) error {
...
// PhysicType Setter
// 药品类型[2,特药，3,普药]
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetPhysicType(_physicType int64) error {
...
// RefUserId Setter
// 码上放心平台企业唯一编码（门店或医疗机构）
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetRefUserId(_refUserId string) error {
...
// FromUserId Setter
// 发货企业(可为空)
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetFromUserId(_fromUserId string) error {
...
// OperIcCode Setter
// 单据提交者(appkey编号)
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetOperIcCode(_operIcCode string) error {
...
// OperIcName Setter
// 单据提交者姓名(可为空)
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetOperIcName(_operIcName string) error {
...
// TraceCodes Setter
// 20位追溯码（多个时用半角逗号分隔）
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetTraceCodes(_traceCodes []string) error {
...
// 购买人证件类型【1身份证2护照3 军官证4 医保卡5接种卡6学生证9其它】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetCustomerIdType(_customerIdType string) error {
...
// CustomerId Setter
// 购买人证件编号
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetCustomerId(_customerId string) error {
...
// UserTel Setter
// 用药人电话
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetUserTel(_userTel string) error {
    r._userTel = _userTel
...
// 互联标识 1是  0否
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetNetworkBillFlag(_networkBillFlag string) error {
...
// MedicDoctor Setter
// 医师名称
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetMedicDoctor(_medicDoctor string) error {
...
// 发药人
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetMedicDispenser(_medicDispenser string) error {
...
// UserName Setter
// 患者名称
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetUserName(_userName string) error {
...
// UserAgent Setter
// 代理领药人
func (r *AlibabaAlihealthDrugtraceTopYljgUploadretailRequest) SetUserAgent(_userAgent string) error {
