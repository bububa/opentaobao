...
type CodeStatusTypeDto struct {
    ...
    ParentCodeInfoList   []ParentCodeInfo `json:"parent_code_info_list,omitempty" xml:"parent_code_info_list,omitempty"`
    

    // 当前码的子码
    
    ChildCodes   []Childcodes `json:"child_codes,omitempty" xml:"child_codes,omitempty"`
