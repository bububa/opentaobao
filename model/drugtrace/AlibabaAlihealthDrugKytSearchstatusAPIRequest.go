...
func (r *AlibabaAlihealthDrugKytSearchstatusAPIRequest) Reset() {
	r._refEntId = ""
	r._beginDate = ""
	r._endDate = ""
	r._billType = ""
...
var poolAlibabaAlihealthDrugKytSearchstatusAPIRequest = sync.Pool{
	New: func() any {
		return NewAlibabaAlihealthDrugKytSearchstatusRequest()
	},
}

// GetAlibabaAlihealthDrugKytSearchstatusRequest 从 sync.Pool 获取 AlibabaAlihealthDrugKytSearchstatusAPIRequest
func GetAlibabaAlihealthDrugKytSearchstatusAPIRequest() *AlibabaAlihealthDrugKytSearchstatusAPIRequest {
	return poolAlibabaAlihealthDrugKytSearchstatusAPIRequest.Get().(*AlibabaAlihealthDrugKytSearchstatusAPIRequest)
}

// ReleaseAlibabaAlihealthDrugKytSearchstatusAPIRequest 将 AlibabaAlihealthDrugKytSearchstatusAPIRequest 放入 sync.Pool
func ReleaseAlibabaAlihealthDrugKytSearchstatusAPIRequest(v *AlibabaAlihealthDrugKytSearchstatusAPIRequest) {
	v.Reset()
	poolAlibabaAlihealthDrugKytSearchstatusAPIRequest.Put(v)
}
