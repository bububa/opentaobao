...
// BillCode Setter
// 单据编码
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetBillCode(_billCode string) error {
...
// BillTime Setter
// 单据时间
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetBillTime(_billTime string) error {
...
// BillType Setter
// 单据类型【102代表采购入库】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetBillType(_billType int64) error {
...
// PhysicType Setter
// 药品类型【3普药2特药】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetPhysicType(_physicType int64) error {
...
// RefUserId Setter
// 上传企业的单位编码
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetRefUserId(_refUserId string) error {
...
// 代理企业REF标识
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetAgentRefUserId(_agentRefUserId string) error {
...
// FromUserId Setter
// 发货企业entId
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetFromUserId(_fromUserId string) error {
...
// ToUserId Setter
// 收货企业entId
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetToUserId(_toUserId string) error {
...
// DestUserId Setter
// 直调企业标识
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetDestUserId(_destUserId string) error {
...
// OperIcCode Setter
// 单据提交者（appkey编号）
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetOperIcCode(_operIcCode string) error {
...
// OperIcName Setter
// 单据提交者姓名
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetOperIcName(_operIcName string) error {
...
// ClientType Setter
// 客户端类型[必须填2]
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetClientType(_clientType string) error {
...
// 退货原因代码[退货入出库时填写]
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetReturnReasonCode(_returnReasonCode string) error {
...
// 退货原因描述[退货入出库时填写]
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetReturnReasonDes(_returnReasonDes string) error {
...
// 注销原因代码【销毁出库时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetCancelReasonCode(_cancelReasonCode string) error {
...
// 注销原因描述【销毁出库时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetCancelReasonDes(_cancelReasonDes string) error {
...
// ExecuterName Setter
// 执行人姓名【销毁出库时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetExecuterName(_executerName string) error {
...
// ExecuterCode Setter
// 执行人证件号【销毁出库时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetExecuterCode(_executerCode string) error {
...
// 监督人姓名【销毁出库时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetSuperviserName(_superviserName string) error {
...
// 监督人证件号【销毁出库时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetSuperviserCode(_superviserCode string) error {
...
// WarehouseId Setter
// 仓号
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetWarehouseId(_warehouseId string) error {
...
// DrugId Setter
// 药品ID[企业自已系统的药品ID]
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetDrugId(_drugId string) error {
    r._drugId = _drugId
...
// TraceCodes Setter
// 追溯码[多个时用逗号分开]
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetTraceCodes(_traceCodes []string) error {
...
// FromAddress Setter
// （协同平台数据合规）发货地址【必选】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetFromAddress(_fromAddress string) error {
...
// ToAddress Setter
// （协同平台数据合规）收货地址【必选】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetToAddress(_toAddress string) error {
...
// FromBillCode Setter
// （协同平台数据合规）发货单编号【必选】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetFromBillCode(_fromBillCode string) error {
...
// OrderCode Setter
// （协同平台数据合规）订货单编号【可选】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetOrderCode(_orderCode string) error {
...
// FromPerson Setter
// （协同平台数据合规）发货人【必选】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetFromPerson(_fromPerson string) error {
...
// ToPerson Setter
// （协同平台数据合规）收货人【必选】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetToPerson(_toPerson string) error {
...
// DisRefEntId Setter
// （协同平台数据合规）药品配送企业【出库单，收货方为医疗机构时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetDisRefEntId(_disRefEntId string) error {
...
// DisEntId Setter
// （协同平台数据合规）药品配送企业entId【出库单，收货方为医疗机构时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetDisEntId(_disEntId string) error {
...
// QuReceivable Setter
// （协同平台数据合规）应收货总数量【必选】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetQuReceivable(_quReceivable int64) error {
...
// XtIsCheck Setter
// （协同平台数据合规）是否验证，0：未通过验证，1：已验证
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetXtIsCheck(_xtIsCheck string) error {
...
// XtCheckCode Setter
// （协同平台数据合规）未验证通过原因【验证未通过时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetXtCheckCode(_xtCheckCode string) error {
...
// （协同平台数据合规）未验证通过原因描述【验证未通过时填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetXtCheckCodeDesc(_xtCheckCodeDesc string) error {
...
// DrugListJson Setter
// （协同平台数据合规）药品列表Json
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetDrugListJson(_drugListJson string) error {
...
// AssRefEntId Setter
// （协同平台数据合规）单据委托企业refEntId【疫苗药品出库单填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetAssRefEntId(_assRefEntId string) error {
...
// AssEntId Setter
// （协同平台数据合规）单据委托企业entId【疫苗药品出库单填写】
func (r *AlibabaAlihealthDrugtraceTopYljgUploadinoutbillRequest) SetAssEntId(_assEntId string) error {
