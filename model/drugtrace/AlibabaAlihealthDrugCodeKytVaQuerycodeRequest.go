...
// RefEntId Setter
// 企业唯一标识（或appkey）
func (r *AlibabaAlihealthDrugCodeKytVaQuerycodeRequest) SetRefEntId(_refEntId string) error {
...
// Codes Setter
// 码列表
func (r *AlibabaAlihealthDrugCodeKytVaQuerycodeRequest) SetCodes(_codes []string) error {
    r._codes = _codes
    r.Set("codes", _codes)
    return nil
}
