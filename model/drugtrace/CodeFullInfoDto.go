...
type CodeFullInfoDto struct {
    ...
    ValidationRuleList   []Validationruledtos `json:"validation_rule_list,omitempty" xml:"validation_rule_list,omitempty"`
    

    // 单据流向信息
    
    BillInOutDTOS   []BillInOutDto `json:"bill_in_out_d_t_o_s,omitempty" xml:"bill_in_out_d_t_o_s,omitempty"`
