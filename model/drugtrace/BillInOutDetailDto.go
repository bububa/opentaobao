...
type BillInOutDetailDto struct {
    ...
    BillChkInOutDetailListDTOList   []Billchkinoutdetaillistdtolist `json:"bill_chk_in_out_detail_list_d_t_o_list,omitempty" xml:"bill_chk_in_out_detail_list_d_t_o_list,omitempty"`
