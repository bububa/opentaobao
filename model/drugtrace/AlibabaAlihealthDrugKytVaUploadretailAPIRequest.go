...
func (r AlibabaAlihealthDrugKytVaUploadretailAPIRequest) GetApiParams(params url.Values) {
...
func (r AlibabaAlihealthDrugKytVaUploadretailAPIRequest) GetRawParams() model.Params {
	return r.Params
}
