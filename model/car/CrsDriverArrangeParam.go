...
type CrsDriverArrangeParam struct {
    ...
    // 是否改派司机
    IsChangeDriver   bool `json:"is_change_driver,omitempty"`

    // 车型名称
    CarTypeName   string `json:"car_type_name,omitempty"`
    ...
    // 司机手机号
    DriverPhoneNum   string `json:"driver_phone_num,omitempty"`

    // 司机身份证号
    DriverIdCard   string `json:"driver_id_card,omitempty"`
