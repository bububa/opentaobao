...
// DeviceCode Setter
// 硬件CODE
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetDeviceCode(_deviceCode string) error {
...
// EndTime Setter
// 字段废弃
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetEndTime(_endTime string) error {
    r._endTime = _endTime
...
// StartTime Setter
// 字段废弃，考虑兼容，等同于op_time，两个必须传一个
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetStartTime(_startTime string) error {
...
// Action Setter
// ACTION枚举值： BODY_SENSOR（通过人体感应、人脸识别成功识别到人） ITEM_SENSOR（通过RFID、蓝牙等感应设备识别商品，必须设置ITEM_ID） ITEM_CLICK（商品点击时必须设置ITEM_ID）  RECEIVE_COUPONS（扫码领取优惠券时必须设置COUPON_ID） BUY_CLICK（点击购买，必须设置ITEM_ID）  SHARE_CLICK（点击分享）
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetAction(_action string) error {
    r._action = _action
...
// ItemId Setter
// 商品ID，item_id 在action为ITEM_CLICK、ITEM_SENSOR、BUY_CLICK必须传入；  必须使用淘宝商品id，否则失败。
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetItemId(_itemId string) error {
    r._itemId = _itemId
...
// CouponId Setter
// "例如官方领取优惠券链接里的activityId： https://taoquan.taobao.com/coupon/unify_apply.htm?sellerId=2649119619&activityId=9d390579777e41a981b54aa4d6154f5e"
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetCouponId(_couponId string) error {
...
// OuterBizId Setter
// 数据外部编码，保证数据唯一性
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetOuterBizId(_outerBizId string) error {
...
// OpTime Setter
// 操作时间，后续统一使用该字段，考虑兼容，start_time跟该字段含义一致
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetOpTime(_opTime string) error {
    r._opTime = _opTime
...
// UserNick Setter
// 用户昵称（混淆）
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetUserNick(_userNick string) error {
...
// OuterUser Setter
// 硬件识别的用户标识
func (r *TaobaoSmartstoreDeviceIashelfFeedbackRequest) SetOuterUser(_outerUser string) error {
