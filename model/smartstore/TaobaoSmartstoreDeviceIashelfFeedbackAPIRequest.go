...
// TaobaoSmartstoreDeviceIashelfFeedbackAPIRequest 智能硬件云货架数据回流 API请求
...
// NewTaobaoSmartstoreDeviceIashelfFeedbackRequest 初始化TaobaoSmartstoreDeviceIashelfFeedbackAPIRequest对象
