...
// TaobaoNrrsAcceptanceTaskUpdateResultAPIResponse 更新验收任务支付宝结果 API返回值
...
// TaobaoNrrsAcceptanceTaskUpdateResultAPIResponseModel is 更新验收任务支付宝结果 成功返回结果
type TaobaoNrrsAcceptanceTaskUpdateResultAPIResponseModel struct {
