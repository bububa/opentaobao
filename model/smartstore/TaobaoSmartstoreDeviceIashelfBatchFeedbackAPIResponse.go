...
// TaobaoSmartstoreDeviceIashelfBatchFeedbackAPIResponse 智能硬件互动云货架批量数据回流 API返回值
...
// TaobaoSmartstoreDeviceIashelfBatchFeedbackAPIResponseModel is 智能硬件互动云货架批量数据回流 成功返回结果
type TaobaoSmartstoreDeviceIashelfBatchFeedbackAPIResponseModel struct {
