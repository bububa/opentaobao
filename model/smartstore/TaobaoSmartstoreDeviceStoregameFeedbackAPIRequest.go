...
// TaobaoSmartstoreDeviceStoregameFeedbackAPIRequest 智能硬件互动大屏数据回流 API请求
...
// NewTaobaoSmartstoreDeviceStoregameFeedbackRequest 初始化TaobaoSmartstoreDeviceStoregameFeedbackAPIRequest对象
