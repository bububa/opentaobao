...
type PredictDeliveryTimeParam struct {
    ...
    TransportLocation  *struct {
        LocationParam  *LocationParam `json:"location_param,omitempty"`
    } `json:"transport_location,omitempty"`
    ...
    ReceiverLocation  *struct {
        LocationParam  *LocationParam `json:"location_param,omitempty"`
    } `json:"receiver_location,omitempty"`
    ...
    ItemInfos  struct {
        ItemInfoParam  []ItemInfoParam `json:"item_info_param,omitempty"`
