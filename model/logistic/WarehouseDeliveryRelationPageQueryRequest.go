...
type WarehouseDeliveryRelationPageQueryRequest struct {
    ...
    FromOrgResourceCodeList  struct {
        String  []string `json:"string,omitempty"`
    } `json:"from_org_resource_code_list,omitempty"`
    ...
    FromResourceCodeList  struct {
        String  []string `json:"string,omitempty"`
    } `json:"from_resource_code_list,omitempty"`
    ...
    ToResourceCodeList  struct {
        String  []string `json:"string,omitempty"`
    } `json:"to_resource_code_list,omitempty"`
