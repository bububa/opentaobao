...
type ReportOrderSummaryRequest struct {
    ...
    ReportDiagnoseMessageList   []Reportdiagnosemessagelist `json:"report_diagnose_message_list,omitempty" xml:"report_diagnose_message_list,omitempty"`
    

    // 异常项指标
    
    AbnormalItemList   []Abnormalitemlist `json:"abnormal_item_list,omitempty" xml:"abnormal_item_list,omitempty"`
