...
func (r AliexpressAffiliateProductQueryAPIRequest) GetApiParams(params url.Values) {
...
func (r AliexpressAffiliateProductQueryAPIRequest) GetRawParams() model.Params {
	return r.Params
}
