...
// TotalFee Setter
// 总的收费金额，单位为分
func (r *TaobaoXhotelOrderAlipayfaceCheckRequest) SetTotalFee(_totalFee int64) error {
...
// HotelCode Setter
// 参数必填，发布到阿里旅行的酒店编码
func (r *TaobaoXhotelOrderAlipayfaceCheckRequest) SetHotelCode(_hotelCode string) error {
...
// IdNumber Setter
// 证件号, 如果加密方式设置为1, 传入加密后的证件号
func (r *TaobaoXhotelOrderAlipayfaceCheckRequest) SetIdNumber(_idNumber string) error {
...
// EncryptType Setter
// 加密方式, 默认0: 不加密, 信息会通过淘宝开放平台传输, 阿里旅行可以获取到具体信息;  1: SHA-1不可逆加密,  阿里旅行方面无法解析到具体信息, 只用于做信息匹配.注意加密后生成40字节长度的字符串
func (r *TaobaoXhotelOrderAlipayfaceCheckRequest) SetEncryptType(_encryptType int64) error {
...
// Type Setter
// 验证类型.可以不设置. 默认0-信用住下单资格校验;1-已经创建的信用住订单,入住人在checkIn时的资格复审
func (r *TaobaoXhotelOrderAlipayfaceCheckRequest) SetType(_type int64) error {
    r._type = _type
    r.Set("type", _type)
    return nil
}
...
// IdType Setter
// 证件类型, 默认0:身份证; 1: 护照; 2:警官证; 3:士兵证; 4: 回乡证
func (r *TaobaoXhotelOrderAlipayfaceCheckRequest) SetIdType(_idType int64) error {
    r._idType = _idType
...
// Vendor Setter
// 不清楚请留空, 用于和outHid共同定位一个酒店
func (r *TaobaoXhotelOrderAlipayfaceCheckRequest) SetVendor(_vendor string) error {
    r._vendor = _vendor
...
// GuestName Setter
// 入住人姓名
func (r *TaobaoXhotelOrderAlipayfaceCheckRequest) SetGuestName(_guestName string) error {
...
// MobileNo Setter
// 客人手机号
func (r *TaobaoXhotelOrderAlipayfaceCheckRequest) SetMobileNo(_mobileNo string) error {
