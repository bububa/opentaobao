...
// Tid Setter
// 淘宝订单id,必须填写
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetTid(_tid int64) error {
    r._tid = _tid
    r.Set("tid", _tid)
    return nil
}
...
// TotalRoomFee Setter
// 房费总额(必须大于0)
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetTotalRoomFee(_totalRoomFee int64) error {
...
// OtherFee Setter
// 杂费总额(不能为负数)
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetOtherFee(_otherFee int64) error {
...
// 杂费明细,如果otherFee>0则该字段必须设置,并和杂费金额相吻合
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetOtherFeeDetail(_otherFeeDetail string) error {
...
// OutId Setter
// 商家订单号
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetOutId(_outId string) error {
    r._outId = _outId
    r.Set("out_id", _outId)
    return nil
}
...
// RoomNo Setter
// 入住房间号
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetRoomNo(_roomNo string) error {
    r._roomNo = _roomNo
...
// 每日房价,json格式,如果房价和在阿里旅行下单时发生了变化，必须设置该字段.用于更新阿里旅行端的房价信息,涉及到对用户的优惠信息处理等环节(多间房的时候dailyPriceInfo留空)
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetDailyPriceInfo(_dailyPriceInfo string) error {
...
// CheckOut Setter
// 实际离店日期，用于校验总房费收取
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetCheckOut(_checkOut string) error {
...
// Memo Setter
// 备注
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetMemo(_memo string) error {
    r._memo = _memo
    r.Set("memo", _memo)
    return nil
}
...
// 房间明细列表
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetRoomSettleInfoList(_roomSettleInfoList []RoomSettleInfo) error {
...
// 此金额是否包含担保金 0：默认值无意义；1：包含；2：不包含（多间房结账必须传入）
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetContainGuarantee(_containGuarantee int64) error {
...
// OutUuid Setter
// 结账请求流水号
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetOutUuid(_outUuid string) error {
    r._outUuid = _outUuid
...
// NotifyUrl Setter
// 请求结果通知地址（暂时无效，无需传入）
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetNotifyUrl(_notifyUrl string) error {
...
// Amount Setter
// 应收金额,大于0时，直接按照此金额扣款，忽略房费和杂费金额(单位分)
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetAmount(_amount int64) error {
    r._amount = _amount
...
// HotelCode Setter
// 商家酒店编码
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetHotelCode(_hotelCode string) error {
...
// Vendor Setter
// 系统商标识
func (r *TaobaoXhotelOrderOfflineSettlePutRequest) SetVendor(_vendor string) error {
    r._vendor = _vendor
