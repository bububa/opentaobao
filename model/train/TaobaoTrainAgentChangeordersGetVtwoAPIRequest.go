...
// TaobaoTrainAgentChangeordersGetVtwoAPIRequest 获取待改签订单v2--增加鉴权校验 API请求
...
// NewTaobaoTrainAgentChangeordersGetVtwoRequest 初始化TaobaoTrainAgentChangeordersGetVtwoAPIRequest对象
