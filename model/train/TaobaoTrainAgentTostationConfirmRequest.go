...
// MainOrderId Setter
// 淘宝的主订单号
func (r *TaobaoTrainAgentTostationConfirmRequest) SetMainOrderId(_mainOrderId int64) error {
...
// AgentId Setter
// 代理商id
func (r *TaobaoTrainAgentTostationConfirmRequest) SetAgentId(_agentId int64) error {
    r._agentId = _agentId
