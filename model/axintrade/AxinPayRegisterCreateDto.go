...
type AxinPayRegisterCreateDto struct {
    ...
    Sites   []AxinPayRegisterSiteInfo `json:"sites,omitempty" xml:"sites,omitempty"`
    ...
    Qualifications   []AxinPayRegisterQualification `json:"qualifications,omitempty" xml:"qualifications,omitempty"`
