...
type TmallServicecenterServicestoreDeleteservicestorecapacityAPIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"tmall_servicecenter_servicestore_deleteservicestorecapacity_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识
