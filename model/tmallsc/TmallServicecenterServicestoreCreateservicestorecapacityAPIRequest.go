...
// 初始化TmallServicecenterServicestoreCreateservicestorecapacityAPIRequest对象
...
func (r TmallServicecenterServicestoreCreateservicestorecapacityAPIRequest) GetApiParams() url.Values {
    params := url.Values{}
