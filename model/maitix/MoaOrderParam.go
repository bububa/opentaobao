...
type MoaOrderParam struct {
    ...
    SeatProps   []MoaTicketInfo `json:"seat_props,omitempty" xml:"seat_props,omitempty"`
    

    // 下单票品信息
    
    TicketItems   []MoaTicketItemSpec `json:"ticket_items,omitempty" xml:"ticket_items,omitempty"`
