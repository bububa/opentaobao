...
// 请求参数
func (r *AlibabaPerfectPerformanceLocalitemPublishRequest) SetParamPerfectPerformanceItemPublishReq(_paramPerfectPerformanceItemPublishReq *PerfectPerformanceItemPublishReq) error {
