...
type TmallMarketingFaceSkindetectAPIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"tmall_marketing_face_skindetect_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识
    ...
    DetectResult   string `json:"detect_result,omitempty" xml:"