...
type DealerOrder struct {
    ...
    AuditTimeSupplier   string `json:"audit_time_supplier,omitempty"`
    

    // 分销商最后一次确认/申请/拒绝的时间
    
    AuditTimeApplier   string `json:"audit_time_applier,omitempty"`
    ...
    DealerOrderDetails  struct {
        DealerOrderDetail  []DealerOrderDetail `json:"dealer_order_detail,omitempty"`
    } `json:"dealer_order_details,omitempty"`
    ...
    RebateFee   float64 `json:"rebate_fee,omitempty"`
...
type DealerOrder struct {
    ...
    // 产品明细
    DealerOrderDetails   []DealerOrderDetail `json:"dealer_order_details,omitempty"`
