...
// ProductId Setter
// 分销产品id。
func (r *TaobaoFenxiaoProductMapAddRequest) SetProductId(_productId int64) error {
...
// ScItemId Setter
// 后端商品id（如果当前分销产品没有sku和后端商品时需要指定）。
func (r *TaobaoFenxiaoProductMapAddRequest) SetScItemId(_scItemId int64) error {
...
// SkuIds Setter
// 分销产品的sku id。逗号分隔，顺序需要保证与sc_item_ids一致（没有sku就不传）。
func (r *TaobaoFenxiaoProductMapAddRequest) SetSkuIds(_skuIds string) error {
    r._skuIds = _skuIds
...
// ScItemIds Setter
// 在有sku的情况下，与各个sku对应的后端商品id列表。逗号分隔，顺序需要保证与sku_ids一致。
func (r *TaobaoFenxiaoProductMapAddRequest) SetScItemIds(_scItemIds string) error {
...
// 是否需要校验商家编码，true不校验，false校验。
func (r *TaobaoFenxiaoProductMapAddRequest) SetNotCheckOuterCode(_notCheckOuterCode bool) error {
