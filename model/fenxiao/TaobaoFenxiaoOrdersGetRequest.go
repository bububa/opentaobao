...
// Status Setter
// 交易状态，不传默认查询所有采购单根据身份选择自身状态可选值: *供应商： WAIT_SELLER_SEND_GOODS(等待发货) WAIT_SELLER_CONFIRM_PAY(待确认收款) WAIT_BUYER_PAY(等待付款) WAIT_BUYER_CONFIRM_GOODS(已发货) TRADE_REFUNDING(退款中) TRADE_FINISHED(采购成功) TRADE_CLOSED(已关闭) *分销商： WAIT_BUYER_PAY(等待付款) WAIT_BUYER_CONFIRM_GOODS(待收货确认) TRADE_FOR_PAY(已付款) TRADE_REFUNDING(退款中) TRADE_FINISHED(采购成功) TRADE_CLOSED(已关闭)
func (r *TaobaoFenxiaoOrdersGetRequest) SetStatus(_status string) error {
    r._status = _status
...
// StartCreated Setter
// 起始时间 格式 yyyy-MM-dd HH:mm:ss.支持到秒的查询。若不传时分秒，默认为0时0分0秒。若purchase_order_id没传，则此参数必传。
func (r *TaobaoFenxiaoOrdersGetRequest) SetStartCreated(_startCreated string) error {
...
// EndCreated Setter
// 结束时间 格式 yyyy-MM-dd HH:mm:ss.支持到秒的查询。若不传时分秒，默认为0时0分0秒。若purchase_order_id没传，则此参数必传。
func (r *TaobaoFenxiaoOrdersGetRequest) SetEndCreated(_endCreated string) error {
...
// TimeType Setter
// 可选值：trade_time_type(采购单按照成交时间范围查询),update_time_type(采购单按照更新时间范围查询)
func (r *TaobaoFenxiaoOrdersGetRequest) SetTimeType(_timeType string) error {
...
// PageNo Setter
// 页码。（大于0的整数。默认为1）
func (r *TaobaoFenxiaoOrdersGetRequest) SetPageNo(_pageNo int64) error {
    r._pageNo = _pageNo
...
// PageSize Setter
// 每页条数。（每页条数不超过50条）
func (r *TaobaoFenxiaoOrdersGetRequest) SetPageSize(_pageSize int64) error {
...
// 采购单编号或分销流水号，若其它参数没传，则此参数必传。
func (r *TaobaoFenxiaoOrdersGetRequest) SetPurchaseOrderId(_purchaseOrderId int64) error {
...
// Fields Setter
// 多个字段用","分隔。<br/><br/>fields<br/>如果为空：返回所有采购单对象(purchase_orders)字段。<br/>如果不为空：返回指定采购单对象(purchase_orders)字段。<br/><br/>例1：<br/>sub_purchase_orders.tc_order_id 表示只返回tc_order_id <br/>例2：<br/>sub_purchase_orders表示只返回子采购单列表
func (r *TaobaoFenxiaoOrdersGetRequest) SetFields(_fields string) error {
    r._fields = _fields
...
// TcOrderId Setter
// 采购单下游买家订单id
func (r *TaobaoFenxiaoOrdersGetRequest) SetTcOrderId(_tcOrderId int64) error {
...
// ChannelCodes Setter
// 渠道code，可批量 查询老供销：999
func (r *TaobaoFenxiaoOrdersGetRequest) SetChannelCodes(_channelCodes []int64) error {
...
// UserRoleType Setter
// 角色，供应商：2，分销商：1
func (r *TaobaoFenxiaoOrdersGetRequest) SetUserRoleType(_userRoleType int64) error {
...
// TradeTypes Setter
// 代销：1 经销：2 寄售（猫超自营寄售）：5 平台寄售：6
func (r *TaobaoFenxiaoOrdersGetRequest) SetTradeTypes(_tradeTypes []int64) error {
