...
func (r TaobaofenxiaoproductquantityupdateAPIRequest) GetApiParams(params url.Values) {
...
func (r TaobaofenxiaoproductquantityupdateAPIRequest) GetRawParams() model.Params {
	return r.Params
}
