...
type FenxiaoProduct struct {
    ...
    Skus   []SkuList `json:"skus,omitempty" xml:"skus,omitempty"`
    ...
    Pdus   []PduList `json:"pdus,omitempty" xml:"pdus,omitempty"`
    ...
    Images   []ProductImageList `json:"images,omitempty" xml:"images,omitempty"`
