...
type TopDpOrderDo struct {
    ...
    DistributorUsername   string `json:"distributor_username,omitempty"`
    ...
    DistributorPayment   string `json:"distributor_payment,omitempty"`
    ...
    Receiver  *struct {
        TopReceiverDo  *TopReceiverDo `json:"top_receiver_do,omitempty"`
    ...
    FenxiaoId   int64 `json:"fenxiao_id,omitempty"`
    ...
    DistributorFrom   string `json:"distributor_from,omitempty"`
    ...
    TcOrderId   int64 `json:"tc_order_id,omitempty"`
    ...
    } `json:"isv_custom_key,omitempty"`
    

    // 自定义值
    
    IsvCustomValue  struct {
        String  []string `json:"string,omitempty"`
    } `json:"isv_custom_value,omitempty"`
    ...
    SupplierFlag   int64 `json:"supplier_flag,omitempty"`
    

    // 买家支付给分销商的总金额。注意买家购买的商品可能不是全部来自同一供货商，请同时参考子单上的相关金额。（精确到2位小数;单位:元。如:200.07，表示:200元7分）
    
    BuyerPayment   string `json:"buyer_payment,omitempty"`
    

    // 采购单留言列表
    
    OrderMessages  struct {
        OrderMessages  []OrderMessages `json:"order_messages,omitempty"`
    } `json:"order_messages,omitempty"`
    

    // 子订单的详细信息列表。
    
    SubPurchaseOrders  struct {
        SubOrderDetail  []SubOrderDetail `json:"sub_order_detail,omitempty"`
    } `json:"sub_purchase_orders,omitempty"`
    

    // 加密后的买家淘宝ID，长度为32位
    
    BuyerTaobaoId   string `json:"buyer_taobao_id,omitempty"`
    

    // 主订单属性信息，key-value形式：<br/>orderNovice ：订单发票抬头；<br/>orderNoviceContent ：代表发票明细
    
    Features  struct {
        FeatureDo  []FeatureDo `json:"feature_do,omitempty"`
    } `json:"features,omitempty"`
    

    // [架海金梁独有字段，非架海金梁用户请勿关心]子单物流发货信息
    
    LogisticsInfos  struct {
        ErpLogisticsInfo  []ErpLogisticsInfo `json:"erp_logistics_info,omitempty"`
    } `json:"logistics_infos,omitempty"`
    ...
    ConfirmPaidFeeYuan   string `json:"confirm_paid_fee_yuan,omitempty"`
...
type TopDpOrderDo struct {
    ...
    // 买家详细信息
    Receiver   *TopReceiverDo `json:"receiver,omitempty"`
    ...
    // 自定义key
    IsvCustomKey   []string `json:"isv_custom_key,omitempty"`

    // 自定义值
    IsvCustomValue   []string `json:"isv_custom_value,omitempty"`
    ...
    // 子订单的详细信息列表。
    SubPurchaseOrders   []SubOrderDetail `json:"sub_purchase_orders,omitempty"`

    // 加密后的买家淘宝ID，长度为32位
    BuyerTaobaoId   string `json:"buyer_taobao_id,omitempty"`

    // 主订单属性信息，key-value形式：<br/>orderNovice ：订单发票抬头；<br/>orderNoviceContent ：代表发票明细
    Features   []FeatureDo `json:"features,omitempty"`

    // [架海金梁独有字段，非架海金梁用户请勿关心]子单物流发货信息
    LogisticsInfos   []ErpLogisticsInfo `json:"logistics_infos,omitempty"`
