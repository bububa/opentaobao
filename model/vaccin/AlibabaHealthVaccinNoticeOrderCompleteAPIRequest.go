...
// AlibabaHealthVaccinNoticeOrderCompleteAPIRequest 疫苗接种完成(带支付宝提醒) API请求
...
// NewAlibabaHealthVaccinNoticeOrderCompleteRequest 初始化AlibabaHealthVaccinNoticeOrderCompleteAPIRequest对象
