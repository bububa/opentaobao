...
type TaobaoUsergrowthOfflineConvertionSummaryEightGetAPIResponse struct {
    ...
    TaobaoUsergrowthOfflineConvertionSummaryEightGetResponse
}

// 获取 手淘用增 线下业务 t+8汇总数据 成功返回结果
type TaobaoUsergrowthOfflineConvertionSummaryEightGetResponse struct {
