...
type TaobaoCaipiaoSignstatusCheckAPIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"caipiao_signstatus_check_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识

    // 是否签署了支付宝代扣协议
    
    Sign   bool `json:"sign,omitempty" xml:"