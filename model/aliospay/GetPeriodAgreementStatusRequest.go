...
var poolGetPeriodAgreementStatusRequest = sync.Pool{
	New: func() any {
		return new(GetPeriodAgreementStatusRequest)
	},
}
...
func GetGetPeriodAgreementStatusRequest() *GetPeriodAgreementStatusRequest {
	return poolGetPeriodAgreementStatusRequest.Get().(*GetPeriodAgreementStatusRequest)
}
...
func ReleaseGetPeriodAgreementStatusRequest(v *GetPeriodAgreementStatusRequest) {
	...
	poolGetPeriodAgreementStatusRequest.Put(v)
}
