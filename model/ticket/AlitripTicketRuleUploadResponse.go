...
type AlitripTicketRuleUploadAPIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"alitrip_ticket_rule_upload_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识

    // result
    
    Result   *AlitripTicketRuleUploadResultSet `json:"result,omitempty" xml:"