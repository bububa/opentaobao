...
type TicketRuleParam struct {
    ...
    OutRuleId   string `json:"out_rule_id,omitempty"`
    

    // 卖家景点规则名称
    
    OutRuleName   string `json:"out_rule_name,omitempty"`
    ...
    VisitorRequire   int64 `json:"visitor_require,omitempty"`
    ...
    VisitorLimitMode   int64 `json:"visitor_limit_mode,omitempty"`
    

    // 限购数量
    
    VisitorLimitNum   int64 `json:"visitor_limit_num,omitempty"`
    

    // 入园类型。1-用兑换凭证直接入园，2-用兑换凭证换票入园
    
    EnterType   int64 `json:"enter_type,omitempty"`
    

    // 入园使用的凭证类型。1、二维码，2、身份证，3、二维码或身份证，4:数字码，5、手机号，6、其它
    
    EnterVoucherType   int64 `json:"enter_voucher_type,omitempty"`
    

    // 其他入园凭证类型。
    
    EnterVoucherValue   string `json:"enter_voucher_value,omitempty"`
    

    // 换票地址
    
    TicketChangeAdderss   string `json:"ticket_change_adderss,omitempty"`
    

    // 景区入园地址
    
    EnterAddress   string `json:"enter_address,omitempty"`
    ...
    VisitorLimitType   int64 `json:"visitor_limit_type,omitempty"`
