...
type WholesaleTrade struct {
    ...
    ShippingLineTemplateId   int64 `json:"shipping_line_template_id,omitempty"`
    

    // 备货期，单位是天，范围是1-60
    
    HandlingTime   int64 `json:"handling_time,omitempty"`
    

    // 发货周期，发货时间相关建议使用此项
    
    DeliverPeriods  struct {
        DeliverPeriod  []DeliverPeriod `json:"deliver_period,omitempty"`
    } `json:"deliver_periods,omitempty"`
