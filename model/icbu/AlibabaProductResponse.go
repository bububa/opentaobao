...
type AlibabaProductResponse struct {
    ...
    } `json:"main_image,omitempty"`
    

    // 询盘商品交易信息
    
    SourcingTrade  *struct {
        SourcingTrade  *SourcingTrade `json:"sourcing_trade,omitempty"`
    } `json:"sourcing_trade,omitempty"`
    

    // 在线批发商品交易信息
    
    WholesaleTrade  *struct {
        WholesaleTrade  *WholesaleTrade `json:"wholesale_trade,omitempty"`
    } `json:"wholesale_trade,omitempty"`
    

    // 商品SKU
    
    ProductSku  *struct {
        ProductSkuResponse  *ProductSkuResponse `json:"product_sku_response,omitempty"`
    } `json:"product_sku,omitempty"`
