...
type NormalVisaDetailInfo struct {
    ...
    NVisaDetailPersonResultVOList   []NormalVisaPersonDetailVo `json:"n_visa_detail_person_result_v_o_list,omitempty" xml:"n_visa_detail_person_result_v_o_list,omitempty"`
