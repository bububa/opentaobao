...
// dsp客户新增资质dto
func (r *TaobaoTanxQualificationAddRequest) SetQualifications(_qualifications []Qualification) error {
...
// MemberId Setter
// dsp用户memberId
func (r *TaobaoTanxQualificationAddRequest) SetMemberId(_memberId int64) error {
...
// Token Setter
// dsp验证的token
func (r *TaobaoTanxQualificationAddRequest) SetToken(_token string) error {
    r._token = _token
    r.Set("token", _token)
    return nil
}
...
// SignTime Setter
// 签名时间，1970年到现在的秒
func (r *TaobaoTanxQualificationAddRequest) SetSignTime(_signTime int64) error {
