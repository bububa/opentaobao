...
type CreativeDto struct {
    ...
    CreativePublisherAuditDtoList   []CreativePublisherAuditDto `json:"creative_publisher_audit_dto_list,omitempty" xml:"creative_publisher_audit_dto_list,omitempty"`
