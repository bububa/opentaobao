...
type CreativeParamDTO struct {
    ...
    AdboardSize   string `json:"adboard_size,omitempty"`
    

    // 广告类目
    
    AdboardType   string `json:"adboard_type,omitempty"`
    ...
    CreativePackageFormat   int64 `json:"creative_package_format,omitempty"`
    ...
    DisType   int64 `json:"dis_type,omitempty"`
