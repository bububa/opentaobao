...
type CreativeAuditDto struct {
    ...
    PublishersAuditInfoList  struct {
        CreativePublisherAuditDto  []CreativePublisherAuditDto `json:"creative_publisher_audit_dto,omitempty"`
    } `json:"publishers_audit_info_list,omitempty"`
...
type CreativeAuditDto struct {
    ...
    // 媒体审核列表
    PublishersAuditInfoList   []CreativePublisherAuditDto `json:"publishers_audit_info_list,omitempty"`
