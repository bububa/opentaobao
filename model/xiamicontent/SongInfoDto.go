...
type SongInfoDto struct {
    ...
    Singers   []ArtistDto `json:"singers,omitempty" xml:"singers,omitempty"`
    ...
    Composers   []ArtistDto `json:"composers,omitempty" xml:"composers,omitempty"`
    ...
    Songwriters   []ArtistDto `json:"songwriters,omitempty" xml:"songwriters,omitempty"`
    

    // 制作人列表
    
    Producers   []ArtistDto `json:"producers,omitempty" xml:"producers,omitempty"`
    

    // 标签列表
    
    Tags   []TagLink `json:"tags,omitempty" xml:"tags,omitempty"`
    ...
    Arrangements   []ArtistDto `json:"arrangements,omitempty" xml:"arrangements,omitempty"`
    

    // 歌词列表
    
    Lyrics   []LyricDto `json:"lyrics,omitempty" xml:"lyrics,omitempty"`
