...
type Order struct {
    ...
    TimeoutActionTime   string `json:"timeout_action_time,omitempty"`
    ...
    ClDownPayment   string `json:"cl_down_payment,omitempty"`
    

    // clDownPaymentRatio
    
    ClDownPaymentRatio   string `json:"cl_down_payment_ratio,omitempty"`
    

    // clMonthPayment
    
    ClMonthPayment   string `json:"cl_month_payment,omitempty"`
    

    // clTailPayment
    
    ClTailPayment   string `json:"cl_tail_payment,omitempty"`
    

    // clInstallmentNum
    
    ClInstallmentNum   string `json:"cl_installment_num,omitempty"`
    

    // calPenalty
    
    CalPenalty   string `json:"cal_penalty,omitempty"`
    

    // clServiceFee
    
    ClServiceFee   string `json:"cl_service_fee,omitempty"`
    

    // clCarTaker
    
    ClCarTaker   string `json:"cl_car_taker,omitempty"`
    

    // clCarTakerPhone
    
    ClCarTakerPhone   string `json:"cl_car_taker_phone,omitempty"`
    

    // clCarTakerIDNum
    
    ClCarTakerIDNum   string `json:"cl_car_taker_i_d_num,omitempty"`
    

    // clCarTakerIDNum
    
    ClCarTakerIdNum   string `json:"cl_car_taker_id_num,omitempty"`
    ...
    CarTakerIdNum   string `json:"car_taker_id_num,omitempty"`
    ...
    OmniJxsOuterid   string `json:"omni_jxs_outerid,omitempty"`
