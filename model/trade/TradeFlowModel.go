...
type TradeFlowModel struct {
    ...
    // 交易流水信息-商品详情
    TradeFlowGoodsDetailModelList   []TradeFlowGoodsDetailModel `json:"trade_flow_goods_detail_model_list,omitempty" xml:"trade_flow_goods_detail_model_list>trade_flow_goods_detail_model,omitempty"`
    // 设备类型
