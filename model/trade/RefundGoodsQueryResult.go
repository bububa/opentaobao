...
type RefundGoodsQueryResult struct {
    ...
    RefundGoodsSubOrderDetailList   []RefundGoodsSubOrderDetail `json:"refund_goods_sub_order_detail_list,omitempty" xml:"refund_goods_sub_order_detail_list,omitempty"`
