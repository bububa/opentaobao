...
// Oid Setter
// 子订单（消息中传的子订单）
func (r *TaobaoRdcAligeniusOrdermsgUpdateRequest) SetOid(_oid int64) error {
    r._oid = _oid
    r.Set("oid", _oid)
    return nil
}
...
// Status Setter
// 处理状态，1=成功，2=处理失败
func (r *TaobaoRdcAligeniusOrdermsgUpdateRequest) SetStatus(_status int64) error {
    r._status = _status
...
// Tid Setter
// 主订单（消息中传的主订单）
func (r *TaobaoRdcAligeniusOrdermsgUpdateRequest) SetTid(_tid int64) error {
    r._tid = _tid
    r.Set("tid", _tid)
    return nil
}
