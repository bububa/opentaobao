...
func (r AlibabaWdkTxdCrmStatementBackflowAPIRequest) GetApiParams(params url.Values) {
...
func (r AlibabaWdkTxdCrmStatementBackflowAPIRequest) GetRawParams() model.Params {
	return r.Params
}
