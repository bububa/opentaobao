...
type Trade struct {
    ...
    } `json:"promotion_details,omitempty"`
    ...
    ServiceTags  struct {
        LogisticsTag  []LogisticsTag `json:"logistics_tag,omitempty"`
    ...
    TradeExt  *struct {
        TradeExt  *TradeExt `json:"trade_ext,omitempty"`
    } `json:"trade_ext,omitempty"`
    ...
    ExpandcardInfo  *struct {
        ExpandCardInfo  *ExpandCardInfo `json:"expand_card_info,omitempty"`
    } `json:"expandcard_info,omitempty"`
...
type Trade struct {
    ...
    // 物流标签
    ServiceTags   []LogisticsTag `json:"service_tags,omitempty"`
    ...
    // logisticsInfos
    LogisticsInfos   []LogisticsInfo `json:"logistics_infos,omitempty"`
    ...
    // 购物金信息输出
    ExpandcardInfo   *ExpandCardInfo `json:"expandcard_info,omitempty"`
