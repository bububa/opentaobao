...
type BatchStockPublishDto struct {
    ...
    StockPublishDtos  struct {
        StockPublishDto  []StockPublishDto `json:"stock_publish_dto,omitempty"`
    } `json:"stock_publish_dtos,omitempty"`
...
type BatchStockPublishDto struct {
    ...
    // 子参数列表
    StockPublishDtos   []StockPublishDto `json:"stock_publish_dtos,omitempty"`
