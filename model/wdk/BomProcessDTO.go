...
type BomProcessDTO struct {
    ...
    ProductItemInfos   []BomItemInfos `json:"product_item_infos,omitempty" xml:"product_item_infos,omitempty"`
    

    // materialItemInfos
    
    MaterialItemInfos   []BomItemInfos `json:"material_item_infos,omitempty" xml:"material_item_infos,omitempty"`
