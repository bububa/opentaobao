...
func (r AlibabaWdkMerchantStoreitemCreateAPIRequest) GetApiParams(params url.Values) {
...
func (r AlibabaWdkMerchantStoreitemCreateAPIRequest) GetRawParams() model.Params {
	return r.Params
}
