...
type ItemInfo struct {
    ...
    ItemTypeNew   string `json:"item_type_new,omitempty"`
    ...
    InventoryUtil   string `json:"inventory_util,omitempty"`
    ...
    SaleUtil   string `json:"sale_util,omitempty"`
    

    // 均重
    
    AvgWeight   int64 `json:"avg_weight,omitempty"`
