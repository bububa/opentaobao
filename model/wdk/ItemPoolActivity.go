...
type ItemPoolActivity struct {
    ...
    LogicGroupRules  struct {
        OpenLogicGroupRule  []OpenLogicGroupRule `json:"open_logic_group_rule,omitempty"`
    } `json:"logic_group_rules,omitempty"`
    

    // 活动优惠规则
    
    ActivityRule  *struct {
        ActivityRule  *ActivityRule `json:"activity_rule,omitempty"`
    } `json:"activity_rule,omitempty"`
    ...
    } `json:"period_config,omitempty"`
    

    // 是否是组合优惠
    
    IsComb   bool `json:"is_comb,omitempty"`
    ...
    ExcludeSingle   bool `json:"exclude_single,omitempty"`
...
type ItemPoolActivity struct {
    ...
    // 逻辑分组规则
    LogicGroupRules   []OpenLogicGroupRule `json:"logic_group_rules,omitempty"`
