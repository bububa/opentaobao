...
type SkuDo struct {
    ...
    SkuSuppliers  struct {
        SkuSupplierDo  []SkuSupplierDo `json:"sku_supplier_do,omitempty"`
    } `json:"sku_suppliers,omitempty"`
    ...
    IndustryProps  *struct {
        IndustryPropDo  *IndustryPropDo `json:"industry_prop_do,omitempty"`
    } `json:"industry_props,omitempty"`
    ...
    ChannelProps  struct {
        ChannelProp  []ChannelProp `json:"channel_prop,omitempty"`
    } `json:"channel_props,omitempty"`
    ...
    AppEffectBeginTime   string `json:"app_effect_begin_time,omitempty"`
    

    // 线上生效过期时间
    
    AppEffectEndTime   string `json:"app_effect_end_time,omitempty"`
    

    // 子商品信息
    
    SubSkus  struct {
        SubSkuDo  []SubSkuDo `json:"sub_sku_do,omitempty"`
    } `json:"sub_skus,omitempty"`
...
type SkuDo struct {
    ...
    // 供货商信息
    SkuSuppliers   []SkuSupplierDo `json:"sku_suppliers,omitempty"`

    // 文描,（同字段txt_desc）；优先使用本字段
    RichText   string `json:"rich_text,omitempty"`

    // 行业属性
    IndustryProps   *IndustryPropDo `json:"industry_props,omitempty"`
    ...
    // 渠道属性
    ChannelProps   []ChannelProp `json:"channel_props,omitempty"`
    ...
    // 子商品信息
    SubSkus   []SubSkuDo `json:"sub_skus,omitempty"`
