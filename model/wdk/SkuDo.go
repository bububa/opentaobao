...
type SkuDo struct {
    ...
    SkuSuppliers   []SkuSupplierDo `json:"sku_suppliers,omitempty" xml:"sku_suppliers,omitempty"`
    ...
    ChannelProps   []ChannelProp `json:"channel_props,omitempty" xml:"channel_props,omitempty"`
    ...
    SubSkus   []SubSkuDo `json:"sub_skus,omitempty" xml:"sub_skus,omitempty"`
