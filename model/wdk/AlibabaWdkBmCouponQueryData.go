...
type AlibabaWdkBmCouponQueryData struct {
    ...
    PaymentChannel   int64 `json:"payment_channel,omitempty"`
    

    // 补差比例
    
    PaymentRate   string `json:"payment_rate,omitempty"`
    

    // 补差商品列表
    
    PaymentItemDOList  struct {
        PaymentItemDo  []PaymentItemDo `json:"payment_item_do,omitempty"`
    } `json:"payment_item_d_o_list,omitempty"`
...
type AlibabaWdkBmCouponQueryData struct {
    ...
    // 补差商品列表
    PaymentItemDOList   []PaymentItemDo `json:"payment_item_d_o_list,omitempty"`
