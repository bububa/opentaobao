...
func (r AlibabaWdkMerchantItemCreatedraftAPIRequest) GetApiParams(params url.Values) {
...
func (r AlibabaWdkMerchantItemCreatedraftAPIRequest) GetRawParams() model.Params {
	return r.Params
}
