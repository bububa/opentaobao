...
type MerchantOrderInfo struct {
    ...
    SubOrderList  struct {
        MerchantSubOrderInfo  []MerchantSubOrderInfo `json:"merchant_sub_order_info,omitempty"`
    ...
    PayChannelList  struct {
        MerchantOrderPaymentInfo  []MerchantOrderPaymentInfo `json:"merchant_order_payment_info,omitempty"`
