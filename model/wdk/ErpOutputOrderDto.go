...
type ErpOutputOrderDto struct {
    ...
    OutputItemInfos  struct {
        OutputItemInfoDto  []OutputItemInfoDto `json:"output_item_info_dto,omitempty"`
    } `json:"output_item_infos,omitempty"`
...
type ErpOutputOrderDto struct {
    ...
    // 商品明细列表（子表）
    OutputItemInfos   []OutputItemInfoDto `json:"output_item_infos,omitempty"`
