...
type OrderSyncDto struct {
    ...
    SubOrders   []SubOrderSyncDto `json:"sub_orders,omitempty" xml:"sub_orders,omitempty"`
    ...
    PayChannels   []PayChannel `json:"pay_channels,omitempty" xml:"pay_channels,omitempty"`
