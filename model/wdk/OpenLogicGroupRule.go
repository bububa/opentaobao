...
type OpenLogicGroupRule struct {
    ...
    CoverAllDiscountRule  *struct {
        CoverAllDiscountRule  *CoverAllDiscountRule `json:"cover_all_discount_rule,omitempty"`
    } `json:"cover_all_discount_rule,omitempty"`
    

    // 是否为优惠作用分组
    
    IsEffectiveGroup   bool `json:"is_effective_group,omitempty"`
    ...
    LogicGroupType   int64 `json:"logic_group_type,omitempty"`
    ...
    ExchangeGroupOrder   int64 `json:"exchange_group_order,omitempty"`
    

    // 换购分组名称
    
    ExchangeGroupName   string `json:"exchange_group_name,omitempty"`
