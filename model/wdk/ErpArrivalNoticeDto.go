...
type ErpArrivalNoticeDto struct {
    ...
    InvalidDate   string `json:"invalid_date,omitempty"`
    ...
    ItemList  struct {
        ErpArrivalNoticeDetailDto  []ErpArrivalNoticeDetailDto `json:"erp_arrival_notice_detail_dto,omitempty"`
...
type ErpArrivalNoticeDto struct {
    ...
    // 1
    ItemList   []ErpArrivalNoticeDetailDto `json:"item_list,omitempty"`
