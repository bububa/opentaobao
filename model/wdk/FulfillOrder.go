...
type FulfillOrder struct {
    ...
    SkuInfoList  struct {
        SkuInfo  []SkuInfo `json:"sku_info,omitempty"`
    ...
    CarriageAmount   string `json:"carriage_amount,omitempty"`
    ...
    NewSupply   string `json:"new_supply,omitempty"`
...
type FulfillOrder struct {
    ...
    // 子订单信息列表
    SkuInfoList   []SkuInfo `json:"sku_info_list,omitempty"`
