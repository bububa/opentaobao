...
func (r *AlibabaWdkMarketingItempoolAdditemAPIRequest) Reset() {
	r._param0 = nil
	r._param1 = nil
	r.Params.ToZero()
}
...
var poolAlibabaWdkMarketingItempoolAdditemAPIRequest = sync.Pool{
	New: func() any {
		return NewAlibabaWdkMarketingItempoolAdditemRequest()
	},
}

// GetAlibabaWdkMarketingItempoolAdditemRequest 从 sync.Pool 获取 AlibabaWdkMarketingItempoolAdditemAPIRequest
func GetAlibabaWdkMarketingItempoolAdditemAPIRequest() *AlibabaWdkMarketingItempoolAdditemAPIRequest {
	return poolAlibabaWdkMarketingItempoolAdditemAPIRequest.Get().(*AlibabaWdkMarketingItempoolAdditemAPIRequest)
}

// ReleaseAlibabaWdkMarketingItempoolAdditemAPIRequest 将 AlibabaWdkMarketingItempoolAdditemAPIRequest 放入 sync.Pool
func ReleaseAlibabaWdkMarketingItempoolAdditemAPIRequest(v *AlibabaWdkMarketingItempoolAdditemAPIRequest) {
	v.Reset()
	poolAlibabaWdkMarketingItempoolAdditemAPIRequest.Put(v)
}
