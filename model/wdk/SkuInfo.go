...
type SkuInfo struct {
    ...
    Containers  struct {
        ContainerDto  []ContainerDto `json:"container_dto,omitempty"`
    ...
    SkuSaleUnit   string `json:"sku_sale_unit,omitempty"`
    

    // 销售数量
    
    SkuSaleQuantity   string `json:"sku_sale_quantity,omitempty"`
    ...
    OutOfStockQuantity   string `json:"out_of_stock_quantity,omitempty"`
    ...
    IsStandardSku   bool `json:"is_standard_sku,omitempty"`
    

    // 取消数量
    
    CancelSaleQuantity   string `json:"cancel_sale_quantity,omitempty"`
    

    // 缺货金额
    
    OutOfStockAmount   string `json:"out_of_stock_amount,omitempty"`
    ...
    SubSourceOrderId   string `json:"sub_source_order_id,omitempty"`
