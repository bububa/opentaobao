...
type DrfHalfDayCcCallbackOrder struct {
    ...
    CallbackUnits   []DrfHalfDayCcCallBackUnit `json:"callback_units,omitempty" xml:"callback_units,omitempty"`
    ...
    Containers   []Container `json:"containers,omitempty" xml:"containers,omitempty"`
