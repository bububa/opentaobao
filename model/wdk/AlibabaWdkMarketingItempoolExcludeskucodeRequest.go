...
// Param0 Setter
// 商品对象
func (r *AlibabaWdkMarketingItempoolExcludeskucodeRequest) SetParam0(_param0 *ItemPoolSku) error {
    r._param0 = _param0
...
// Param1 Setter
// 活动基本信息
func (r *AlibabaWdkMarketingItempoolExcludeskucodeRequest) SetParam1(_param1 *CommonActivityParam) error {
    r._param1 = _param1
