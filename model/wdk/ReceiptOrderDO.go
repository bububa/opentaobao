...
type ReceiptOrderDO struct {
    ...
    MemberDiscount   string `json:"member_discount,omitempty"`
    ...
    PayChannels  struct {
        ReceiptPayChannelDo  []ReceiptPayChannelDo `json:"receipt_pay_channel_do,omitempty"`
    ...
    SubOrders  struct {
        ReceiptSubOrderDo  []ReceiptSubOrderDo `json:"receipt_sub_order_do,omitempty"`
    ...
    AliUserid   string `json:"ali_userid,omitempty"`
...
type ReceiptOrderDO struct {
    ...
    // 子订单信息
    SubOrders   []ReceiptSubOrderDo `json:"sub_orders,omitempty"`
