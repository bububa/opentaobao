...
func (r *TaobaoFilmTfavatarBillTicketRefundQueryAPIRequest) Reset() {
...
var poolTaobaoFilmTfavatarBillTicketRefundQueryAPIRequest = sync.Pool{
	New: func() any {
		return NewTaobaoFilmTfavatarBillTicketRefundQueryRequest()
	},
}

// GetTaobaoFilmTfavatarBillTicketRefundQueryRequest 从 sync.Pool 获取 TaobaoFilmTfavatarBillTicketRefundQueryAPIRequest
func GetTaobaoFilmTfavatarBillTicketRefundQueryAPIRequest() *TaobaoFilmTfavatarBillTicketRefundQueryAPIRequest {
	return poolTaobaoFilmTfavatarBillTicketRefundQueryAPIRequest.Get().(*TaobaoFilmTfavatarBillTicketRefundQueryAPIRequest)
}

// ReleaseTaobaoFilmTfavatarBillTicketRefundQueryAPIRequest 将 TaobaoFilmTfavatarBillTicketRefundQueryAPIRequest 放入 sync.Pool
func ReleaseTaobaoFilmTfavatarBillTicketRefundQueryAPIRequest(v *TaobaoFilmTfavatarBillTicketRefundQueryAPIRequest) {
	v.Reset()
	poolTaobaoFilmTfavatarBillTicketRefundQueryAPIRequest.Put(v)
}
