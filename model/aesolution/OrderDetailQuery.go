...
var poolOrderDetailQuery = sync.Pool{
	New: func() any {
		return new(OrderDetailQuery)
	},
}

// GetOrderDetailQuery() 从对象池中获取OrderDetailQuery
func GetOrderDetailQuery() *OrderDetailQuery {
	return poolOrderDetailQuery.Get().(*OrderDetailQuery)
}

// ReleaseOrderDetailQuery 释放OrderDetailQuery
func ReleaseOrderDetailQuery(v *OrderDetailQuery) {
	v.ExtInfoBitFlag = 0
	v.OrderId = 0
	poolOrderDetailQuery.Put(v)
}
