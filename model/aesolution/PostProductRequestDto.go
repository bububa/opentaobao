...
type PostProductRequestDto struct {
    ...
    MarketingImages   []MarketImageDto `json:"marketing_images,omitempty" xml:"marketing_images,omitempty"`
    ...
    AttributeList   []AttributeDto `json:"attribute_list,omitempty" xml:"attribute_list,omitempty"`
    

    // If specified this field, all the previous skus will be replaced by the new skus.
    
    SkuInfoList   []SkuInfoDto `json:"sku_info_list,omitempty" xml:"sku_info_list,omitempty"`
    ...
    MultiLanguageSubjectList   []SingleLanguageTitleDto `json:"multi_language_subject_list,omitempty" xml:"multi_language_subject_list,omitempty"`
    ...
    MultiLanguageDescriptionList   []SingleLanguageDescriptionDto `json:"multi_language_description_list,omitempty" xml:"multi_language_description_list,omitempty"`
