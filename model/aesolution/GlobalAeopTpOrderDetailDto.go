...
type GlobalAeopTpOrderDetailDto struct {
    ...
    OrderMsgList   []GlobalAeopTpOrderMsgDto `json:"order_msg_list,omitempty" xml:"order_msg_list,omitempty"`
    

    // child order ext info list
    
    ChildOrderExtInfoList   []GlobalAeopTpOrderProductInfoDto `json:"child_order_ext_info_list,omitempty" xml:"child_order_ext_info_list,omitempty"`
    ...
    LogisticInfoList   []GlobalAeopTpLogisticInfoDto `json:"logistic_info_list,omitempty" xml:"logistic_info_list,omitempty"`
    ...
    OprLogDtoList   []GlobalAeopTpOperationLogDto `json:"opr_log_dto_list,omitempty" xml:"opr_log_dto_list,omitempty"`
    

    // child order list
    
    ChildOrderList   []GlobalAeopTpChildOrderDto `json:"child_order_list,omitempty" xml:"child_order_list,omitempty"`
