...
type GlobalAeopFindProductResultDto struct {
    ...
    AeopAeProductPropertys   []GlobalAeopAeProductProperty `json:"aeop_ae_product_propertys,omitempty" xml:"aeop_ae_product_propertys,omitempty"`
    

    // List for multiple skus of the product, expressed in json format.
    
    AeopAeProductSKUs   []GlobalAeopAeProductSku `json:"aeop_ae_product_s_k_us,omitempty" xml:"aeop_ae_product_s_k_us,omitempty"`
    ...
    MultiLanguageSubjectList   []GlobalSubject `json:"multi_language_subject_list,omitempty" xml:"multi_language_subject_list,omitempty"`
    

    // multo language description list
    
    MultiLanguageDescriptionList   []GlobalDescription `json:"multi_language_description_list,omitempty" xml:"multi_language_description_list,omitempty"`
