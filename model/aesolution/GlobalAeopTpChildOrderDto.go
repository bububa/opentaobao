...
type GlobalAeopTpChildOrderDto struct {
    ...
    ChildOrderDiscountDetailList   []GlobalAeopTpSaleDiscountInfo `json:"child_order_discount_detail_list,omitempty" xml:"child_order_discount_detail_list,omitempty"`
