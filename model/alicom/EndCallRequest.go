...
type EndCallRequest struct {
    ...
    SecretNo   string `json:"secret_no,omitempty"`
    

    // 呼叫被叫侧发起的时间；短信话单时，此值传短信接收时间
    
    CallOutTime   string `json:"call_out_time,omitempty"`
    

    // 0-平台释放 1-主叫释放 2-被叫释放；短信话单时，传0
    
    ReleaseDir   int64 `json:"release_dir,omitempty"`
    ...
    FreeRingTime   string `json:"free_ring_time,omitempty"`
    

    // 短信条数
    
    SmsNumber   int64 `json:"sms_number,omitempty"`
    ...
    RingingRecordUrl   string `json:"ringing_record_url,omitempty"`
    ...
    CallNo   string `json:"call_no,omitempty"`
    ...
    ExtensionNo   string `json:"extension_no,omitempty"`
