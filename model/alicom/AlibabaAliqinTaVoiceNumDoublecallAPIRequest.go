...
/* AlibabaAliqinTaVoiceNumDoublecallAPIRequest
聚石塔语音双呼接口 API请求
...
func (r AlibabaAliqinTaVoiceNumDoublecallAPIRequest) GetApiParams() url.Values {
	params := url.Values{}
