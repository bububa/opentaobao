...
// 入参
func (r *AlibabaAscpAicSupplierAicinventoryNegativeSalePublishRequest) SetFutureInventoryMainOperationQuest(_futureInventoryMainOperationQuest *Futureinventorymainoperationquest) error {
