...
type DeviceStandardApiDto struct {
    ...
    MetaPointDatas   []MeatDataApiDto `json:"meta_point_datas,omitempty" xml:"meta_point_datas,omitempty"`
    ...
    TagInfoList   []TagInfoApiDto `json:"tag_info_list,omitempty" xml:"tag_info_list,omitempty"`
