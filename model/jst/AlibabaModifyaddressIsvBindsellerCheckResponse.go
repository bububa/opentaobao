...
type AlibabaModifyaddressIsvBindsellerCheckAPIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"alibaba_modifyaddress_isv_bindseller_check_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识

    // model
    
    Model   *CheckSellerChooseErpResponse `json:"model,omitempty" xml:"