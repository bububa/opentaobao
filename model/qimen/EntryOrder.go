...
type EntryOrder struct {
    ...
    EntryOrderType   string `json:"entryOrderType,omitempty"`
    ...
    SourceWarehouseCode   string `json:"sourceWarehouseCode,omitempty"`
    

    // 出库仓库名称
    
    SourceWarehouseName   string `json:"sourceWarehouseName,omitempty"`
