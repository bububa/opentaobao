...
type DeliveryOrder struct {
    ...
    StorageFee   string `json:"storageFee,omitempty"`
    ...
    PlaceOrderTime   string `json:"placeOrderTime,omitempty"`
    ...
    ItemAmount   string `json:"itemAmount,omitempty"`
    ...
    ArAmount   string `json:"arAmount,omitempty"`
    

    // 已收金额(消费者已经支付多少;单位元)
    
    GotAmount   string `json:"gotAmount,omitempty"`
    ...
    DeliveryRequirements  *struct {
        DeliveryRequirements  *DeliveryRequirements `json:"delivery_requirements,omitempty"`
    } `json:"deliveryRequirements,omitempty"`
    ...
    IsUrgency   string `json:"isUrgency,omitempty"`
    

    // 是否需要发票(Y/N;默认为N)
    
    InvoiceFlag   string `json:"invoiceFlag,omitempty"`
    ...
    OaidOrderSourceCode   string `json:"oaidOrderSourceCode,omitempty"`
    ...
    LatestCollectionTime   string `json:"latestCollectionTime,omitempty"`
    

    // 最晚发货时间, string (19) , YYYY-MM-DD HH:MM:SS
    
    LatestDeliveryTime   string `json:"latestDeliveryTime,omitempty"`
    

    // 单据总行数
    
    TotalOrderLines   int64 `json:"totalOrderLines,omitempty"`
    ...
    SubOrderType   string `json:"subOrderType,omitempty"`
    

    // 关联单据信息
    
    RelatedOrders  struct {
        RelatedOrder  []RelatedOrder `json:"related_order,omitempty"`
    } `json:"relatedOrders,omitempty"`
    ...
    PickerInfo  *struct {
        PickerInfo  *PickerInfo `json:"picker_info,omitempty"`
    } `json:"pickerInfo,omitempty"`
    

    // 出库单渠道类型,VIP=唯品会，FX=分销 ，SHOP=门店
    
    OrderSourceType   string `json:"orderSourceType,omitempty"`
    ...
    TargetWarehouseName   string `json:"targetWarehouseName,omitempty"`
    

    // 入库仓库编码, string (50) ，统仓统配等无需ERP指定仓储编码的情况填OTHER
    
    TargetWarehouseCode   string `json:"targetWarehouseCode,omitempty"`
    

    // 关联的入库单号（ERP分配）
    
    TargetEntryOrderCode   string `json:"targetEntryOrderCode,omitempty"`
...
type DeliveryOrder struct {
    ...
    // 发货要求
    DeliveryRequirements   *DeliveryRequirements `json:"deliveryRequirements,omitempty"`
    ...
    // 关联单据信息
    RelatedOrders   []RelatedOrder `json:"relatedOrders,omitempty"`
    ...
    // 提货人信息
    PickerInfo   *PickerInfo `json:"pickerInfo,omitempty"`
