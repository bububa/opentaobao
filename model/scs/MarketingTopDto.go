...
var poolMarketingTopDto = sync.Pool{
	New: func() any {
		return new(MarketingTopDto)
	},
}

// GetMarketingTopDto() 从对象池中获取MarketingTopDto
func GetMarketingTopDto() *MarketingTopDto {
	return poolMarketingTopDto.Get().(*MarketingTopDto)
}

// ReleaseMarketingTopDto 释放MarketingTopDto
func ReleaseMarketingTopDto(v *MarketingTopDto) {
	v.MarketScene = 0
	v.MarketAim = 0
	poolMarketingTopDto.Put(v)
}
