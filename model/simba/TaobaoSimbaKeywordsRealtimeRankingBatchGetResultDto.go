...
type TaobaosimbakeywordsrealtimerankingbatchgetResultDto struct {
	...
	RealtimeRankList []TaobaosimbakeywordsrealtimerankingbatchgetResult `json:"realtime_rank_list,omitempty" xml:"realtime_rank_list>taobaosimbakeywordsrealtimerankingbatchget_result,omitempty"`
	// 错误码
