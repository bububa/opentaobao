...
// SubwayToken Setter
// 权限验证信息
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetSubwayToken(_subwayToken string) error {
...
// Nick Setter
// 昵称
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetNick(_nick string) error {
    r._nick = _nick
    r.Set("nick", _nick)
    return nil
}
...
// StartTime Setter
// 开始日期，格式yyyy-mm-dd
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetStartTime(_startTime string) error {
...
// EndTime Setter
// 结束日期，格式yyyy-mm-dd
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetEndTime(_endTime string) error {
    r._endTime = _endTime
...
// CampaignId Setter
// 查询推广计划id
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetCampaignId(_campaignId int64) error {
...
// AdgroupId Setter
// 推广组id
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetAdgroupId(_adgroupId int64) error {
...
// Source Setter
// 数据来源（PC站内：1，PC站外：2，无线站内：4，无线站外 : 5，汇总：SUMMARY）SUMMARY必须单选，其他值可多选例如1,2
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetSource(_source string) error {
    r._source = _source
...
// PageNo Setter
// 页码
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetPageNo(_pageNo int64) error {
    r._pageNo = _pageNo
...
// PageSize Setter
// 每页大小
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetPageSize(_pageSize int64) error {
...
// SearchType Setter
// 报表类型（搜索：SEARCH,类目出价：CAT, 定向投放：NOSEARCH汇总：SUMMARY）SUMMARY必须单选，其他值可多选例如：SEARCH,CAT
func (r *TaobaoSimbaRptAdgroupcreativeeffectGetRequest) SetSearchType(_searchType string) error {
