...
var poolItemMaterialVo = sync.Pool{
	New: func() any {
		return new(ItemMaterialVo)
	},
}

// GetItemMaterialVo() 从对象池中获取ItemMaterialVo
func GetItemMaterialVo() *ItemMaterialVo {
	return poolItemMaterialVo.Get().(*ItemMaterialVo)
}

// ReleaseItemMaterialVo 释放ItemMaterialVo
func ReleaseItemMaterialVo(v *ItemMaterialVo) {
	v.Url = ""
	v.CoverUrl = ""
	v.MaterialId = 0
	v.VideoId = 0
