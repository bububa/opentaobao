...
var poolAuditVo = sync.Pool{
	New: func() any {
		return new(AuditVo)
	},
}

// GetAuditVo() 从对象池中获取AuditVo
func GetAuditVo() *AuditVo {
	return poolAuditVo.Get().(*AuditVo)
}

// ReleaseAuditVo 释放AuditVo
func ReleaseAuditVo(v *AuditVo) {
	v.Status = ""
	v.EffectiveTime = ""
	v.ExpireTime = ""
	v.AuditReason = ""
