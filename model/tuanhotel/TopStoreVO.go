...
type TopStoreVO struct {
    ...
    RoomTypes   []TopRoomTypeVO `json:"room_types,omitempty" xml:"room_types,omitempty"`
    ...
    AppointPhones   []TopAppointPhoneVO `json:"appoint_phones,omitempty" xml:"appoint_phones,omitempty"`
