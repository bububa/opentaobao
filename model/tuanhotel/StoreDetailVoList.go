...
type StoreDetailVoList struct {
    ...
    AppointPhoneList   []AppointPhoneVoList `json:"appoint_phone_list,omitempty" xml:"appoint_phone_list,omitempty"`
    ...
    RoomTypeList   []RoomTypeVoList `json:"room_type_list,omitempty" xml:"room_type_list,omitempty"`
