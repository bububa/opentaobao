...
type TvmPassengerVo struct {
    ...
    AgentEticket   string `json:"agent_eticket,omitempty"`
    ...
    TvmInsuranceInfos  struct {
        TvmInsuranceInfo  []TvmInsuranceInfo `json:"tvm_insurance_info,omitempty"`
    } `json:"tvm_insurance_infos,omitempty"`
