...
// 飞猪订单号
func (r *TaobaoBusTvmbookorderSetRequest) SetAlitripOrderId(_alitripOrderId string) error {
...
// BookTime Setter
// 出票时间 2017-03-03 11:22:33
func (r *TaobaoBusTvmbookorderSetRequest) SetBookTime(_bookTime string) error {
...
// Success Setter
// true代表出票成功；false代表出票失败
func (r *TaobaoBusTvmbookorderSetRequest) SetSuccess(_success bool) error {
    r._success = _success
...
// PayMode Setter
// 取值范围  ALIPAY （飞猪渠道）; WECHAT（微信）; BANKCARD（银行卡）;CASH（现金）; OWN_ALIPAY（自身支付宝渠道，非飞猪渠道）
func (r *TaobaoBusTvmbookorderSetRequest) SetPayMode(_payMode string) error {
    r._payMode = _payMode
...
// FetchPhone Setter
// 取票人手机号
func (r *TaobaoBusTvmbookorderSetRequest) SetFetchPhone(_fetchPhone string) error {
...
// Passengers Setter
// 乘客票面信息
func (r *TaobaoBusTvmbookorderSetRequest) SetPassengers(_passengers []TvmPassengerVo) error {
...
// 是否支持电子票
func (r *TaobaoBusTvmbookorderSetRequest) SetSupportEticket(_supportEticket bool) error {
...
// TicketGate Setter
// 检票口
func (r *TaobaoBusTvmbookorderSetRequest) SetTicketGate(_ticketGate string) error {
