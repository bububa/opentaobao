...
type Busomainorderhistoryvolist struct {
    ...
    CanRefund   int64 `json:"can_refund,omitempty"`
    ...
    // endCityName 到达城市
    EndCityName   string `json:"end_city_name,omitempty"`

    // arriveStationName 到达站名称
    ArriveStationName   string `json:"arrive_station_name,omitempty"`
    ...
    OrderModel   int64 `json:"order_model,omitempty"`
