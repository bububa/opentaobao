...
type TvmCreateOrderRq struct {
    ...
    Passengers   []TvmPassengerVo `json:"passengers,omitempty" xml:"passengers,omitempty"`
    ...
    AccountInDetails   []AccountInDetail `json:"account_in_details,omitempty" xml:"account_in_details,omitempty"`
