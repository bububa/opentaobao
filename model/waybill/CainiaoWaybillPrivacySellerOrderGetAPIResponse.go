...
type CainiaowaybillprivacysellerordergetAPIResponseModel struct {
	...
	// 返回值
	ResponseList []CainiaowaybillprivacysellerordergetModule `json:"response_list,omitempty" xml:"response_list>cainiaowaybillprivacysellerorderget_module,omitempty"`
	// 错误信息
