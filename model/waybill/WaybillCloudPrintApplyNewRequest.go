...
type WaybillCloudPrintApplyNewRequest struct {
    ...
    TradeOrderInfoDtos  struct {
        TradeOrderInfoDto  []TradeOrderInfoDto `json:"trade_order_info_dto,omitempty"`
    } `json:"trade_order_info_dtos,omitempty"`
...
type WaybillCloudPrintApplyNewRequest struct {
    ...
    // 发货人信息
    Sender   *UserInfoDto `json:"sender,omitempty"`

    // 请求面单信息，数量限制为10
    TradeOrderInfoDtos   []TradeOrderInfoDto `json:"trade_order_info_dtos,omitempty"`
