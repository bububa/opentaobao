...
// DataSetId Setter
// 身份ID，识别合作方身份（可联系口碑综合体业务获取）
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetDataSetId(_dataSetId string) error {
...
// MallId Setter
// 商圈ID
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetMallId(_mallId string) error {
    r._mallId = _mallId
...
// Start Setter
// 分页查询起始值，默认为0
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetStart(_start int64) error {
    r._start = _start
    r.Set("start", _start)
    return nil
}
...
// PageSize Setter
// 每页查询量，默认10（建议查询值为10的倍数，最大不超过20）
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetPageSize(_pageSize int64) error {
...
// CategoryIds Setter
// 门店列表按照类目筛选条件过滤，可通过查询商圈详情获取类目信息
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetCategoryIds(_categoryIds []string) error {
...
// StoreId Setter
// 商圈内的门店ID
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetStoreId(_storeId string) error {
    r._storeId = _storeId
...
// Order Setter
// 门店列表排序规则；默认：门店质量分降序，暂无其它排序规则
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetOrder(_order string) error {
    r._order = _order
    r.Set("order", _order)
    return nil
}
...
// ServiceTag Setter
// 店铺服务标签，用于列表过滤条件；比如：点餐/外卖/预定等服务筛选条件。预定：SERVICE_DING；排号：SERVICE_PAI；点菜：SERVICE_DIAN；外卖：SERVICE_WAI；
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetServiceTag(_serviceTag []string) error {
...
// CityCode Setter
// 口碑城市编码（示例：杭州市330100）
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetCityCode(_cityCode string) error {
...
// Longitude Setter
// 经度（终端设备地理位置）
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetLongitude(_longitude string) error {
...
// Latitude Setter
// 纬度（终端设备地理位置）
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetLatitude(_latitude string) error {
...
// TerminalType Setter
// 终端设备描述(中、英文均可)
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetTerminalType(_terminalType string) error {
...
// AppVersion Setter
// 支付宝/口碑/淘宝app版本号
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetAppVersion(_appVersion string) error {
...
// 展示渠道：ALIPAY_APP KOUBEI_APP TAOBAO_APP（默认ALIPAY_APP）
func (r *TaobaoKoubeiMallCommonStorePageRequest) SetDisplayChannel(_displayChannel string) error {
