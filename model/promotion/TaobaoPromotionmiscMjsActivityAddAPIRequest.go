...
func (r TaobaoPromotionmiscMjsActivityAddAPIRequest) GetApiParams(params url.Values) {
...
func (r TaobaoPromotionmiscMjsActivityAddAPIRequest) GetRawParams() model.Params {
	return r.Params
}
