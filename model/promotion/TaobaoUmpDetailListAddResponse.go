...
type TaobaoUmpDetailListAddAPIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"ump_detail_list_add_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识
    ...
    DetailIdList   []int64 `json:"detail_id_list,omitempty" xml:"