...
type RedRiskUpdateFactor struct {
    ...
    SkuRiskFactors   []SkuRedRiskFactor `json:"sku_risk_factors,omitempty" xml:"sku_risk_factors,omitempty"`
    

    // 风险等级设置
    
    RiskLevels   []RiskLevelParam `json:"risk_levels,omitempty" xml:"risk_levels,omitempty"`
