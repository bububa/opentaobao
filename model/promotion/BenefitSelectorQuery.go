...
var poolBenefitSelectorQuery = sync.Pool{
	New: func() any {
		return new(BenefitSelectorQuery)
	},
}

// GetBenefitSelectorQuery() 从对象池中获取BenefitSelectorQuery
func GetBenefitSelectorQuery() *BenefitSelectorQuery {
	return poolBenefitSelectorQuery.Get().(*BenefitSelectorQuery)
}

// ReleaseBenefitSelectorQuery 释放BenefitSelectorQuery
func ReleaseBenefitSelectorQuery(v *BenefitSelectorQuery) {
	v.BenefitType = ""
	v.BenefitId = 0
	v.ConfigId = 0
	v.ExcludeOptions = 0
	...
	v.CurrentPage = 0
	v.PageSize = 0
	v.PageQueryRequest = false
	poolBenefitSelectorQuery.Put(v)
}
