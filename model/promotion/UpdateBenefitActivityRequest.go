...
type UpdateBenefitActivityRequest struct {
    ...
    DeleteDetailVos   []DeleteActivityBenefitDetailVo `json:"delete_detail_vos,omitempty" xml:"delete_detail_vos,omitempty"`
    

    // 活动关联的权益信息列表，可以从权益选择器API中获取
    
    AddDetailVos   []ActivityBenefitDetailVo `json:"add_detail_vos,omitempty" xml:"add_detail_vos,omitempty"`
