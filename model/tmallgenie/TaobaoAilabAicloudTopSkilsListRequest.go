...
// Schema Setter
// 账户体系隔离
func (r *TaobaoAilabAicloudTopSkilsListRequest) SetSchema(_schema string) error {
    r._schema = _schema
...
// UserId Setter
// 用户ID，此处传入第三方账户体系的用户id
func (r *TaobaoAilabAicloudTopSkilsListRequest) SetUserId(_userId string) error {
    r._userId = _userId
...
// UtdId Setter
// 用户设备唯一识别码，长度限制32以内，建议使用系统接口获取deviceid,然后做一定的混淆处理来作为此输入参数
func (r *TaobaoAilabAicloudTopSkilsListRequest) SetUtdId(_utdId string) error {
    r._utdId = _utdId
    r.Set("utd_id", _utdId)
    return nil
}
...
// Ext Setter
// 扩展信息，用于存放APP类型等
func (r *TaobaoAilabAicloudTopSkilsListRequest) SetExt(_ext string) error {
    r._ext = _ext
    r.Set("ext", _ext)
    return nil
}
...
// Query Setter
// query(模糊匹配skillName)
func (r *TaobaoAilabAicloudTopSkilsListRequest) SetQuery(_query string) error {
    r._query = _query
    r.Set("query", _query)
    return nil
}
...
// Type Setter
// type(1000代表内容技能，3000代表自定义技能，4000代表官方技能)
func (r *TaobaoAilabAicloudTopSkilsListRequest) SetType(_type string) error {
    r._type = _type
    r.Set("type", _type)
    return nil
}
...
// PageNo Setter
// pageNo
func (r *TaobaoAilabAicloudTopSkilsListRequest) SetPageNo(_pageNo int64) error {
    r._pageNo = _pageNo
...
// PageSize Setter
// pageSize
func (r *TaobaoAilabAicloudTopSkilsListRequest) SetPageSize(_pageSize int64) error {
