...
type BotSkillsRelInfo struct {
    ...
    Results   []BotSkillsRelInfo `json:"results,omitempty" xml:"results,omitempty"`
    ...
    ServiceProviders   []ServiceProvider `json:"service_providers,omitempty" xml:"service_providers,omitempty"`
