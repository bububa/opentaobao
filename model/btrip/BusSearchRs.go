...
type BusSearchRs struct {
    ...
    BusLines   []BusLineInfoVo `json:"bus_lines,omitempty" xml:"bus_lines,omitempty"`
    ...
    RecommendRoutes   []RouteVo `json:"recommend_routes,omitempty" xml:"recommend_routes,omitempty"`
    

    // 车站信息集合
    
    StationLatitudeLongitudes   []StationLatitudeLongitudeVo `json:"station_latitude_longitudes,omitempty" xml:"station_latitude_longitudes,omitempty"`
