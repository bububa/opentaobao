...
type OpenApiZzdTrainOrderRs struct {
    ...
    CostCenterList   []CostCenterDo `json:"cost_center_list,omitempty" xml:"cost_center_list,omitempty"`
    

    // 用户信息
    
    ClientInfoDos   []ClientInfoDo `json:"client_info_dos,omitempty" xml:"client_info_dos,omitempty"`
    ...
    BtripTrainOpenTicketDoList   []BtripTrainOpenTicketDo `json:"btrip_train_open_ticket_do_list,omitempty" xml:"btrip_train_open_ticket_do_list,omitempty"`
