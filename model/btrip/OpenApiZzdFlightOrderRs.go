...
type OpenApiZzdFlightOrderRs struct {
    ...
    ClientInfodos   []ClientInfoDo `json:"client_infodos,omitempty" xml:"client_infodos,omitempty"`
    ...
    Ticketdos   []OpenTicketDo `json:"ticketdos,omitempty" xml:"ticketdos,omitempty"`
