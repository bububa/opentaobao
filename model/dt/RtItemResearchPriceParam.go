...
type RtItemResearchPriceParam struct {
    ...
    // 规格描述
    SpecDesc   string `json:"spec_desc,omitempty"`
    ...
    // 是否促销
    InPromotion   int64 `json:"in_promotion,omitempty"`
    ...
    // rt货号
    RtItemNo   string `json:"rt_item_no,omitempty"`
