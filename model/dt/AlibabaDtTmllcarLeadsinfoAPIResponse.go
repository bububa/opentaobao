...
// AlibabaDtTmllcarLeadsinfoAPIResponse 天猫汽车线索产品潜客数据 API返回值
...
// AlibabaDtTmllcarLeadsinfoAPIResponseModel is 天猫汽车线索产品潜客数据 成功返回结果
type AlibabaDtTmllcarLeadsinfoAPIResponseModel struct {
