...
type TaobaoMixnickChangeAPIResponse struct {
	...
	RequestId     string         `json:"request_id,omitempty" xml:"mixnick_change_response>request_id,omitempty"`         // 平台颁发的每次请求访问的唯一标识

    // 是否成功
    
    RetSuccess   bool `json:"ret_success,omitempty" xml:"