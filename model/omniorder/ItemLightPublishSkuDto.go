...
type ItemLightPublishSkuDto struct {
    ...
    SalePropsDTOs   []ItemLightPublishSalePropDto `json:"sale_props_d_t_os,omitempty" xml:"sale_props_d_t_os,omitempty"`
    ...
    SaleProps   []ItemLightPublishSalePropDto `json:"sale_props,omitempty" xml:"sale_props,omitempty"`
