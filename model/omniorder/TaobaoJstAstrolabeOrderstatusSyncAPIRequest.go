...
func (r TaobaoJstAstrolabeOrderstatusSyncAPIRequest) GetApiParams(params url.Values) {
...
func (r TaobaoJstAstrolabeOrderstatusSyncAPIRequest) GetRawParams() model.Params {
	return r.Params
}
