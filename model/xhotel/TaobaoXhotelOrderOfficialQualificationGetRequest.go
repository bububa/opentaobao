...
// NotifyUrl Setter
// 卖家接收阿里旅行订单状态变更的服务地址（需要实现阿里旅行提供的服务通知规范）
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetNotifyUrl(_notifyUrl string) error {
...
// ReturnUrl Setter
// 阿里旅行支付（下单）结束后跳转卖家的页面地址（必须）
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetReturnUrl(_returnUrl string) error {
...
// ExtendAttrs Setter
// 扩展字段，json串，用户后续的营销、统计、定制等需求，目前已有key列表：      is_new_user：是否是卖家新用户，1-是，0或者key为null，表示不是      is_first_stay：是否是卖家首住，1-是，0或者key为null，表示不是     （已有列表必须传递）
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetExtendAttrs(_extendAttrs string) error {
...
// MobileNo Setter
// 用户手机号(可选)
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetMobileNo(_mobileNo string) error {
...
// Vendor Setter
// 商家在淘宝给分配的渠道名（建议填充较好）
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetVendor(_vendor string) error {
    r._vendor = _vendor
...
// IdType Setter
// 证件类型, 默认0:身份证; 1: 护照; 2:警官证; 3:士兵证; 4: 回乡证。目前只支持身份证
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetIdType(_idType int64) error {
    r._idType = _idType
...
// EncryptType Setter
// 加密方式, 默认0: 不加密, 信息会通过淘宝开放平台传输, 阿里旅行可以获取到具体信息;      * 目前只支持不加密
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetEncryptType(_encryptType int64) error {
...
// GuestName Setter
// 入住人姓名（必选）
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetGuestName(_guestName string) error {
...
// 用户支付宝唯一识别码(可选)
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetAlipayAccount(_alipayAccount string) error {
...
// 外部会员账号（必选）
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetOutMemberAccount(_outMemberAccount string) error {
...
// IdNumber Setter
// 身份证号，必选
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetIdNumber(_idNumber string) error {
...
// 每日房价,json格式 ，如果是多间房，则是每日多间房总房价(可选)      * eg:{"day":"2015-08-12","price":48800},      {"day":"2015-08-13","price":48800}
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetDailyPriceInfo(_dailyPriceInfo string) error {
...
// CheckOut Setter
// 客人离店日期, 最多支持9间夜
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetCheckOut(_checkOut string) error {
...
// CheckIn Setter
// 客人入住日期
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetCheckIn(_checkIn string) error {
    r._checkIn = _checkIn
...
// OutUUID Setter
// 外部请求序列表号\流水号，单次请求的唯一标识(必须)
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetOutUUID(_outUUID string) error {
    r._outUUID = _outUUID
...
// TotalFee Setter
// 总的收费金额，单位为分(必须)
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetTotalFee(_totalFee int64) error {
...
// HotelCode Setter
// 酒店外部编码
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetHotelCode(_hotelCode string) error {
...
// OutOid Setter
// 外部订单号（必选），阿里旅行会根据此值进行幂等性校验
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetOutOid(_outOid string) error {
    r._outOid = _outOid
...
// RoomNum Setter
// 房间数
func (r *TaobaoXhotelOrderOfficialQualificationGetRequest) SetRoomNum(_roomNum int64) error {
    r._roomNum = _roomNum
