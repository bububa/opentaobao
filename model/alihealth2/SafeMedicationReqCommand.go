...
type SafeMedicationReqCommand struct {
    ...
    PrescriptionItems   []PrescriptionItem `json:"prescription_items,omitempty" xml:"prescription_items,omitempty"`
    

    // 诊断信息，启用适应症和禁忌症规则下必传
    
    Diags   []Diag `json:"diags,omitempty" xml:"diags,omitempty"`
