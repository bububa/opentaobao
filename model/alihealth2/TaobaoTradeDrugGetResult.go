...
// TaobaoTradeDrugGetResult 
type TaobaoTradeDrugGetResult struct {

    // 订单列表
    
    ResultList   []TaobaoTradeDrugGetResult `json:"result_list,omitempty" xml:"result_list,omitempty"`
    ...
    GoodsList   []OrderGoods `json:"goods_list,omitempty" xml:"goods_list,omitempty"`
