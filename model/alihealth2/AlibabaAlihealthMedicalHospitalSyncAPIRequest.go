...
// AlibabaAlihealthMedicalHospitalSyncAPIRequest 阿里将康支付宝挂号数据医院回传接口 API请求
...
func (r AlibabaAlihealthMedicalHospitalSyncAPIRequest) GetApiParams(params url.Values) {
...
func (r AlibabaAlihealthMedicalHospitalSyncAPIRequest) GetRawParams() model.Params {
	return r.Params
}
