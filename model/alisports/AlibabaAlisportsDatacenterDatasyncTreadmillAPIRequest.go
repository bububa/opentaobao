...
// Set is CollectTimeInterval Setter
// 过程数据收集间隔时间
...
// Get MotionFrequencyDatas Getter
...
// Set is HrzMotionRangeDatas Setter
// 步幅/踏幅/桨幅过程数据
