...
// AlispAppKey Setter
// 应用appkey
func (r *AlibabaAlisportsPassportAccountSsotokenrefreshRequest) SetAlispAppKey(_alispAppKey string) error {
...
// AlispTime Setter
// 当前时间戳[精确到秒,10位]
func (r *AlibabaAlisportsPassportAccountSsotokenrefreshRequest) SetAlispTime(_alispTime string) error {
...
// AlispSign Setter
// 签名
func (r *AlibabaAlisportsPassportAccountSsotokenrefreshRequest) SetAlispSign(_alispSign string) error {
...
// Secret Setter
// 登录成功返回的access_token(access_token是TOP保留关键字，只能改名，望谅解)
func (r *AlibabaAlisportsPassportAccountSsotokenrefreshRequest) SetSecret(_secret string) error {
    r._secret = _secret
