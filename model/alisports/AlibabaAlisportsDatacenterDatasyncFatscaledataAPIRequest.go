...
func (r AlibabaAlisportsDatacenterDatasyncFatscaledataAPIRequest) GetApiParams(params url.Values) {
...
func (r AlibabaAlisportsDatacenterDatasyncFatscaledataAPIRequest) GetRawParams() model.Params {
	return r.Params
}
