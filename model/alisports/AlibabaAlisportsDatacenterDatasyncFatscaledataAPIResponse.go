...
// AlibabaAlisportsDatacenterDatasyncFatscaledataAPIResponse 阿里体育接入体脂秤数据 API返回值
...
// AlibabaAlisportsDatacenterDatasyncFatscaledataAPIResponseModel is 阿里体育接入体脂秤数据 成功返回结果
type AlibabaAlisportsDatacenterDatasyncFatscaledataAPIResponseModel struct {
