...
type ClearanceOrderLineDo struct {
    ...
    OriginalCountry   string `json:"original_country,omitempty"`
    ...
    SellProperty   string `json:"sell_property,omitempty"`
    ...
    TaxDO  *struct {
        ClearanceTaxDo  *ClearanceTaxDo `json:"clearance_tax_do,omitempty"`
    } `json:"tax_d_o,omitempty"`
    

    // 计量单位封装
    
    UnitDO  *struct {
        ClearanceUnitDo  *ClearanceUnitDo `json:"clearance_unit_do,omitempty"`
    } `json:"unit_d_o,omitempty"`
    

    // 镜像商品ID
    
    VirtualItemId   string `json:"virtual_item_id,omitempty"`
...
type ClearanceOrderLineDo struct {
    ...
    // 计量单位封装
    UnitDO   *ClearanceUnitDo `json:"unit_d_o,omitempty"`
