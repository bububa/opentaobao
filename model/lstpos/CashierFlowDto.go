...
type CashierFlowDto struct {
    ...
    CashierGoodsDetailDTOList   []CashierGoodsDetailDto `json:"cashier_goods_detail_d_t_o_list,omitempty" xml:"cashier_goods_detail_d_t_o_list,omitempty"`
    ...
    CashierPayDetailDTOList   []CashierPayDetailDto `json:"cashier_pay_detail_d_t_o_list,omitempty" xml:"cashier_pay_detail_d_t_o_list,omitempty"`
