...
// AlibabaLstPosOpenGoodsGetgoodsbypagingAPIResponseModel is 分页查询用户全量的门店域商品接口(每页最多20条) 成功返回结果
type AlibabaLstPosOpenGoodsGetgoodsbypagingAPIResponseModel struct {
