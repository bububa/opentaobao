...
*/
func TaobaoSmartstoreDeviceMakeupmirrorFeedback(clt *core.SDKClient, req *smartstore.TaobaoSmartstoreDeviceMakeupmirrorFeedbackRequest, session string) (*smartstore.TaobaoSmartstoreDeviceMakeupmirrorFeedbackAPIResponse, error) {
