...
*/
func TaobaoIstoreAreasGet(clt *core.SDKClient, req *smartstore.TaobaoIstoreAreasGetRequest, session string) (*smartstore.TaobaoIstoreAreasGetAPIResponse, error) {
