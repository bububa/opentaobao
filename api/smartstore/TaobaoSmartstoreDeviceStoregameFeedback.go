...
// TaobaoSmartstoreDeviceStoregameFeedback 智能硬件互动大屏数据回流
...
func TaobaoSmartstoreDeviceStoregameFeedback(clt *core.SDKClient, req *smartstore.TaobaoSmartstoreDeviceStoregameFeedbackAPIRequest, session string) (*smartstore.TaobaoSmartstoreDeviceStoregameFeedbackAPIResponse, error) {
