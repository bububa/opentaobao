...
*/
func TaobaoXhotelOrderFutureInfoPut(clt *core.SDKClient, req *xhotelonlineorder.TaobaoXhotelOrderFutureInfoPutRequest, session string) (*xhotelonlineorder.TaobaoXhotelOrderFutureInfoPutAPIResponse, error) {
