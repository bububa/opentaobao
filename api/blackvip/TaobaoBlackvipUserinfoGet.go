...
*/
func TaobaoBlackvipUserinfoGet(clt *core.SDKClient, req *blackvip.TaobaoBlackvipUserinfoGetRequest, session string) (*blackvip.TaobaoBlackvipUserinfoGetResponse, error) {
