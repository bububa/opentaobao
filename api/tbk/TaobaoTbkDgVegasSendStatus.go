...
*/
func TaobaoTbkDgVegasSendStatus(clt *core.SDKClient, req *tbk.TaobaoTbkDgVegasSendStatusRequest, session string) (*tbk.TaobaoTbkDgVegasSendStatusAPIResponse, error) {
