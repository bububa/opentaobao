...
*/
func TaobaoTbkDgOptimusMaterial(clt *core.SDKClient, req *tbk.TaobaoTbkDgOptimusMaterialRequest, session string) (*tbk.TaobaoTbkDgOptimusMaterialResponse, error) {
