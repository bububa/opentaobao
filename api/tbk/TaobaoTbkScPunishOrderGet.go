...
func TaobaoTbkScPunishOrderGet(clt *core.SDKClient, req *tbk.TaobaoTbkScPunishOrderGetAPIRequest, resp *tbk.TaobaoTbkScPunishOrderGetAPIResponse, session string) error {
