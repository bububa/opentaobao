...
func TaobaoTbkRtaConsumerMatch(ctx context.Context, clt *core.SDKClient, req *tbk.TaobaoTbkRtaConsumerMatchAPIRequest, resp *tbk.TaobaoTbkRtaConsumerMatchAPIResponse, session string) error {
