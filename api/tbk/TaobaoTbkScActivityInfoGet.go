...
func TaobaoTbkScActivityInfoGet(ctx context.Context, clt *core.SDKClient, req *tbk.TaobaoTbkScActivityInfoGetAPIRequest, resp *tbk.TaobaoTbkScActivityInfoGetAPIResponse, session string) error {
