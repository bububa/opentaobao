...
func TaobaoTbkActivityInfoGet(clt *core.SDKClient, req *tbk.TaobaoTbkActivityInfoGetAPIRequest, resp *tbk.TaobaoTbkActivityInfoGetAPIResponse, session string) error {
