...
func TaobaoOcTradetagsGet(ctx context.Context, clt *core.SDKClient, req *jst.TaobaoOcTradetagsGetAPIRequest, resp *jst.TaobaoOcTradetagsGetAPIResponse, session string) error {
