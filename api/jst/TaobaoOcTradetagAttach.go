...
func TaobaoOcTradetagAttach(ctx context.Context, clt *core.SDKClient, req *jst.TaobaoOcTradetagAttachAPIRequest, resp *jst.TaobaoOcTradetagAttachAPIResponse, session string) error {
