...
func TaobaoOcTradetagAttach(clt *core.SDKClient, req *jst.TaobaoOcTradetagAttachAPIRequest, resp *jst.TaobaoOcTradetagAttachAPIResponse, session string) error {
