...
*/
func AlibabaNlifeB2cTradePay(clt *core.SDKClient, req *nlife.AlibabaNlifeB2cTradePayRequest, session string) (*nlife.AlibabaNlifeB2cTradePayAPIResponse, error) {
