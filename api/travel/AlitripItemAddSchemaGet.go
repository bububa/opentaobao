...
func AlitripItemAddSchemaGet(clt *core.SDKClient, req *travel.AlitripItemAddSchemaGetAPIRequest, resp *travel.AlitripItemAddSchemaGetAPIResponse, session string) error {
