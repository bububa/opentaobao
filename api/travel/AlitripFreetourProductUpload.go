...
func AlitripFreetourProductUpload(ctx context.Context, clt *core.SDKClient, req *travel.AlitripFreetourProductUploadAPIRequest, resp *travel.AlitripFreetourProductUploadAPIResponse, session string) error {
