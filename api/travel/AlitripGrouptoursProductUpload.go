...
func AlitripGrouptoursProductUpload(clt *core.SDKClient, req *travel.AlitripGrouptoursProductUploadAPIRequest, resp *travel.AlitripGrouptoursProductUploadAPIResponse, session string) error {
