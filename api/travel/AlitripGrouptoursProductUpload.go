...
*/
func AlitripGrouptoursProductUpload(clt *core.SDKClient, req *travel.AlitripGrouptoursProductUploadRequest, session string) (*travel.AlitripGrouptoursProductUploadResponse, error) {
