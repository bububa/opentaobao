...
*/
func AlitripItemSchemaUpdate(clt *core.SDKClient, req *travel.AlitripItemSchemaUpdateRequest, session string) (*travel.AlitripItemSchemaUpdateAPIResponse, error) {
