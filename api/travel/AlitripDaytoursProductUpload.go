...
func AlitripDaytoursProductUpload(clt *core.SDKClient, req *travel.AlitripDaytoursProductUploadAPIRequest, resp *travel.AlitripDaytoursProductUploadAPIResponse, session string) error {
