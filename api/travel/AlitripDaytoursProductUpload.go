...
*/
func AlitripDaytoursProductUpload(clt *core.SDKClient, req *travel.AlitripDaytoursProductUploadRequest, session string) (*travel.AlitripDaytoursProductUploadAPIResponse, error) {
