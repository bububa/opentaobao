...
func AlitripItemSchemaAdd(clt *core.SDKClient, req *travel.AlitripItemSchemaAddAPIRequest, session string) (*travel.AlitripItemSchemaAddAPIResponse, error) {
