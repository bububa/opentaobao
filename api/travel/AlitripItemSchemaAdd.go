...
func AlitripItemSchemaAdd(clt *core.SDKClient, req *travel.AlitripItemSchemaAddAPIRequest, resp *travel.AlitripItemSchemaAddAPIResponse, session string) error {
