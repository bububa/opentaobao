...
*/
func AlitripItemUpdateSchemaGet(clt *core.SDKClient, req *travel.AlitripItemUpdateSchemaGetRequest, session string) (*travel.AlitripItemUpdateSchemaGetResponse, error) {
