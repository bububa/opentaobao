...
func AlitripItemUpdateSchemaGet(clt *core.SDKClient, req *travel.AlitripItemUpdateSchemaGetAPIRequest, resp *travel.AlitripItemUpdateSchemaGetAPIResponse, session string) error {
