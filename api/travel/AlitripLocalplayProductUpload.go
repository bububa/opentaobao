...
func AlitripLocalplayProductUpload(clt *core.SDKClient, req *travel.AlitripLocalplayProductUploadAPIRequest, resp *travel.AlitripLocalplayProductUploadAPIResponse, session string) error {
