...
func AlitripTravelGereralitemUpdate(clt *core.SDKClient, req *travel.AlitripTravelGereralitemUpdateAPIRequest, resp *travel.AlitripTravelGereralitemUpdateAPIResponse, session string) error {
