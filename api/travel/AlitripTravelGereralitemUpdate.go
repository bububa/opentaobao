...
*/
func AlitripTravelGereralitemUpdate(clt *core.SDKClient, req *travel.AlitripTravelGereralitemUpdateRequest, session string) (*travel.AlitripTravelGereralitemUpdateAPIResponse, error) {
