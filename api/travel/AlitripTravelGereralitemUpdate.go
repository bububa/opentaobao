...
func AlitripTravelGereralitemUpdate(ctx context.Context, clt *core.SDKClient, req *travel.AlitripTravelGereralitemUpdateAPIRequest, resp *travel.AlitripTravelGereralitemUpdateAPIResponse, session string) error {
