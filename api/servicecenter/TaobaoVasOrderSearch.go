...
*/
func TaobaoVasOrderSearch(clt *core.SDKClient, req *servicecenter.TaobaoVasOrderSearchRequest, session string) (*servicecenter.TaobaoVasOrderSearchAPIResponse, error) {
