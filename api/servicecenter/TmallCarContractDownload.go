...
*/
func TmallCarContractDownload(clt *core.SDKClient, req *servicecenter.TmallCarContractDownloadRequest, session string) (*servicecenter.TmallCarContractDownloadAPIResponse, error) {
