...
*/
func TaobaoFuwuSaleLinkGen(clt *core.SDKClient, req *servicecenter.TaobaoFuwuSaleLinkGenRequest, session string) (*servicecenter.TaobaoFuwuSaleLinkGenAPIResponse, error) {
