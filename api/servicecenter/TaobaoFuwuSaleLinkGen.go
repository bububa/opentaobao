...
func TaobaoFuwuSaleLinkGen(clt *core.SDKClient, req *servicecenter.TaobaoFuwuSaleLinkGenAPIRequest, resp *servicecenter.TaobaoFuwuSaleLinkGenAPIResponse, session string) error {
