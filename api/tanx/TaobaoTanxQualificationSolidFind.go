...
*/
func TaobaoTanxQualificationSolidFind(clt *core.SDKClient, req *tanx.TaobaoTanxQualificationSolidFindRequest, session string) (*tanx.TaobaoTanxQualificationSolidFindResponse, error) {
