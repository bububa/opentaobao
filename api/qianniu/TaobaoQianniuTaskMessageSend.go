...
*/
func TaobaoQianniuTaskMessageSend(clt *core.SDKClient, req *qianniu.TaobaoQianniuTaskMessageSendRequest, session string) (*qianniu.TaobaoQianniuTaskMessageSendResponse, error) {
