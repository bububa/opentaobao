...
func TaobaoQianniuTasksGet(ctx context.Context, clt *core.SDKClient, req *qianniu.TaobaoQianniuTasksGetAPIRequest, resp *qianniu.TaobaoQianniuTasksGetAPIResponse, session string) error {
