...
20001,已查询到最后一页
*/
func TmallServicecenterWorkerDelete(clt *core.SDKClient, req *tmallservice.TmallServicecenterWorkerDeleteRequest, session string) (*tmallservice.TmallServicecenterWorkerDeleteResponse, error) {
