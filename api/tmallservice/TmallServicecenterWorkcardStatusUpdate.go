...
*/
func TmallServicecenterWorkcardStatusUpdate(clt *core.SDKClient, req *tmallservice.TmallServicecenterWorkcardStatusUpdateRequest, session string) (*tmallservice.TmallServicecenterWorkcardStatusUpdateResponse, error) {
