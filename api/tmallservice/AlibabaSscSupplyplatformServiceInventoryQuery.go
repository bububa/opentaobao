...
*/
func AlibabaSscSupplyplatformServiceInventoryQuery(clt *core.SDKClient, req *tmallservice.AlibabaSscSupplyplatformServiceInventoryQueryRequest, session string) (*tmallservice.AlibabaSscSupplyplatformServiceInventoryQueryResponse, error) {
