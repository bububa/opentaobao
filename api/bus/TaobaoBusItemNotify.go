...
func Taobaobusitemnotify(clt *core.SDKClient, req *bus.TaobaobusitemnotifyAPIRequest, session string) (*bus.TaobaobusitemnotifyAPIResponse, error) {
	var resp bus.TaobaobusitemnotifyAPIResponse
