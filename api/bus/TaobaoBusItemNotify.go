...
func TaobaoBusItemNotify(ctx context.Context, clt *core.SDKClient, req *bus.TaobaoBusItemNotifyAPIRequest, resp *bus.TaobaoBusItemNotifyAPIResponse, session string) error {
