...
*/
func TaobaoXhotelOrderAlipayfaceCreate(clt *core.SDKClient, req *xhoteloffline.TaobaoXhotelOrderAlipayfaceCreateRequest, session string) (*xhoteloffline.TaobaoXhotelOrderAlipayfaceCreateAPIResponse, error) {
