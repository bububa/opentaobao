...
func TaobaoRefundRefuse(clt *core.SDKClient, req *tbrefund.TaobaoRefundRefuseAPIRequest, session string) (*tbrefund.TaobaoRefundRefuseAPIResponse, error) {
	var resp tbrefund.TaobaoRefundRefuseAPIResponse
