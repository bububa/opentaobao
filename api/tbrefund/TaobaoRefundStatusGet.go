...
func TaobaoRefundStatusGet(clt *core.SDKClient, req *tbrefund.TaobaoRefundStatusGetAPIRequest, session string) (*tbrefund.TaobaoRefundStatusGetAPIResponse, error) {
	var resp tbrefund.TaobaoRefundStatusGetAPIResponse
