...
*/
func YunosCloudcardBatchOpermsgSend(clt *core.SDKClient, req *yunos.YunosCloudcardBatchOpermsgSendRequest, session string) (*yunos.YunosCloudcardBatchOpermsgSendAPIResponse, error) {
