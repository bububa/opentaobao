...
*/
func TmallItemsExtendSearch(clt *core.SDKClient, req *tmallitem.TmallItemsExtendSearchRequest, session string) (*tmallitem.TmallItemsExtendSearchResponse, error) {
