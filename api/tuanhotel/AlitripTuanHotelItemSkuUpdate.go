...
*/
func AlitripTuanHotelItemSkuUpdate(clt *core.SDKClient, req *tuanhotel.AlitripTuanHotelItemSkuUpdateRequest, session string) (*tuanhotel.AlitripTuanHotelItemSkuUpdateAPIResponse, error) {
