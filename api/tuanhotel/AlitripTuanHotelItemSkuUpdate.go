...
func AlitripTuanHotelItemSkuUpdate(clt *core.SDKClient, req *tuanhotel.AlitripTuanHotelItemSkuUpdateAPIRequest, resp *tuanhotel.AlitripTuanHotelItemSkuUpdateAPIResponse, session string) error {
