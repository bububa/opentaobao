...
func AlitripTuanHotelItemSkuCalendarUpdate(clt *core.SDKClient, req *tuanhotel.AlitripTuanHotelItemSkuCalendarUpdateAPIRequest, resp *tuanhotel.AlitripTuanHotelItemSkuCalendarUpdateAPIResponse, session string) error {
