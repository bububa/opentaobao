...
*/
func AlitripTuanHotelItemSkuCalendarUpdate(clt *core.SDKClient, req *tuanhotel.AlitripTuanHotelItemSkuCalendarUpdateRequest, session string) (*tuanhotel.AlitripTuanHotelItemSkuCalendarUpdateAPIResponse, error) {
