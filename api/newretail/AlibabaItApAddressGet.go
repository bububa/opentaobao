...
*/
func AlibabaItApAddressGet(clt *core.SDKClient, req *newretail.AlibabaItApAddressGetRequest, session string) (*newretail.AlibabaItApAddressGetAPIResponse, error) {
