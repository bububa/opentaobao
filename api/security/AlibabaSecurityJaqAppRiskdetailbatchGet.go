...
*/
func AlibabaSecurityJaqAppRiskdetailbatchGet(clt *core.SDKClient, req *security.AlibabaSecurityJaqAppRiskdetailbatchGetRequest, session string) (*security.AlibabaSecurityJaqAppRiskdetailbatchGetResponse, error) {
