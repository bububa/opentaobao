...
*/
func AlibabaSecurityJaqAppRiskdetailGet(clt *core.SDKClient, req *security.AlibabaSecurityJaqAppRiskdetailGetRequest, session string) (*security.AlibabaSecurityJaqAppRiskdetailGetResponse, error) {
