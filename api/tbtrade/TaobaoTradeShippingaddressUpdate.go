...
func TaobaoTradeShippingaddressUpdate(clt *core.SDKClient, req *tbtrade.TaobaoTradeShippingaddressUpdateAPIRequest, resp *tbtrade.TaobaoTradeShippingaddressUpdateAPIResponse, session string) error {
