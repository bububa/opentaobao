...
func Taobaotradessoldincrementvget(clt *core.SDKClient, req *tbtrade.TaobaotradessoldincrementvgetAPIRequest, session string) (*tbtrade.TaobaotradessoldincrementvgetAPIResponse, error) {
	var resp tbtrade.TaobaotradessoldincrementvgetAPIResponse
