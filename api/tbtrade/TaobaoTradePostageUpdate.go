...
func TaobaoTradePostageUpdate(clt *core.SDKClient, req *tbtrade.TaobaoTradePostageUpdateAPIRequest, resp *tbtrade.TaobaoTradePostageUpdateAPIResponse, session string) error {
