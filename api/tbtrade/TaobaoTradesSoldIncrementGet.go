...
func Taobaotradessoldincrementget(clt *core.SDKClient, req *tbtrade.TaobaotradessoldincrementgetAPIRequest, session string) (*tbtrade.TaobaotradessoldincrementgetAPIResponse, error) {
	var resp tbtrade.TaobaotradessoldincrementgetAPIResponse
