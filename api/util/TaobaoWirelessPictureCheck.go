...
*/
func TaobaoWirelessPictureCheck(clt *core.SDKClient, req *util.TaobaoWirelessPictureCheckRequest, session string) (*util.TaobaoWirelessPictureCheckAPIResponse, error) {
