...
func TaobaoWirelessPictureCheck(clt *core.SDKClient, req *util.TaobaoWirelessPictureCheckAPIRequest, resp *util.TaobaoWirelessPictureCheckAPIResponse, session string) error {
