...
*/
func TaobaoWirelessPictureCheck(clt *core.SDKClient, req *util.TaobaoWirelessPictureCheckRequest, session string) (*util.TaobaoWirelessPictureCheckResponse, error) {
