...
*/
func TaobaoTopAuthTokenRefresh(clt *core.SDKClient, req *util.TaobaoTopAuthTokenRefreshRequest, session string) (*util.TaobaoTopAuthTokenRefreshAPIResponse, error) {
