...
*/
func TaobaoTopAuthTokenRefresh(clt *core.SDKClient, req *util.TaobaoTopAuthTokenRefreshRequest, session string) (*util.TaobaoTopAuthTokenRefreshResponse, error) {
