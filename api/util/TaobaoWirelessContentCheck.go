...
func TaobaoWirelessContentCheck(clt *core.SDKClient, req *util.TaobaoWirelessContentCheckAPIRequest, resp *util.TaobaoWirelessContentCheckAPIResponse, session string) error {
