...
*/
func TaobaoWirelessContentCheck(clt *core.SDKClient, req *util.TaobaoWirelessContentCheckRequest, session string) (*util.TaobaoWirelessContentCheckAPIResponse, error) {
