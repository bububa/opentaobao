...
*/
func TaobaoOpenimTribeSetmembernick(clt *core.SDKClient, req *openim.TaobaoOpenimTribeSetmembernickRequest, session string) (*openim.TaobaoOpenimTribeSetmembernickResponse, error) {
