...
func Taobaotradessoldhistoryget(clt *core.SDKClient, req *trade.TaobaotradessoldhistorygetAPIRequest, session string) (*trade.TaobaotradessoldhistorygetAPIResponse, error) {
	var resp trade.TaobaotradessoldhistorygetAPIResponse
