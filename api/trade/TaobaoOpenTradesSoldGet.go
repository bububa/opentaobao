...
func TaobaoOpenTradesSoldGet(clt *core.SDKClient, req *trade.TaobaoOpenTradesSoldGetAPIRequest, resp *trade.TaobaoOpenTradesSoldGetAPIResponse, session string) error {
