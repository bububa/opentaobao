...
*/
func TaobaoTradeShippingaddressUpdate(clt *core.SDKClient, req *trade.TaobaoTradeShippingaddressUpdateRequest, session string) (*trade.TaobaoTradeShippingaddressUpdateResponse, error) {
