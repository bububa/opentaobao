...
*/
func TaobaoTradePostageUpdate(clt *core.SDKClient, req *trade.TaobaoTradePostageUpdateRequest, session string) (*trade.TaobaoTradePostageUpdateResponse, error) {
