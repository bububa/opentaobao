...
*/
func TaobaoTradeOrderskuUpdate(clt *core.SDKClient, req *trade.TaobaoTradeOrderskuUpdateRequest, session string) (*trade.TaobaoTradeOrderskuUpdateResponse, error) {
