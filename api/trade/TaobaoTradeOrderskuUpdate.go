...
*/
func TaobaoTradeOrderskuUpdate(clt *core.SDKClient, req *trade.TaobaoTradeOrderskuUpdateRequest, session string) (*trade.TaobaoTradeOrderskuUpdateAPIResponse, error) {
