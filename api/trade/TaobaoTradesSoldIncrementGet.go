...
*/
func TaobaoTradesSoldIncrementGet(clt *core.SDKClient, req *trade.TaobaoTradesSoldIncrementGetRequest, session string) (*trade.TaobaoTradesSoldIncrementGetResponse, error) {
