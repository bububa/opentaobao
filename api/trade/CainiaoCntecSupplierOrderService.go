...
*/
func CainiaoCntecSupplierOrderService(clt *core.SDKClient, req *trade.CainiaoCntecSupplierOrderServiceRequest, session string) (*trade.CainiaoCntecSupplierOrderServiceAPIResponse, error) {
