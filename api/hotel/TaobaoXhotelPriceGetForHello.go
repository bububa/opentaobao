...
*/
func TaobaoXhotelPriceGetForHello(clt *core.SDKClient, req *hotel.TaobaoXhotelPriceGetForHelloRequest, session string) (*hotel.TaobaoXhotelPriceGetForHelloResponse, error) {
