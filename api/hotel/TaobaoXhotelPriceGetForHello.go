...
func TaobaoXhotelPriceGetForHello(clt *core.SDKClient, req *hotel.TaobaoXhotelPriceGetForHelloAPIRequest, resp *hotel.TaobaoXhotelPriceGetForHelloAPIResponse, session string) error {
