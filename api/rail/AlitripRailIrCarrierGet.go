...
func AlitripRailIrCarrierGet(clt *core.SDKClient, req *rail.AlitripRailIrCarrierGetAPIRequest, resp *rail.AlitripRailIrCarrierGetAPIResponse, session string) error {
