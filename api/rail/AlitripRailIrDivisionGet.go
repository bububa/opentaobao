...
func AlitripRailIrDivisionGet(clt *core.SDKClient, req *rail.AlitripRailIrDivisionGetAPIRequest, resp *rail.AlitripRailIrDivisionGetAPIResponse, session string) error {
