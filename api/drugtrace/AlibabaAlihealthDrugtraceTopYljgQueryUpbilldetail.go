...
*/
func AlibabaAlihealthDrugtraceTopYljgQueryUpbilldetail(clt *core.SDKClient, req *drugtrace.AlibabaAlihealthDrugtraceTopYljgQueryUpbilldetailRequest, session string) (*drugtrace.AlibabaAlihealthDrugtraceTopYljgQueryUpbilldetailAPIResponse, error) {
