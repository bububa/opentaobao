...
func AlibabaAlihealthDrugtraceTopLsydUploadinoutbill(ctx context.Context, clt *core.SDKClient, req *drugtrace.AlibabaAlihealthDrugtraceTopLsydUploadinoutbillAPIRequest, resp *drugtrace.AlibabaAlihealthDrugtraceTopLsydUploadinoutbillAPIResponse, session string) error {
