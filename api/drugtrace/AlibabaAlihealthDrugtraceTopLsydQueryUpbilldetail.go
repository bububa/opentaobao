...
*/
func AlibabaAlihealthDrugtraceTopLsydQueryUpbilldetail(clt *core.SDKClient, req *drugtrace.AlibabaAlihealthDrugtraceTopLsydQueryUpbilldetailRequest, session string) (*drugtrace.AlibabaAlihealthDrugtraceTopLsydQueryUpbilldetailAPIResponse, error) {
