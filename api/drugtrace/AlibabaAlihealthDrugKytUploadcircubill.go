...
// AlibabaAlihealthDrugKytUploadcircubill 生产批发单据上传
...
func AlibabaAlihealthDrugKytUploadcircubill(ctx context.Context, clt *core.SDKClient, req *drugtrace.AlibabaAlihealthDrugKytUploadcircubillAPIRequest, resp *drugtrace.AlibabaAlihealthDrugKytUploadcircubillAPIResponse, session string) error {
