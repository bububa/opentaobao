...
func AlibabaAlihealthDrugKytUploadinoutbill(ctx context.Context, clt *core.SDKClient, req *drugtrace.AlibabaAlihealthDrugKytUploadinoutbillAPIRequest, resp *drugtrace.AlibabaAlihealthDrugKytUploadinoutbillAPIResponse, session string) error {
