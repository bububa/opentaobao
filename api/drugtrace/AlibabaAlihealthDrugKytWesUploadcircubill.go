...
func AlibabaAlihealthDrugKytWesUploadcircubill(clt *core.SDKClient, req *drugtrace.AlibabaAlihealthDrugKytWesUploadcircubillAPIRequest, session string) (*drugtrace.AlibabaAlihealthDrugKytWesUploadcircubillAPIResponse, error) {
	var resp drugtrace.AlibabaAlihealthDrugKytWesUploadcircubillAPIResponse
