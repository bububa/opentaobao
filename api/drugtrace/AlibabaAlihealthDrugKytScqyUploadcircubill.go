...
func AlibabaAlihealthDrugKytScqyUploadcircubill(ctx context.Context, clt *core.SDKClient, req *drugtrace.AlibabaAlihealthDrugKytScqyUploadcircubillAPIRequest, resp *drugtrace.AlibabaAlihealthDrugKytScqyUploadcircubillAPIResponse, session string) error {
