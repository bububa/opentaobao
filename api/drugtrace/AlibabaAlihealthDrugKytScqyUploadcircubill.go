...
func AlibabaAlihealthDrugKytScqyUploadcircubill(clt *core.SDKClient, req *drugtrace.AlibabaAlihealthDrugKytScqyUploadcircubillAPIRequest, session string) (*drugtrace.AlibabaAlihealthDrugKytScqyUploadcircubillAPIResponse, error) {
	var resp drugtrace.AlibabaAlihealthDrugKytScqyUploadcircubillAPIResponse
