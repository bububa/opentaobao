...
func AlibabaAlihealthDrugKytWesUploadinoutbill(ctx context.Context, clt *core.SDKClient, req *drugtrace.AlibabaAlihealthDrugKytWesUploadinoutbillAPIRequest, resp *drugtrace.AlibabaAlihealthDrugKytWesUploadinoutbillAPIResponse, session string) error {
