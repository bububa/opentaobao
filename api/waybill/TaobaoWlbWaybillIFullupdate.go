...
*/
func TaobaoWlbWaybillIFullupdate(clt *core.SDKClient, req *waybill.TaobaoWlbWaybillIFullupdateRequest, session string) (*waybill.TaobaoWlbWaybillIFullupdateResponse, error) {
