...
// TaobaoItemJointPropimg 商品关联属性图
...
func TaobaoItemJointPropimg(clt *core.SDKClient, req *tbitem.TaobaoItemJointPropimgAPIRequest, resp *tbitem.TaobaoItemJointPropimgAPIResponse, session string) error {
