...
func TaobaoItemsInventoryGet(clt *core.SDKClient, req *tbitem.TaobaoItemsInventoryGetAPIRequest, resp *tbitem.TaobaoItemsInventoryGetAPIResponse, session string) error {
