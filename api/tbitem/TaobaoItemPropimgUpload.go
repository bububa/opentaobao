...
func TaobaoItemPropimgUpload(clt *core.SDKClient, req *tbitem.TaobaoItemPropimgUploadAPIRequest, resp *tbitem.TaobaoItemPropimgUploadAPIResponse, session string) error {
