...
func TaobaoItemAdd(clt *core.SDKClient, req *tbitem.TaobaoItemAddAPIRequest, session string) (*tbitem.TaobaoItemAddAPIResponse, error) {
	var resp tbitem.TaobaoItemAddAPIResponse
