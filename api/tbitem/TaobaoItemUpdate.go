...
func TaobaoItemUpdate(clt *core.SDKClient, req *tbitem.TaobaoItemUpdateAPIRequest, session string) (*tbitem.TaobaoItemUpdateAPIResponse, error) {
	var resp tbitem.TaobaoItemUpdateAPIResponse
