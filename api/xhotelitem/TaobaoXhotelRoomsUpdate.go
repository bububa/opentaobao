...
*/
func TaobaoXhotelRoomsUpdate(clt *core.SDKClient, req *xhotelitem.TaobaoXhotelRoomsUpdateRequest, session string) (*xhotelitem.TaobaoXhotelRoomsUpdateAPIResponse, error) {
