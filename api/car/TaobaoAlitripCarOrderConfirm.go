...
*/
func TaobaoAlitripCarOrderConfirm(clt *core.SDKClient, req *car.TaobaoAlitripCarOrderConfirmRequest, session string) (*car.TaobaoAlitripCarOrderConfirmResponse, error) {
