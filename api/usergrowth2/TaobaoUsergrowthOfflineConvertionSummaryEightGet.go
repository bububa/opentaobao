...
*/
func TaobaoUsergrowthOfflineConvertionSummaryEightGet(clt *core.SDKClient, req *usergrowth2.TaobaoUsergrowthOfflineConvertionSummaryEightGetRequest, session string) (*usergrowth2.TaobaoUsergrowthOfflineConvertionSummaryEightGetAPIResponse, error) {
