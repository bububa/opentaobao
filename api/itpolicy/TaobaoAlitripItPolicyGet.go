...
*/
func TaobaoAlitripItPolicyGet(clt *core.SDKClient, req *itpolicy.TaobaoAlitripItPolicyGetRequest, session string) (*itpolicy.TaobaoAlitripItPolicyGetAPIResponse, error) {
