...
func TaobaoAlitripItPolicyGet(clt *core.SDKClient, req *itpolicy.TaobaoAlitripItPolicyGetAPIRequest, resp *itpolicy.TaobaoAlitripItPolicyGetAPIResponse, session string) error {
