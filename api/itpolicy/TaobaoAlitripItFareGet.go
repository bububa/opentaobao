...
*/
func TaobaoAlitripItFareGet(clt *core.SDKClient, req *itpolicy.TaobaoAlitripItFareGetRequest, session string) (*itpolicy.TaobaoAlitripItFareGetAPIResponse, error) {
