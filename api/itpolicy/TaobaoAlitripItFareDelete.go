...
*/
func TaobaoAlitripItFareDelete(clt *core.SDKClient, req *itpolicy.TaobaoAlitripItFareDeleteRequest, session string) (*itpolicy.TaobaoAlitripItFareDeleteAPIResponse, error) {
