...
*/
func TaobaoAlitripItFareUpdate(clt *core.SDKClient, req *itpolicy.TaobaoAlitripItFareUpdateRequest, session string) (*itpolicy.TaobaoAlitripItFareUpdateAPIResponse, error) {
