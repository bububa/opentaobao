...
*/
func TaobaoAlitripFlightchangeAdd(clt *core.SDKClient, req *flight.TaobaoAlitripFlightchangeAddRequest, session string) (*flight.TaobaoAlitripFlightchangeAddAPIResponse, error) {
