...
*/
func TaobaoTraderateExplainAdd(clt *core.SDKClient, req *traderate.TaobaoTraderateExplainAddRequest, session string) (*traderate.TaobaoTraderateExplainAddResponse, error) {
