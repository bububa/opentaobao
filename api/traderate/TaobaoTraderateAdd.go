...
func TaobaoTraderateAdd(clt *core.SDKClient, req *traderate.TaobaoTraderateAddAPIRequest, resp *traderate.TaobaoTraderateAddAPIResponse, session string) error {
