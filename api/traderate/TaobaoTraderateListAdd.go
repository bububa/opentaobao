...
func TaobaoTraderateListAdd(clt *core.SDKClient, req *traderate.TaobaoTraderateListAddAPIRequest, resp *traderate.TaobaoTraderateListAddAPIResponse, session string) error {
