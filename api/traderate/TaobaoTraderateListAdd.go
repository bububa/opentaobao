...
*/
func TaobaoTraderateListAdd(clt *core.SDKClient, req *traderate.TaobaoTraderateListAddRequest, session string) (*traderate.TaobaoTraderateListAddAPIResponse, error) {
