...
func TaobaoAreasGet(ctx context.Context, clt *core.SDKClient, req *tblogistics.TaobaoAreasGetAPIRequest, resp *tblogistics.TaobaoAreasGetAPIResponse, session string) error {
