...
func Taobaologisticsonlinesend(clt *core.SDKClient, req *tblogistics.TaobaologisticsonlinesendAPIRequest, session string) (*tblogistics.TaobaologisticsonlinesendAPIResponse, error) {
	var resp tblogistics.TaobaologisticsonlinesendAPIResponse
