...
func TaobaoLogisticsTraceSearch(ctx context.Context, clt *core.SDKClient, req *tblogistics.TaobaoLogisticsTraceSearchAPIRequest, resp *tblogistics.TaobaoLogisticsTraceSearchAPIResponse, session string) error {
