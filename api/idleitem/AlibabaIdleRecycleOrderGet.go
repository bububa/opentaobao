...
*/
func AlibabaIdleRecycleOrderGet(clt *core.SDKClient, req *idleitem.AlibabaIdleRecycleOrderGetRequest, session string) (*idleitem.AlibabaIdleRecycleOrderGetAPIResponse, error) {
