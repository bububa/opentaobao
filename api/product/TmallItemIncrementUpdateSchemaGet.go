...
*/
func TmallItemIncrementUpdateSchemaGet(clt *core.SDKClient, req *product.TmallItemIncrementUpdateSchemaGetRequest, session string) (*product.TmallItemIncrementUpdateSchemaGetAPIResponse, error) {
