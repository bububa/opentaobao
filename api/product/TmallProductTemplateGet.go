...
func TmallProductTemplateGet(ctx context.Context, clt *core.SDKClient, req *product.TmallProductTemplateGetAPIRequest, resp *product.TmallProductTemplateGetAPIResponse, session string) error {
