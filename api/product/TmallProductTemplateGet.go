...
*/
func TmallProductTemplateGet(clt *core.SDKClient, req *product.TmallProductTemplateGetRequest, session string) (*product.TmallProductTemplateGetResponse, error) {
