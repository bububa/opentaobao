...
*/
func TaobaoItemsInventoryGet(clt *core.SDKClient, req *product.TaobaoItemsInventoryGetRequest, session string) (*product.TaobaoItemsInventoryGetResponse, error) {
