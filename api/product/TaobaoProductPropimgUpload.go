...
*/
func TaobaoProductPropimgUpload(clt *core.SDKClient, req *product.TaobaoProductPropimgUploadRequest, session string) (*product.TaobaoProductPropimgUploadAPIResponse, error) {
