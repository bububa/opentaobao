...
func TaobaoProductPropimgUpload(clt *core.SDKClient, req *product.TaobaoProductPropimgUploadAPIRequest, resp *product.TaobaoProductPropimgUploadAPIResponse, session string) error {
