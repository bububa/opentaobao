...
func TaobaoProductPropimgUpload(ctx context.Context, clt *core.SDKClient, req *product.TaobaoProductPropimgUploadAPIRequest, resp *product.TaobaoProductPropimgUploadAPIResponse, session string) error {
