...
*/
func TaobaoItemPropimgUpload(clt *core.SDKClient, req *product.TaobaoItemPropimgUploadRequest, session string) (*product.TaobaoItemPropimgUploadResponse, error) {
