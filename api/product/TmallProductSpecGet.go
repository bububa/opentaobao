...
func TmallProductSpecGet(clt *core.SDKClient, req *product.TmallProductSpecGetAPIRequest, resp *product.TmallProductSpecGetAPIResponse, session string) error {
