...
*/
func TmallItemSizemappingTemplateCreate(clt *core.SDKClient, req *product.TmallItemSizemappingTemplateCreateRequest, session string) (*product.TmallItemSizemappingTemplateCreateResponse, error) {
