...
func TmallItemSizemappingTemplateCreate(ctx context.Context, clt *core.SDKClient, req *product.TmallItemSizemappingTemplateCreateAPIRequest, resp *product.TmallItemSizemappingTemplateCreateAPIResponse, session string) error {
