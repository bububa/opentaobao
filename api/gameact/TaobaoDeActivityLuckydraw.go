...
*/
func TaobaoDeActivityLuckydraw(clt *core.SDKClient, req *gameact.TaobaoDeActivityLuckydrawRequest, session string) (*gameact.TaobaoDeActivityLuckydrawAPIResponse, error) {
