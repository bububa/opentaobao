...
*/
func TaobaoOpensecurityIsvUidGet(clt *core.SDKClient, req *user.TaobaoOpensecurityIsvUidGetRequest, session string) (*user.TaobaoOpensecurityIsvUidGetResponse, error) {
