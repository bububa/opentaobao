...
// TaobaoMixnickChange 新旧mixnick互转
...
func TaobaoMixnickChange(clt *core.SDKClient, req *user.TaobaoMixnickChangeAPIRequest, session string) (*user.TaobaoMixnickChangeAPIResponse, error) {
