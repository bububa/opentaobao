...
*/
func TaobaoQimenOrderprocessReport(clt *core.SDKClient, req *qimen.TaobaoQimenOrderprocessReportRequest, session string) (*qimen.TaobaoQimenOrderprocessReportAPIResponse, error) {
