...
*/
func TaobaoSellercenterSubuserPermissionsRolesGet(clt *core.SDKClient, req *subuser.TaobaoSellercenterSubuserPermissionsRolesGetRequest, session string) (*subuser.TaobaoSellercenterSubuserPermissionsRolesGetResponse, error) {
