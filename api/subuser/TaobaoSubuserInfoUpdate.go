...
*/
func TaobaoSubuserInfoUpdate(clt *core.SDKClient, req *subuser.TaobaoSubuserInfoUpdateRequest, session string) (*subuser.TaobaoSubuserInfoUpdateAPIResponse, error) {
