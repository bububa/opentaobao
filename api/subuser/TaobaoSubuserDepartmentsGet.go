...
*/
func TaobaoSubuserDepartmentsGet(clt *core.SDKClient, req *subuser.TaobaoSubuserDepartmentsGetRequest, session string) (*subuser.TaobaoSubuserDepartmentsGetAPIResponse, error) {
