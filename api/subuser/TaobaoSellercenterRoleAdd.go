...
func TaobaoSellercenterRoleAdd(clt *core.SDKClient, req *subuser.TaobaoSellercenterRoleAddAPIRequest, resp *subuser.TaobaoSellercenterRoleAddAPIResponse, session string) error {
