...
*/
func TaobaoSellercenterRoleAdd(clt *core.SDKClient, req *subuser.TaobaoSellercenterRoleAddRequest, session string) (*subuser.TaobaoSellercenterRoleAddResponse, error) {
