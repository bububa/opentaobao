...
func TaobaoSellercenterRoleAdd(clt *core.SDKClient, req *subuser.TaobaoSellercenterRoleAddAPIRequest, session string) (*subuser.TaobaoSellercenterRoleAddAPIResponse, error) {
