...
*/
func TaobaoSellercenterUserPermissionsGet(clt *core.SDKClient, req *subuser.TaobaoSellercenterUserPermissionsGetRequest, session string) (*subuser.TaobaoSellercenterUserPermissionsGetAPIResponse, error) {
