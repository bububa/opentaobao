...
*/
func TmallTraceplatformCcicTracecodeCheck(clt *core.SDKClient, req *tmallhk.TmallTraceplatformCcicTracecodeCheckRequest, session string) (*tmallhk.TmallTraceplatformCcicTracecodeCheckResponse, error) {
