...
*/
func TaobaoElifeLifecardConsume(clt *core.SDKClient, req *elife.TaobaoElifeLifecardConsumeRequest, session string) (*elife.TaobaoElifeLifecardConsumeResponse, error) {
