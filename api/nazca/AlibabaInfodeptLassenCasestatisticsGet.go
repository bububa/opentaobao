...
*/
func AlibabaInfodeptLassenCasestatisticsGet(clt *core.SDKClient, req *nazca.AlibabaInfodeptLassenCasestatisticsGetRequest, session string) (*nazca.AlibabaInfodeptLassenCasestatisticsGetResponse, error) {
