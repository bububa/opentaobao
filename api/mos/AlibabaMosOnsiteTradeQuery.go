...
func AlibabaMosOnsiteTradeQuery(clt *core.SDKClient, req *mos.AlibabaMosOnsiteTradeQueryAPIRequest, resp *mos.AlibabaMosOnsiteTradeQueryAPIResponse, session string) error {
