...
*/
func AlibabaMosOnsiteTradeQuery(clt *core.SDKClient, req *mos.AlibabaMosOnsiteTradeQueryRequest, session string) (*mos.AlibabaMosOnsiteTradeQueryAPIResponse, error) {
