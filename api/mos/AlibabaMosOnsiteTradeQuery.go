...
*/
func AlibabaMosOnsiteTradeQuery(clt *core.SDKClient, req *mos.AlibabaMosOnsiteTradeQueryRequest, session string) (*mos.AlibabaMosOnsiteTradeQueryResponse, error) {
