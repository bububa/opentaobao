...
2. 只支持全额退款。
*/
func AlibabaMosOnsiteTradeRefund(clt *core.SDKClient, req *mos.AlibabaMosOnsiteTradeRefundRequest, session string) (*mos.AlibabaMosOnsiteTradeRefundResponse, error) {
