...
func TaobaoOmniitemItemFullupdate(clt *core.SDKClient, req *omniorder.TaobaoOmniitemItemFullupdateAPIRequest, resp *omniorder.TaobaoOmniitemItemFullupdateAPIResponse, session string) error {
