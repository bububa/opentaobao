...
*/
func TaobaoOmniitemItemFullupdate(clt *core.SDKClient, req *omniorder.TaobaoOmniitemItemFullupdateRequest, session string) (*omniorder.TaobaoOmniitemItemFullupdateAPIResponse, error) {
