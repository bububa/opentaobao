...
func TaobaoOmniitemItemFullupdate(ctx context.Context, clt *core.SDKClient, req *omniorder.TaobaoOmniitemItemFullupdateAPIRequest, resp *omniorder.TaobaoOmniitemItemFullupdateAPIResponse, session string) error {
