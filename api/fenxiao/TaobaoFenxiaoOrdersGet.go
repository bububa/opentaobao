...
func TaobaoFenxiaoOrdersGet(clt *core.SDKClient, req *fenxiao.TaobaoFenxiaoOrdersGetAPIRequest, session string) (*fenxiao.TaobaoFenxiaoOrdersGetAPIResponse, error) {
