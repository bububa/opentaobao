...
func TaobaoFenxiaoOrdersGet(ctx context.Context, clt *core.SDKClient, req *fenxiao.TaobaoFenxiaoOrdersGetAPIRequest, resp *fenxiao.TaobaoFenxiaoOrdersGetAPIResponse, session string) error {
