...
*/
func TaobaoFenxiaoOrdersGet(clt *core.SDKClient, req *fenxiao.TaobaoFenxiaoOrdersGetRequest, session string) (*fenxiao.TaobaoFenxiaoOrdersGetAPIResponse, error) {
