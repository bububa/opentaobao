...
*/
func TaobaoFenxiaoProductUpdate(clt *core.SDKClient, req *fenxiao.TaobaoFenxiaoProductUpdateRequest, session string) (*fenxiao.TaobaoFenxiaoProductUpdateResponse, error) {
