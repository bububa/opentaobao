...
func TaobaoFenxiaoProductsGet(ctx context.Context, clt *core.SDKClient, req *fenxiao.TaobaoFenxiaoProductsGetAPIRequest, resp *fenxiao.TaobaoFenxiaoProductsGetAPIResponse, session string) error {
