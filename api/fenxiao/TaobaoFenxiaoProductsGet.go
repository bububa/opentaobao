...
func TaobaoFenxiaoProductsGet(clt *core.SDKClient, req *fenxiao.TaobaoFenxiaoProductsGetAPIRequest, resp *fenxiao.TaobaoFenxiaoProductsGetAPIResponse, session string) error {
