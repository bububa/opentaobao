...
*/
func TaobaoFenxiaoProductsGet(clt *core.SDKClient, req *fenxiao.TaobaoFenxiaoProductsGetRequest, session string) (*fenxiao.TaobaoFenxiaoProductsGetResponse, error) {
