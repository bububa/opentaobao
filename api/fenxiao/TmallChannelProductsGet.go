...
*/
func TmallChannelProductsGet(clt *core.SDKClient, req *fenxiao.TmallChannelProductsGetRequest, session string) (*fenxiao.TmallChannelProductsGetResponse, error) {
