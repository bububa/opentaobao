...
*/
func AliyunViapiGoodstechRecognizeFurnitureAttribute(clt *core.SDKClient, req *viapi.AliyunViapiGoodstechRecognizeFurnitureAttributeRequest, session string) (*viapi.AliyunViapiGoodstechRecognizeFurnitureAttributeAPIResponse, error) {
