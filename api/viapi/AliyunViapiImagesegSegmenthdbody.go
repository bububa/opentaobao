...
*/
func AliyunViapiImagesegSegmenthdbody(clt *core.SDKClient, req *viapi.AliyunViapiImagesegSegmenthdbodyRequest, session string) (*viapi.AliyunViapiImagesegSegmenthdbodyAPIResponse, error) {
