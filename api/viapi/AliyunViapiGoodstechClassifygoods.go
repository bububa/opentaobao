...
func AliyunViapiGoodstechClassifygoods(ctx context.Context, clt *core.SDKClient, req *viapi.AliyunViapiGoodstechClassifygoodsAPIRequest, resp *viapi.AliyunViapiGoodstechClassifygoodsAPIResponse, session string) error {
