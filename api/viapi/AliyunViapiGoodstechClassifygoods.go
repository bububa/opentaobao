...
*/
func AliyunViapiGoodstechClassifygoods(clt *core.SDKClient, req *viapi.AliyunViapiGoodstechClassifygoodsRequest, session string) (*viapi.AliyunViapiGoodstechClassifygoodsAPIResponse, error) {
