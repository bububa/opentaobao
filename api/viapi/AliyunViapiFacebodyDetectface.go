...
*/
func AliyunViapiFacebodyDetectface(clt *core.SDKClient, req *viapi.AliyunViapiFacebodyDetectfaceRequest, session string) (*viapi.AliyunViapiFacebodyDetectfaceAPIResponse, error) {
