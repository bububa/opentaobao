...
func AliyunViapiImageauditScantext(ctx context.Context, clt *core.SDKClient, req *viapi.AliyunViapiImageauditScantextAPIRequest, resp *viapi.AliyunViapiImageauditScantextAPIResponse, session string) error {
