...
*/
func AliyunViapiImageauditScantext(clt *core.SDKClient, req *viapi.AliyunViapiImageauditScantextRequest, session string) (*viapi.AliyunViapiImageauditScantextAPIResponse, error) {
