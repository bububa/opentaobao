...
*/
func AliyunViapiFacebodyCompareface(clt *core.SDKClient, req *viapi.AliyunViapiFacebodyComparefaceRequest, session string) (*viapi.AliyunViapiFacebodyComparefaceAPIResponse, error) {
