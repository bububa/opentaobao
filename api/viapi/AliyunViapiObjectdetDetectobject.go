...
// AliyunViapiObjectdetDetectobject 物体检测
...
func AliyunViapiObjectdetDetectobject(clt *core.SDKClient, req *viapi.AliyunViapiObjectdetDetectobjectAPIRequest, session string) (*viapi.AliyunViapiObjectdetDetectobjectAPIResponse, error) {
	var resp viapi.AliyunViapiObjectdetDetectobjectAPIResponse
