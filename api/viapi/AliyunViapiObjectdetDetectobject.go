...
*/
func AliyunViapiObjectdetDetectobject(clt *core.SDKClient, req *viapi.AliyunViapiObjectdetDetectobjectRequest, session string) (*viapi.AliyunViapiObjectdetDetectobjectAPIResponse, error) {
