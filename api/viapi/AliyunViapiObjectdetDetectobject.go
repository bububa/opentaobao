...
func AliyunViapiObjectdetDetectobject(clt *core.SDKClient, req *viapi.AliyunViapiObjectdetDetectobjectAPIRequest, resp *viapi.AliyunViapiObjectdetDetectobjectAPIResponse, session string) error {
