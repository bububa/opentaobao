...
*/
func AliyunViapiImagesegSegmenthead(clt *core.SDKClient, req *viapi.AliyunViapiImagesegSegmentheadRequest, session string) (*viapi.AliyunViapiImagesegSegmentheadAPIResponse, error) {
