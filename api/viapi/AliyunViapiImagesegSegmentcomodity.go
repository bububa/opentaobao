...
*/
func AliyunViapiImagesegSegmentcomodity(clt *core.SDKClient, req *viapi.AliyunViapiImagesegSegmentcomodityRequest, session string) (*viapi.AliyunViapiImagesegSegmentcomodityAPIResponse, error) {
