...
func AliyunViapiImagesegSegmentcomodity(ctx context.Context, clt *core.SDKClient, req *viapi.AliyunViapiImagesegSegmentcomodityAPIRequest, resp *viapi.AliyunViapiImagesegSegmentcomodityAPIResponse, session string) error {
