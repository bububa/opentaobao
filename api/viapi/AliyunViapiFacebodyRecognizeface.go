...
/* AliyunViapiFacebodyRecognizeface
人脸属性识别
...
func AliyunViapiFacebodyRecognizeface(clt *core.SDKClient, req *viapi.AliyunViapiFacebodyRecognizefaceAPIRequest, session string) (*viapi.AliyunViapiFacebodyRecognizefaceAPIResponse, error) {
