...
*/
func AliyunViapiImagesegSegmentCommonimage(clt *core.SDKClient, req *viapi.AliyunViapiImagesegSegmentCommonimageRequest, session string) (*viapi.AliyunViapiImagesegSegmentCommonimageAPIResponse, error) {
