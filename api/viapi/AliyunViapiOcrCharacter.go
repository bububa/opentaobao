...
func AliyunViapiOcrCharacter(clt *core.SDKClient, req *viapi.AliyunViapiOcrCharacterAPIRequest, resp *viapi.AliyunViapiOcrCharacterAPIResponse, session string) error {
