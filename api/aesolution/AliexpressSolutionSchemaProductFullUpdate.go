...
*/
func AliexpressSolutionSchemaProductFullUpdate(clt *core.SDKClient, req *aesolution.AliexpressSolutionSchemaProductFullUpdateRequest, session string) (*aesolution.AliexpressSolutionSchemaProductFullUpdateAPIResponse, error) {
