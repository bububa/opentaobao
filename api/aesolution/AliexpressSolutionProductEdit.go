...
*/
func AliexpressSolutionProductEdit(clt *core.SDKClient, req *aesolution.AliexpressSolutionProductEditRequest, session string) (*aesolution.AliexpressSolutionProductEditAPIResponse, error) {
