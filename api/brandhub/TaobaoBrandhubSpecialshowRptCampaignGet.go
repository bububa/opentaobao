...
*/
func TaobaoBrandhubSpecialshowRptCampaignGet(clt *core.SDKClient, req *brandhub.TaobaoBrandhubSpecialshowRptCampaignGetRequest, session string) (*brandhub.TaobaoBrandhubSpecialshowRptCampaignGetAPIResponse, error) {
