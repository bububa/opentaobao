...
*/
func TaobaoBrandStartshopRptCreativeGet(clt *core.SDKClient, req *brandhub.TaobaoBrandStartshopRptCreativeGetRequest, session string) (*brandhub.TaobaoBrandStartshopRptCreativeGetAPIResponse, error) {
