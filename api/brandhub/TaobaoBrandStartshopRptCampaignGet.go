...
*/
func TaobaoBrandStartshopRptCampaignGet(clt *core.SDKClient, req *brandhub.TaobaoBrandStartshopRptCampaignGetRequest, session string) (*brandhub.TaobaoBrandStartshopRptCampaignGetAPIResponse, error) {
