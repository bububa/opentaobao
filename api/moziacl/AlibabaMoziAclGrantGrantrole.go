...
*/
func AlibabaMoziAclGrantGrantrole(clt *core.SDKClient, req *moziacl.AlibabaMoziAclGrantGrantroleRequest, session string) (*moziacl.AlibabaMoziAclGrantGrantroleAPIResponse, error) {
