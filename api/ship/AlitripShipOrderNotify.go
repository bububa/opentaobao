...
func AlitripShipOrderNotify(clt *core.SDKClient, req *ship.AlitripShipOrderNotifyAPIRequest, session string) (*ship.AlitripShipOrderNotifyAPIResponse, error) {
	var resp ship.AlitripShipOrderNotifyAPIResponse
