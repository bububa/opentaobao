...
func AlitripShipOrderNotify(ctx context.Context, clt *core.SDKClient, req *ship.AlitripShipOrderNotifyAPIRequest, resp *ship.AlitripShipOrderNotifyAPIResponse, session string) error {
