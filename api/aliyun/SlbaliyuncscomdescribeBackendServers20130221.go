...
func SlbAliyuncsComDescribeBackendServers20130221(ctx context.Context, clt *core.SDKClient, req *aliyun.SlbAliyuncsComDescribeBackendServers20130221APIRequest, resp *aliyun.SlbAliyuncsComDescribeBackendServers20130221APIResponse, session string) error {
