...
*/
func AlibabaAliqinFcSmsNumSend(clt *core.SDKClient, req *aliqin.AlibabaAliqinFcSmsNumSendRequest, session string) (*aliqin.AlibabaAliqinFcSmsNumSendAPIResponse, error) {
