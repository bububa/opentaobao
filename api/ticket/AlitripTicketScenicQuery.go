...
*/
func AlitripTicketScenicQuery(clt *core.SDKClient, req *ticket.AlitripTicketScenicQueryRequest, session string) (*ticket.AlitripTicketScenicQueryAPIResponse, error) {
