...
*/
func AlitripTicketSkusUpload(clt *core.SDKClient, req *ticket.AlitripTicketSkusUploadRequest, session string) (*ticket.AlitripTicketSkusUploadAPIResponse, error) {
