...
func AlitripTicketSkusUpload(ctx context.Context, clt *core.SDKClient, req *ticket.AlitripTicketSkusUploadAPIRequest, resp *ticket.AlitripTicketSkusUploadAPIResponse, session string) error {
