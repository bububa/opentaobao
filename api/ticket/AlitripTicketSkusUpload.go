...
// AlitripTicketSkusUpload 【门票API2.0】门票价格库存同步接口
...
func AlitripTicketSkusUpload(clt *core.SDKClient, req *ticket.AlitripTicketSkusUploadAPIRequest, session string) (*ticket.AlitripTicketSkusUploadAPIResponse, error) {
	var resp ticket.AlitripTicketSkusUploadAPIResponse
