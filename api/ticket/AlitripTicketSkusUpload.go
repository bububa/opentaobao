...
func AlitripTicketSkusUpload(clt *core.SDKClient, req *ticket.AlitripTicketSkusUploadAPIRequest, resp *ticket.AlitripTicketSkusUploadAPIResponse, session string) error {
