...
*/
func AlitripTicketProductUpload(clt *core.SDKClient, req *ticket.AlitripTicketProductUploadRequest, session string) (*ticket.AlitripTicketProductUploadAPIResponse, error) {
