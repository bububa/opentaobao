...
// AlitripTicketSkusBatchUpload 【门票API2.0】门票价格库存同步接口（多票种批量更新）
...
func AlitripTicketSkusBatchUpload(ctx context.Context, clt *core.SDKClient, req *ticket.AlitripTicketSkusBatchUploadAPIRequest, resp *ticket.AlitripTicketSkusBatchUploadAPIResponse, session string) error {
