...
*/
func AlitripTicketSkusBatchUpload(clt *core.SDKClient, req *ticket.AlitripTicketSkusBatchUploadRequest, session string) (*ticket.AlitripTicketSkusBatchUploadAPIResponse, error) {
