...
func AlitripTicketSkusBatchUpload(clt *core.SDKClient, req *ticket.AlitripTicketSkusBatchUploadAPIRequest, resp *ticket.AlitripTicketSkusBatchUploadAPIResponse, session string) error {
