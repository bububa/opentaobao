...
func AlitripTicketRuleUpload(ctx context.Context, clt *core.SDKClient, req *ticket.AlitripTicketRuleUploadAPIRequest, resp *ticket.AlitripTicketRuleUploadAPIResponse, session string) error {
