...
*/
func AlitripTicketRuleUpload(clt *core.SDKClient, req *ticket.AlitripTicketRuleUploadRequest, session string) (*ticket.AlitripTicketRuleUploadAPIResponse, error) {
