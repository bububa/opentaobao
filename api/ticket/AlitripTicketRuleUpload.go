...
func AlitripTicketRuleUpload(clt *core.SDKClient, req *ticket.AlitripTicketRuleUploadAPIRequest, session string) (*ticket.AlitripTicketRuleUploadAPIResponse, error) {
	var resp ticket.AlitripTicketRuleUploadAPIResponse
