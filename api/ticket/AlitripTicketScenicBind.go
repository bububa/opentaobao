...
*/
func AlitripTicketScenicBind(clt *core.SDKClient, req *ticket.AlitripTicketScenicBindRequest, session string) (*ticket.AlitripTicketScenicBindAPIResponse, error) {
