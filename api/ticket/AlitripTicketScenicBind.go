...
func AlitripTicketScenicBind(clt *core.SDKClient, req *ticket.AlitripTicketScenicBindAPIRequest, resp *ticket.AlitripTicketScenicBindAPIResponse, session string) error {
