...
*/
func AlibabaWdkCouponTemplateQueryumpactid(clt *core.SDKClient, req *wdk.AlibabaWdkCouponTemplateQueryumpactidRequest, session string) (*wdk.AlibabaWdkCouponTemplateQueryumpactidAPIResponse, error) {
