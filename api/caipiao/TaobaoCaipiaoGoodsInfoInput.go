...
*/
func TaobaoCaipiaoGoodsInfoInput(clt *core.SDKClient, req *caipiao.TaobaoCaipiaoGoodsInfoInputRequest, session string) (*caipiao.TaobaoCaipiaoGoodsInfoInputResponse, error) {
