...
func TaobaoCaipiaoGoodsInfoInput(clt *core.SDKClient, req *caipiao.TaobaoCaipiaoGoodsInfoInputAPIRequest, resp *caipiao.TaobaoCaipiaoGoodsInfoInputAPIResponse, session string) error {
