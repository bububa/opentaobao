...
*/
func TaobaoCaipiaoShopInfoInput(clt *core.SDKClient, req *caipiao.TaobaoCaipiaoShopInfoInputRequest, session string) (*caipiao.TaobaoCaipiaoShopInfoInputResponse, error) {
