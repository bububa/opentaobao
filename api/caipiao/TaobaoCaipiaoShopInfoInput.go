...
func TaobaoCaipiaoShopInfoInput(clt *core.SDKClient, req *caipiao.TaobaoCaipiaoShopInfoInputAPIRequest, resp *caipiao.TaobaoCaipiaoShopInfoInputAPIResponse, session string) error {
