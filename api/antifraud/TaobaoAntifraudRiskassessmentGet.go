...
/* TaobaoAntifraudRiskassessmentGet
反欺诈风险识别
...
func TaobaoAntifraudRiskassessmentGet(clt *core.SDKClient, req *antifraud.TaobaoAntifraudRiskassessmentGetAPIRequest, session string) (*antifraud.TaobaoAntifraudRiskassessmentGetAPIResponse, error) {
