...
*/
func TaobaoAntifraudRiskassessmentGet(clt *core.SDKClient, req *antifraud.TaobaoAntifraudRiskassessmentGetRequest, session string) (*antifraud.TaobaoAntifraudRiskassessmentGetResponse, error) {
