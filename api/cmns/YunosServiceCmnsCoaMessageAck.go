...
*/
func YunosServiceCmnsCoaMessageAck(clt *core.SDKClient, req *cmns.YunosServiceCmnsCoaMessageAckRequest, session string) (*cmns.YunosServiceCmnsCoaMessageAckAPIResponse, error) {
