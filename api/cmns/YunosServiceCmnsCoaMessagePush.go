...
*/
func YunosServiceCmnsCoaMessagePush(clt *core.SDKClient, req *cmns.YunosServiceCmnsCoaMessagePushRequest, session string) (*cmns.YunosServiceCmnsCoaMessagePushResponse, error) {
