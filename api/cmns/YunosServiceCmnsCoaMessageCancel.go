...
*/
func YunosServiceCmnsCoaMessageCancel(clt *core.SDKClient, req *cmns.YunosServiceCmnsCoaMessageCancelRequest, session string) (*cmns.YunosServiceCmnsCoaMessageCancelResponse, error) {
