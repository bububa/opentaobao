...
*/
func TaobaoCrmMembersGroupsBatchdelete(clt *core.SDKClient, req *crm.TaobaoCrmMembersGroupsBatchdeleteRequest, session string) (*crm.TaobaoCrmMembersGroupsBatchdeleteResponse, error) {
