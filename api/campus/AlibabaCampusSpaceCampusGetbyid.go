...
*/
func AlibabaCampusSpaceCampusGetbyid(clt *core.SDKClient, req *campus.AlibabaCampusSpaceCampusGetbyidRequest, session string) (*campus.AlibabaCampusSpaceCampusGetbyidAPIResponse, error) {
