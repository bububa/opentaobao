...
*/
func TaobaoWlbCrossborderWaybillGet(clt *core.SDKClient, req *wlbimports.TaobaoWlbCrossborderWaybillGetRequest, session string) (*wlbimports.TaobaoWlbCrossborderWaybillGetResponse, error) {
