...
*/
func TaobaoSimbaInsightCatstopwordnewGet(clt *core.SDKClient, req *simba.TaobaoSimbaInsightCatstopwordnewGetRequest, session string) (*simba.TaobaoSimbaInsightCatstopwordnewGetAPIResponse, error) {
