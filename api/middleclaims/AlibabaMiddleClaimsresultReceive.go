...
*/
func AlibabaMiddleClaimsresultReceive(clt *core.SDKClient, req *middleclaims.AlibabaMiddleClaimsresultReceiveRequest, session string) (*middleclaims.AlibabaMiddleClaimsresultReceiveAPIResponse, error) {
