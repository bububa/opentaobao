...
*/
func TaobaoLogisticsOnlineSend(clt *core.SDKClient, req *logistic.TaobaoLogisticsOnlineSendRequest, session string) (*logistic.TaobaoLogisticsOnlineSendResponse, error) {
