...
*/
func TaobaoLogisticsOrderCreate(clt *core.SDKClient, req *logistic.TaobaoLogisticsOrderCreateRequest, session string) (*logistic.TaobaoLogisticsOrderCreateResponse, error) {
