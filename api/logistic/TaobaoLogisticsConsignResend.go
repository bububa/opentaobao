...
func TaobaoLogisticsConsignResend(clt *core.SDKClient, req *logistic.TaobaoLogisticsConsignResendAPIRequest, session string) (*logistic.TaobaoLogisticsConsignResendAPIResponse, error) {
