...
*/
func TaobaoLogisticsConsignResend(clt *core.SDKClient, req *logistic.TaobaoLogisticsConsignResendRequest, session string) (*logistic.TaobaoLogisticsConsignResendResponse, error) {
