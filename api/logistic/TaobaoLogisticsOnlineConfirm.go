...
*/
func TaobaoLogisticsOnlineConfirm(clt *core.SDKClient, req *logistic.TaobaoLogisticsOnlineConfirmRequest, session string) (*logistic.TaobaoLogisticsOnlineConfirmResponse, error) {
