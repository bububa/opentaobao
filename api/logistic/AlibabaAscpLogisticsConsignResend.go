...
*/
func AlibabaAscpLogisticsConsignResend(clt *core.SDKClient, req *logistic.AlibabaAscpLogisticsConsignResendRequest, session string) (*logistic.AlibabaAscpLogisticsConsignResendResponse, error) {
