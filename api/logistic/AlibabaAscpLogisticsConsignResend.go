...
/* AlibabaAscpLogisticsConsignResend
修改物流公司和运单号
...
func AlibabaAscpLogisticsConsignResend(clt *core.SDKClient, req *logistic.AlibabaAscpLogisticsConsignResendAPIRequest, session string) (*logistic.AlibabaAscpLogisticsConsignResendAPIResponse, error) {
