...
func TaobaoLogisticsTraceSearch(clt *core.SDKClient, req *logistic.TaobaoLogisticsTraceSearchAPIRequest, session string) (*logistic.TaobaoLogisticsTraceSearchAPIResponse, error) {
