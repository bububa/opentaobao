...
*/
func AlibabaAlifanyiMarketExam(clt *core.SDKClient, req *seaking.AlibabaAlifanyiMarketExamRequest, session string) (*seaking.AlibabaAlifanyiMarketExamAPIResponse, error) {
