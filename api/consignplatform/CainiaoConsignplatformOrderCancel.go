...
*/
func CainiaoConsignplatformOrderCancel(clt *core.SDKClient, req *consignplatform.CainiaoConsignplatformOrderCancelRequest, session string) (*consignplatform.CainiaoConsignplatformOrderCancelAPIResponse, error) {
