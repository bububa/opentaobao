...
*/
func AlibabaItEslEslimageSendimage(clt *core.SDKClient, req *ioti.AlibabaItEslEslimageSendimageRequest, session string) (*ioti.AlibabaItEslEslimageSendimageAPIResponse, error) {
