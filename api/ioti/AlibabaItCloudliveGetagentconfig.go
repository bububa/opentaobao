...
*/
func AlibabaItCloudliveGetagentconfig(clt *core.SDKClient, req *ioti.AlibabaItCloudliveGetagentconfigRequest, session string) (*ioti.AlibabaItCloudliveGetagentconfigAPIResponse, error) {
