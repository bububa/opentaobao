...
*/
func AlibabaEinvoiceCoreInvUpload(clt *core.SDKClient, req *einvoice.AlibabaEinvoiceCoreInvUploadRequest, session string) (*einvoice.AlibabaEinvoiceCoreInvUploadAPIResponse, error) {
