...
*/
func AlibabaEinvoiceMerchantBindcompany(clt *core.SDKClient, req *einvoice.AlibabaEinvoiceMerchantBindcompanyRequest, session string) (*einvoice.AlibabaEinvoiceMerchantBindcompanyAPIResponse, error) {
