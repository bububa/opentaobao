...
func AlibabaEinvoiceFlowTaxGet(clt *core.SDKClient, req *einvoice.AlibabaEinvoiceFlowTaxGetAPIRequest, resp *einvoice.AlibabaEinvoiceFlowTaxGetAPIResponse, session string) error {
