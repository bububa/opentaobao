...
*/
func AlibabaEinvoiceFlowTaxGet(clt *core.SDKClient, req *einvoice.AlibabaEinvoiceFlowTaxGetRequest, session string) (*einvoice.AlibabaEinvoiceFlowTaxGetAPIResponse, error) {
