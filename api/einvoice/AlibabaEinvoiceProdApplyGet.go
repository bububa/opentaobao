...
*/
func AlibabaEinvoiceProdApplyGet(clt *core.SDKClient, req *einvoice.AlibabaEinvoiceProdApplyGetRequest, session string) (*einvoice.AlibabaEinvoiceProdApplyGetAPIResponse, error) {
