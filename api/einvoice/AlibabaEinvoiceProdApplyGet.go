...
func AlibabaEinvoiceProdApplyGet(clt *core.SDKClient, req *einvoice.AlibabaEinvoiceProdApplyGetAPIRequest, resp *einvoice.AlibabaEinvoiceProdApplyGetAPIResponse, session string) error {
