...
*/
func AlibabaEinvoiceFlowTaxCreate(clt *core.SDKClient, req *einvoice.AlibabaEinvoiceFlowTaxCreateRequest, session string) (*einvoice.AlibabaEinvoiceFlowTaxCreateAPIResponse, error) {
