...
func TaobaoOnebpDkxCreativeCreativeReportOffline(ctx context.Context, clt *core.SDKClient, req *scs.TaobaoOnebpDkxCreativeCreativeReportOfflineAPIRequest, resp *scs.TaobaoOnebpDkxCreativeCreativeReportOfflineAPIResponse, session string) error {
