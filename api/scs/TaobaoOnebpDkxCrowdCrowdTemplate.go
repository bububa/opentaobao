...
func TaobaoOnebpDkxCrowdCrowdTemplate(ctx context.Context, clt *core.SDKClient, req *scs.TaobaoOnebpDkxCrowdCrowdTemplateAPIRequest, resp *scs.TaobaoOnebpDkxCrowdCrowdTemplateAPIResponse, session string) error {
