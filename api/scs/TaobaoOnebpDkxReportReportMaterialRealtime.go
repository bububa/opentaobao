...
func TaobaoOnebpDkxReportReportMaterialRealtime(clt *core.SDKClient, req *scs.TaobaoOnebpDkxReportReportMaterialRealtimeAPIRequest, resp *scs.TaobaoOnebpDkxReportReportMaterialRealtimeAPIResponse, session string) error {
