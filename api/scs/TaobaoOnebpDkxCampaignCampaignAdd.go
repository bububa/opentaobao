...
func TaobaoOnebpDkxCampaignCampaignAdd(ctx context.Context, clt *core.SDKClient, req *scs.TaobaoOnebpDkxCampaignCampaignAddAPIRequest, resp *scs.TaobaoOnebpDkxCampaignCampaignAddAPIResponse, session string) error {
