...
func TaobaoOnebpDkxReportReportCampaignOffline(ctx context.Context, clt *core.SDKClient, req *scs.TaobaoOnebpDkxReportReportCampaignOfflineAPIRequest, resp *scs.TaobaoOnebpDkxReportReportCampaignOfflineAPIResponse, session string) error {
