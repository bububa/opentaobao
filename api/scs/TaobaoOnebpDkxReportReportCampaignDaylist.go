...
func TaobaoOnebpDkxReportReportCampaignDaylist(ctx context.Context, clt *core.SDKClient, req *scs.TaobaoOnebpDkxReportReportCampaignDaylistAPIRequest, resp *scs.TaobaoOnebpDkxReportReportCampaignDaylistAPIResponse, session string) error {
