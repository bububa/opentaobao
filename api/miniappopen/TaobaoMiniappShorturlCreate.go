...
func TaobaoMiniappShorturlCreate(clt *core.SDKClient, req *miniappopen.TaobaoMiniappShorturlCreateAPIRequest, resp *miniappopen.TaobaoMiniappShorturlCreateAPIResponse, session string) error {
