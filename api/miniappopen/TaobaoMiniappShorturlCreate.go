...
func TaobaoMiniappShorturlCreate(clt *core.SDKClient, req *miniappopen.TaobaoMiniappShorturlCreateAPIRequest, session string) (*miniappopen.TaobaoMiniappShorturlCreateAPIResponse, error) {
