...
*/
func TaobaoMiniappDistributionOrderItemsAllBind(clt *core.SDKClient, req *miniappopen.TaobaoMiniappDistributionOrderItemsAllBindRequest, session string) (*miniappopen.TaobaoMiniappDistributionOrderItemsAllBindAPIResponse, error) {
