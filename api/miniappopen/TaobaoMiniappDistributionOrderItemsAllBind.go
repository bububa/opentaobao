...
func TaobaoMiniappDistributionOrderItemsAllBind(ctx context.Context, clt *core.SDKClient, req *miniappopen.TaobaoMiniappDistributionOrderItemsAllBindAPIRequest, resp *miniappopen.TaobaoMiniappDistributionOrderItemsAllBindAPIResponse, session string) error {
