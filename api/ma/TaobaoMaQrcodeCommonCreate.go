...
*/
func TaobaoMaQrcodeCommonCreate(clt *core.SDKClient, req *ma.TaobaoMaQrcodeCommonCreateRequest, session string) (*ma.TaobaoMaQrcodeCommonCreateResponse, error) {
