...
*/
func AlibabaInteractUserIslogin(clt *core.SDKClient, req *interact.AlibabaInteractUserIsloginRequest, session string) (*interact.AlibabaInteractUserIsloginAPIResponse, error) {
