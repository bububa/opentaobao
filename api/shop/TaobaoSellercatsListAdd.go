...
func TaobaoSellercatsListAdd(clt *core.SDKClient, req *shop.TaobaoSellercatsListAddAPIRequest, resp *shop.TaobaoSellercatsListAddAPIResponse, session string) error {
