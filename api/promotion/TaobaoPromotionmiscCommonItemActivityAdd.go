...
/* TaobaoPromotionmiscCommonItemActivityAdd
创建通用单品优惠活动
...
func TaobaoPromotionmiscCommonItemActivityAdd(clt *core.SDKClient, req *promotion.TaobaoPromotionmiscCommonItemActivityAddAPIRequest, session string) (*promotion.TaobaoPromotionmiscCommonItemActivityAddAPIResponse, error) {
