...
*/
func TaobaoPromotionmiscCommonItemActivityAdd(clt *core.SDKClient, req *promotion.TaobaoPromotionmiscCommonItemActivityAddRequest, session string) (*promotion.TaobaoPromotionmiscCommonItemActivityAddResponse, error) {
