...
*/
func TaobaoPromotionActivityGet(clt *core.SDKClient, req *promotion.TaobaoPromotionActivityGetRequest, session string) (*promotion.TaobaoPromotionActivityGetAPIResponse, error) {
