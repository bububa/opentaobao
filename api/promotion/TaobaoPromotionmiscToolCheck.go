...
func TaobaoPromotionmiscToolCheck(clt *core.SDKClient, req *promotion.TaobaoPromotionmiscToolCheckAPIRequest, resp *promotion.TaobaoPromotionmiscToolCheckAPIResponse, session string) error {
