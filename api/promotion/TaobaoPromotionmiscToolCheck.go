...
*/
func TaobaoPromotionmiscToolCheck(clt *core.SDKClient, req *promotion.TaobaoPromotionmiscToolCheckRequest, session string) (*promotion.TaobaoPromotionmiscToolCheckAPIResponse, error) {
