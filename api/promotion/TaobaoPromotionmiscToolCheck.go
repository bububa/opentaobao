...
*/
func TaobaoPromotionmiscToolCheck(clt *core.SDKClient, req *promotion.TaobaoPromotionmiscToolCheckRequest, session string) (*promotion.TaobaoPromotionmiscToolCheckResponse, error) {
