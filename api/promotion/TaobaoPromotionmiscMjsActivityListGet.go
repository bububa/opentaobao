...
*/
func TaobaoPromotionmiscMjsActivityListGet(clt *core.SDKClient, req *promotion.TaobaoPromotionmiscMjsActivityListGetRequest, session string) (*promotion.TaobaoPromotionmiscMjsActivityListGetResponse, error) {
