...
func Taobaopromotionmealget(clt *core.SDKClient, req *promotion.TaobaopromotionmealgetAPIRequest, session string) (*promotion.TaobaopromotionmealgetAPIResponse, error) {
