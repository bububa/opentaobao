...
*/
func TaobaoPromotionMealGet(clt *core.SDKClient, req *promotion.TaobaoPromotionMealGetRequest, session string) (*promotion.TaobaoPromotionMealGetResponse, error) {
