...
func Taobaopromotioncouponsnssend(clt *core.SDKClient, req *promotion.TaobaopromotioncouponsnssendAPIRequest, session string) (*promotion.TaobaopromotioncouponsnssendAPIResponse, error) {
