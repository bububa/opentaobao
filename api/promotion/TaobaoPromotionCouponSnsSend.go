...
*/
func TaobaoPromotionCouponSnsSend(clt *core.SDKClient, req *promotion.TaobaoPromotionCouponSnsSendRequest, session string) (*promotion.TaobaoPromotionCouponSnsSendAPIResponse, error) {
