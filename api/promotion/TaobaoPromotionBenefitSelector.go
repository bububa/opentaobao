...
*/
func TaobaoPromotionBenefitSelector(clt *core.SDKClient, req *promotion.TaobaoPromotionBenefitSelectorRequest, session string) (*promotion.TaobaoPromotionBenefitSelectorResponse, error) {
