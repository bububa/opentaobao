...
func TaobaoUmpDetailAdd(clt *core.SDKClient, req *promotion.TaobaoUmpDetailAddAPIRequest, resp *promotion.TaobaoUmpDetailAddAPIResponse, session string) error {
