...
*/
func TaobaoPromotionCouponSend(clt *core.SDKClient, req *promotion.TaobaoPromotionCouponSendRequest, session string) (*promotion.TaobaoPromotionCouponSendResponse, error) {
