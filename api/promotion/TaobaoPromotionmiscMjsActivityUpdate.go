...
*/
func TaobaoPromotionmiscMjsActivityUpdate(clt *core.SDKClient, req *promotion.TaobaoPromotionmiscMjsActivityUpdateRequest, session string) (*promotion.TaobaoPromotionmiscMjsActivityUpdateAPIResponse, error) {
