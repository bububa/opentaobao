...
func AlibabaBenefitQuery(clt *core.SDKClient, req *promotion.AlibabaBenefitQueryAPIRequest, resp *promotion.AlibabaBenefitQueryAPIResponse, session string) error {
