...
*/
func TmallNrFulfillSoldOrderlistQuery(clt *core.SDKClient, req *tmallnr.TmallNrFulfillSoldOrderlistQueryRequest, session string) (*tmallnr.TmallNrFulfillSoldOrderlistQueryAPIResponse, error) {
