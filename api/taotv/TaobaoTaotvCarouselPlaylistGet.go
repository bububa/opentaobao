...
*/
func TaobaoTaotvCarouselPlaylistGet(clt *core.SDKClient, req *taotv.TaobaoTaotvCarouselPlaylistGetRequest, session string) (*taotv.TaobaoTaotvCarouselPlaylistGetAPIResponse, error) {
